---
title: Introduktion til Dynamics 365 for operationer
description: "Microsoft Dynamics 365 for Operations er Microsofts business program til virksomheder. Denne side kan du få mere at vide og komme i gang ved hjælp af produktet."
author: margoc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
---
# <a name="introduction-to-dynamics-365-for-operations"></a>Introduktion til Dynamics 365 for operationer

[!include[banner](includes/banner.md)]

Microsoft Dynamics 365 for Operations er Microsofts business program til virksomheder. Det gør det muligt at hurtigt at træffe bedre beslutninger via en intelligent brugergrænseflade, der giver adgang til indsigt i realtid og data. Det giver virksomheder transformeringen og innnovate ved at levere gennemprøvede forretningslogik, der gør det muligt at designe deres virksomhedsprocesser hurtigere. Den giver virksomheder fleksibiliteten til at vokse i deres eget tempo og handle næsten hvor som helst, hver gang, så de kan skalere deres aktiviteter globalt til forretningsbehov. 

Denne brugervejledning kan hjælpe dig med at lære, hvordan du foretager Dynamics 365 for Operations i virksomheden.    
...
<tbody>
<tr class="odd">
<td><p><a href="get-started/onboarding-home.md">Onboarding af organisationen</a></p>
<p>Finans</p>
...
<p>Personale</p>
   <ul>
  <li><a href="human-resources/departments-jobs-positions.md">Strategi for personale</a></li>
  <li><a href="human-resources/manage-recruiting-process.md">Rekruttering, ansætte og motivering</a></li>
  ...
  <li><a href="human-resources/localizations/noam-usa-payroll.md">Funktioner for USA</a></li>
</ul></td>
  <td>
  <p>Detail</p>
  <ul>
<li><a href="retail/call-center-functionality.md">Call center</a></li>
  ...
  <li><a href="retail/define-maintain-channel-clients-registers-hw-stations.md">Ressourcer til MPOS og skyen POS</a></li>
  <li><a href="retail/dev-itpro/dev-retail-home-page.md">Retail udvikler og administration</a></li></ul>
