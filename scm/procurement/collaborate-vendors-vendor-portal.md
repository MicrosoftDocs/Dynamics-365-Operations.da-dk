...
| Handling                                                                                                        | Status og version                                                                                                                                                                                                                                                                                                                                                                          |
|---------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Den første version af indkøbsordren oprettes i Dynamics AX.                                                      | Status er **Kladde**.                                                                                                                                                                                                                                                                                                                                                                    |
...
| Indløbsordren sendes til kreditorportalen                                                                           | Versionen registreres på kreditorportalen, og status ændres til **Til eksternt gennemsyn**.                                                                                                                                                                                                                                                                                        |
...
| Du kan sende den nye version af indkøbsordren til kreditorportalen.                                                      | Den nye version registreres på kreditorportalen, og status ændres til **Til eksternt gennemsyn**.                                                                                                                                                                                                                                                                                    |
...
[Arbejdsområde for kreditorsamarbejdsfakturering](/dynamics365/unified-operations/financials/accounts-payable/vendor-portal-invoicing-workspace)
