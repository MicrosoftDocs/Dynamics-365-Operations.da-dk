---
title: Installere og konfigurere Microsoft Dynamics 365 for Operations &#8211; Lagersted
...
Dynamics 365 for Operations – Lagersted en applikation, der er tilgængelig i Google Play Butik og Windows Store. Til den aktuelle version af Microsoft Dynamics 365 for Operations leveres denne app som en separat komponent, der skal installeres separat på enheder, der bruges til opgaver vedrørende lagersted. For at kunne bruge appen i dit Dynamics 365 for Operations-miljø skal du hente den ned på hver enhed og konfigurere den til at oprette forbindelse til dit Dynamics 365 for Operations-miljø. I dette emne beskrives, hvordan du installerer appen på dine enheder. Det forklares også, hvordan du kan konfigurere appen til at oprette forbindelse til dit Dynamics 365 for Operations-miljø.

## <a name="prerequisites"></a>Forudsætninger
Appen er tilgængelig på Android- og Windows-operativsystemer. Når du vil bruge appen, skal du have et af følgende understøttede operativsystemer installeret på dine enheder. Du skal også have en af følgende understøttede versioner af Dynamics 365 for Operations. Du kan bruge oplysningerne i tabellen nedenfor til at vurdere, om din hardware og dit softwaremiljø er klar til at understøtte installationen.

| Platform                    | Version                                                                                                                                                                     |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Android                     | 4.4, 5.0, 6.0                                                                                                                                                               |
| Windows (UWP)               | Windows 10 (alle versioner)                                                                                                                                                   |
| Dynamics 365 for Operations | Microsoft Dynamics 365 for Operations version 1611 eller Microsoft Dynamics AX version 7.0/7.0.1 og opdatering 2 til Microsoft Dynamics AX-platformen med hotfix KB 3210014 |

## <a name="get-the-app"></a>Hent appen
-   Windows (UWP) - [Dynamics 365 for Operations – Lagersted i Windows Store](https://www.microsoft.com/store/apps/9p1bffd5tstm)
-   Android - [Dynamics 365 for Operations – Lagersted i Google Play Butik](https://play.google.com/store/apps/details?id=com.Microsoft.Dynamics365forOperationsWarehousing)

## <a name="create-a-web-service-application-in-active-directory"></a>Oprette en webtjenesteapplikation i Active Directory
For at aktivere appen til at kommunikere med en bestemt Dynamics 365 for Operations-server skal du registrere en webtjenesteapplikation i et Azure Active Directory til Dynamics 365 for Operations-lejeren. Af sikkerhedsmæssige årsager anbefaler vi, at du opretter en webtjenesteapplikation for hver enhed, du bruger. For at oprette en webtjenesteapplikation i Azure Active Directory (AD Azure), skal du udføre følgende trin:
...
4.  Vælg den forekomst af Active Directory, der bruges af Dynamics 365 for Operations, i gitteret.
...
8.  Angiv logon-URL-adressen, som er applikationens URL-adresse i din lejer, rod-URL-adressen til Operations. Logon-URL-adressen bruges i øjeblikket ikke aktivt til godkendelse af appen, men det er et obligatorisk felt. Angiv den samme URL-adresse i feltet App-id-URI. [![wh-04-ad-add-properties](./media/wh-04-ad-add-properties.png)](./media/wh-04-ad-add-properties.png)
9.  Gå til fanen **Konfigurer**. [![wh-05-ad-configure-app](./media/wh-05-ad-configure-app.png)](./media/wh-05-ad-configure-app.png)
...
3.  Knyt din Azure Active Directory-applikation til brugeren af lagerstedsappen.
    1.  I Dynamics 365 for Operations skal du gå til **Systemadministration** &gt; **Opsætning** &gt; **Azure Active Directory-applikationer**.
    2.  Opet en ny linje.
    3.  Angiv **Klient-ID** (fra det sidste afsnit), giv det et navn, og vælg den bruger, der er oprettet tidligere. Vi anbefaler, at du mærker alle dine enheder, så du nemt kan fjerne deres adgang til Dynamics 365 for Operations fra denne side i tilfælde af, at de går tabt. [![wh-10-ad-applications-form](./media/wh-10-ad-applications-form.png)](./media/wh-10-ad-applications-form.png)

## <a name="configure-the-application"></a>Konfigurere applikationen
Du skal konfigurere appen på enheden at oprette forbindelse til Dynamics 365 for Operations-serveren via Azure AD-applikationen. Dette gøres ved at gennemføre følgende trin.

1.  I appen skal du gå til **Forbindelsesindstillinger**.
2.  Ryd feltet **Demotilstand**. [![wh-11-app-connection-settings-demo-mode](./media/wh-11-app-connection-settings-demo-mode-169x300.png)](./media/wh-11-app-connection-settings-demo-mode.png)
3.  Indtast følgende oplysninger: - **Azure Active Directory klient-id** - Brug klient-id'et fra trin 13 i "Oprette en webtjenesteapplikation i Active Directory". - **Azure Active Directory klient-id** - Brug klienthemmeligheden fra trin 13 i "Oprette en webtjenesteapplikation i Active Directory". - **Azure Active Directory-ressource** - Azure AD Directory-ressource viser URL-adressen til Dynamics 365 for Operations-roden. **Bemærk**: Afslut ikke dette felt med en skråstreg (/). - **Azure Active Directory-lejer** - Azure AD Directory-lejeren bruges sammen med Dynamics 365 for Operations-serveren: https://login.windows.net/&lt;dit-AD-lejer-ID&gt;. For eksempel: https://login.windows.net/contosooperations.onmicrosoft.com. 
**Bemærk**: Afslut ikke dette felt med en skråstreg (/). - **Firma** -Angiv den juridiske enhed i Dynamics 365 for Operations, som applikationen skal oprette forbindelse til. [![wh-12-app-connection-settings](./media/wh-12-app-connection-settings-169x300.png)](./media/wh-12-app-connection-settings.png)
4.  Vælg knappen **Tilbage** i applikationens øverste venstre hjørne. Applikationen opretter nu forbindelse til din Dynamics 365 for Operations-server, og logonskærmen for lagermedarbejderen vises. [![wh-13-log-in-screen](./media/wh-13-log-in-screen-180x300.png)](./media/wh-13-log-in-screen.png)

## <a name="remove-access-for-a-device"></a>Fjerne adgang til en enhed
I tilfælde af en mistet eller beskadiget enhed skal du fjerne adgangen til Dynamics 365 for Operations for enheden. De følgende trin beskriver den anbefalede proces til at fjerne adgangen.
