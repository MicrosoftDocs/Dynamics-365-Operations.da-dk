---
title: "Opsætning af produkter, der kan produceres eller udtaget"
description: "Produkterne kan købes på forskellige måder - de kan produceres (produceret) eller udtaget (købt). Denne artikel beskriver nogle typiske punkter, du skal overveje, når du konfigurerer produkter til understøttelse af multiforsyning."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-products-that-can-be-produced-or-procured"></a>Opsætning af produkter, der kan produceres eller udtaget

Produkterne kan købes på forskellige måder - de kan produceres (produceret) eller udtaget (købt). Denne artikel beskriver nogle typiske punkter, du skal overveje, når du konfigurerer produkter til understøttelse af multiforsyning. 
