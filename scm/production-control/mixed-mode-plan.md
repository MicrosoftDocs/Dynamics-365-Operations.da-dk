---
title: "Blandet tilstand planlægning - kombinere separate, proces og lean forsyning"
description: "Denne artikel indeholder oplysninger om planlægning i blandet tilstand. Du kan udforme din forsyningskæde ud fra materialeflowet i planlægning i blandet tilstand. Microsoft Dynamics 365 for operationer, der sørger for, at materiale flow følger dine modeller uanset politikken udbud, der er valgt (kanbans, produktionsordrer, indkøbsordrer, batchordrer eller overflytningsordrer)."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="mixed-mode-planning---combine-discrete-process-and-lean-sourcing"></a>Blandet tilstand planlægning - kombinere separate, proces og lean forsyning

Denne artikel indeholder oplysninger om planlægning i blandet tilstand. Du kan udforme din forsyningskæde ud fra materialeflowet i planlægning i blandet tilstand. Microsoft Dynamics 365 for operationer, der sørger for, at materiale flow følger dine modeller uanset politikken udbud, der er valgt (kanbans, produktionsordrer, indkøbsordrer, batchordrer eller overflytningsordrer). 
...
Dynamics 365 for planlægning af operationer blandet tilstand bestemmer, hvordan et produkt er leveret og, baseret på levering, hvordan afledte behov (forbrug af varer fra en stykliste materialer \[Stykliste\]) er udstedt. Baseret på ordretype henter systemet automatisk materialer for at imødekomme behov.  
...
Uanset hvordan forsyningskæden er udformet, understøtter Dynamics 365 i forbindelse med din blanding af leveringspolitikker for. Du kan få produktionsordrer, der er hentet fra kanbans. Du kan også have en batchordre, der kræver et produkt, der leveres af overførsler eller kanbans.  

Dynamics 365 for operationer sørger for, at materiale flow følger modellen.  
...
## <a name="materials-allocation-crosssupply-policy--resource-consumption-on-boms"></a>Politikken crosssupply fordeling materialer – ressourceforbrug på styklister
...
For arbejde der er uafhængig af en forsyningspolitikken, skal du ikke ændre oplysningerne på styklisten, hvis leveringen er ændret. For ad hoc-ændringer sikrer Dynamics 365 for operationer, at materialer er hentet fra det lagersted, der er rigtige.

## <a name="process-manufacturing--the-production-type"></a>Procesproduktion – produktionstypen
Fuld fleksibilitet i blandet tilstand anbefaler vi, at du bruger produktionstype styklister for alle produkter. Du kan derefter bruge produktionsordrer, kanbans, overflytningsordrer eller produktionsordrer til forsyning af et produkt. For procesproduktion skal du bruge en produktionstype af **Formel**, **Samprodukt**, **Biprodukt** eller **Planlægningsvare**. Kanbans og produktionsordrer kan ikke bruges til disse produktionstyper.
