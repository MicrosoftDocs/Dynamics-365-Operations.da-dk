...
-   Tolerance-handlinger for en attribut i den **heltal** eller **fraktion** type. Hvis værdien af attributten falder uden for minimum- og maksimumområde, kan handlingen være enten en advarsel eller en fejlmeddelelse.
