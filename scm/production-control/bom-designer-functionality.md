...
<li>Når princippet, der er indstillet til <strong>udvalgte/aktive eller valgte</strong>, kan du vælge en styklisteversion eller ruteversion ved at klikke på <strong>Stykliste</strong>&gt;<strong>styklisteversioner</strong> eller <strong>rute</strong>&gt;<strong>ruteversionen</strong>.</li>
</ul></td>
</tr>
<tr class="even">
<td>Versionsdato</td>
...
Når du bruger styklistedesigneren til at gennemgå eller redigere styklister, der består af et eller flere niveauer af fantomstyklister, strækker den rute, som typisk er knyttet til topvaren, sig over hele styklistehierarkiet. For at forenkle oversigten, du kan låse ruten på øverste niveau i visningen ved at klikke på **se**&gt;**Lås rute**. For at låse ruten, skal du klikke på **se**&gt;**Unlock rute**.

## <a name="adding-and-editing-boms-and-bom-lines"></a>Tilføje og redigere styklister og styklistelinjer
Brug den ** styklistelinjer ** eller **Stykliste** funktion til at redigere Styklister eller styklistelinjer. Når du markerer en node i træet, bestemmer typen af noden, hvilke funktioner der er tilgængelige.
...
| Styklistelinjer &gt;slette               | Slet en styklistelinje fra den valgte stykliste.                                                                  | Denne funktion er tilgængelig, når en styklistelinjenode er valgt og styklisten ikke er låst til redigering.                                                                                                                                                                                             |
...
| Styklistelinjer &gt;føjer til Styklisten komponent | Åbn en dialogboks, hvor du kan vælge en produktvariant, der skal medtages ved slutningen af den markerede stykliste.       | Denne funktion er tilgængelig, når den node, der er valgt, har en valgt stykliste. Hvis denne funktion ikke er tilgængelig, mangler der eventuelt en styklisteversion for den valgte varevariant. I så fald kan du klikke på **Stykliste**&gt;**Opret version** til at oprette den manglende version for den valgte node. |
...
| Styklisten &gt;Opret version             | Opret en ny styklisteversion eller stykliste for produktvarianten for den valgte node.                             | Denne funktion er tilgængelig, når styklistelinjenoden, der er markeret, er knyttet til en vare, der har en produktionstype af **Stykliste** eller **Formel**.                                                                                                                                                  |
| Styklisten &gt;beregning                | Åbn en dialogboks, hvor du kan køre beregningen af kost- eller salgsprisen for den valgte produktvariant. | Denne funktion er tilgængelig, når den node, der er valgt, er knyttet til en styklisteversion.                                                                                                                                                                                                         |
| Styklisten &gt;Kontroller                      | Valider og kontrollér den valgte stykliste.                                                                      | Denne funktion er tilgængelig, når den node, der er valgt, er knyttet til en styklisteversion.                                                                                                                                                                                                         |
