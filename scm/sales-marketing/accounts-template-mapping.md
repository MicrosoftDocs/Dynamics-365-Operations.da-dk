...
- **CustomerGroupId** skal opdateres til en gyldig værdi i Finance and Operations. Du kan angive en standardværdi, eller du kan angive værdien ved hjælp af en værditilknytning. Standardskabelonværdien er **10**.
- **Adresse, lande-/områdekode** er påkrævet i Finance and Operations. For at undgå synkroniseringsfejl kan du angive en standardværdi. Denne standardværdi bruges derefter, hvis feltet er tomt, i Sales.
