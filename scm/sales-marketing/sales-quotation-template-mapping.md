...
- Produkter
- Konti (hvis de bruges)
- Kontaktpersoner (hvis de bruges)
...
- Før du synkroniserer salgstilbud i Sales, skal du gå til **Indstillinger** &gt; **Administration** &gt; **Systemindstillinger** &gt; **Sales** og kontrollere, at feltet **Rabatberegningsmetode** er indstillet til **Pr. enhed**. Med denne indstilling kan du sikre, at rabatten for linjeelementet fra Sales svarer til indstillingen i Finance and Operations. I modsat fald er rabatten ikke korrekt i Finance and Operations, fordi Finance and Operations læser rabatten som en rabat på pr. enhed, selvom det var en rabat pr. linje i Sales.
- I Finance and Operations skal du gå til **Debitor** &gt; **Opsætning** &gt; **Debitorparametre**. Under fanen **Nummerserie** skal du vælge nummerserien for salgstilbud og derefter klikke på **Vis detaljer**. Derefter skal du under **Generel opsætning** indstille feltet **Manuel** til **Ja**.
- I Finance and Operations skal du gå til **Debitor** &gt; **Opsætning** &gt; **Debitorparametre**. Under fanen **Forsendelser** skal du derefter indstille feltet **Leveringsdatokontrol** til **Ingen**. Denne indstilling hjælper med at forhindre, at synkronisering mislykkes for salgstilbud.
