---
title: Foretage manuelle justeringer til det oprindelige budget
...
# <a name="make-manual-adjustments-to-the-baseline-forecast"></a>Foretage manuelle justeringer til det oprindelige budget
...
-   Den første kolonne viser varerne, varefordelingsnøgler, virksomheder osv., der er genereret en prognose for. Undertitlen på siden indeholder en beskrivelse af de aktuelle prognosedimensioner, der vises i matrixen. Hvis undertitlen på siden er for eksempel **firma / websteder / punkt fordelingsnøgle**, og en af rækkeoverskrifterne i gitteret er **USMF / 1 / D\_Alloc**, rækken viser budgettet for USMF firmaet, webstedet 1, og den **D\_Alloc** varefordelingsnøgle.
...
## <a name="forecast-aggregation-and-deaggregation"></a>Budgetteret sammenlægning og deaggregation
...
Når der foretages justering af det planlagte antal på et samlet niveau, bruger systemet vægtet tildeling til at distribuere Skift mellem linjerne, opretter sammenlægning. 
