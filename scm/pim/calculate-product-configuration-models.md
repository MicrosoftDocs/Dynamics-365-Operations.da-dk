---
title: "Beregninger for produktkonfigurationsmodeller ofte stillede spørgsmål"
description: "Denne artikel beskriver beregninger for produktkonfigurationsmodeller og forklarer, hvordan du bruger beregninger med begrænsninger."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="calculations-for-product-configuration-models-faq"></a>Beregninger for produktkonfigurationsmodeller ofte stillede spørgsmål

Denne artikel beskriver beregninger for produktkonfigurationsmodeller og forklarer, hvordan du bruger beregninger med begrænsninger.
...
Destinationen for beregningen er længden af en netledning, og den værdi, der er en farve i følgende udtryk:  

**Udtryk:**\[hvis farve == "Grøn" 1.5, 1.0\]  

Når du konfigurerer varen, angives længden af strømledningen til **1.5** Hvis du angiver **grøn** som værdien af attributten farve. Hvis du angiver en anden farve, konfigureres længden til **1,0**. Men da beregninger er envejs, angiver beregningen ikke værdien af farveattributten til **Grøn**, hvis du angiver en længde på **1,5**.
...
## <a name="how-do-i-set-a-target-attribute-as-hidden-or-readonly"></a>Hvordan angiver jeg en målattribut som skjult eller ' ReadOnly '?
...
-   De værdier, der returneres af beregningen, er uden for attributtens domæne. Et eksempel er et heltal fra \[1..10\], der er beregnet til 0.
