...
2. Log på Microsoft Dynamics 365 for Sales.
...
## <a name="inspect-dual-write-synchronization-errors-in-finance-and-operations"></a>Inspicere fejl ved dobbeltskrivningssynkronisering i Finance and Operations
...
4. Opret en forbindelse til Fjernskrivebord på den virtuelle Dynamics 365 for Finance and Operations-maskine (VM) ved hjælp af en lokal konto, der vises i LCS.
5. Åbn Logbog. 
...
## <a name="unlink-one-common-data-service-environment-from-finance-and-operations-and-link-another-environment"></a>Frakoble ét Common Data Service-miljø fra Finance and Operations og tilknytte et andet miljø
