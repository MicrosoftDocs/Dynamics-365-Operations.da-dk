...
I dette emne beskrives integrationen af lokations- og lagerstedsdata mellem Finance and Operations og Common Data Service. Operationelle steder og lagersteder er almindelige begreber i et program til styring af forsyningskæder. De bruges til at modellere forsyningskæden i dit firma.
...
Lagersteder                | lagersteder

[!include [banner](../includes/dual-write-symbols.md)]

## <a name="operational-sites"></a>Operationelle steder

De operationelle steder er tilgængelige i Common Data Service ved hjælp af følgende tilknytninger.
...
## <a name="warehouses"></a>Lagersteder

Lagerstederne er tilgængelige ved hjælp af følgende tilknytninger.
