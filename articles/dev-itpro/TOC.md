...
## Selvstudier
### [Opret formularen Gebyrtyper for leje](user-interface/build-rental-charge-type-form.md)
...
### [FAQ for meddelelsescenter, meddelelseslinje og meddelelsesdetaljerI](user-interface/messaging-user.md)
...
## [Du kan bruge aktivitetsdiagrammer](lifecycle-services/using-activity-diagrams.md)
