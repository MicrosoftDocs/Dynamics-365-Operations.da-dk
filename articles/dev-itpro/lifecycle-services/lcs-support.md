...
---
# <a name="get-support-for-finance-and-operations-or-lifecycle-services-lcs"></a>Få support til Finance and Operations eller Lifecycle Services (LCS)
...
Du kan bruge oplysningerne i denne artikel til at kontakte Microsoft, hvis du har tekniske spørgsmål om Finance and Operations, eller hvis du har brug for hjælp til at få adgang til Microsoft Dynamics Lifecycle Services (LCS).

### <a name="finance-and-operations-support"></a>Support til Finance and Operations

Du kan få support til Finance and Operations eller LCS ved at bruge ressourcerne i tabellen nedenfor. Disse ressourcer er angivet i den rækkefølge, vi anbefaler, at du følger, når du foretager fejlfinding.
...
<tr class="even">
<td>Åbn en supportanmodning hos Finance and Operations-supportteamet.</td>
...
<li>Fejl, der opstår, når du bruger Finance and Operations.</li>
</ul>
...
<tr class="odd">
<td>Få hjælp til spørgsmål om Finance and Operations-licenser.</td>
...
- [Få support til Dynamics 365 for Retail](../../retail/retail-support.md)
- [Få support til Dynamics 365 for Talent](../../talent/talent-support.md)
- Yderligere oplysninger om Microsoft Dynamics-supporttilbud finder du i [Microsoft Dynamics Online-support](https://www.microsoft.com/en-us/dynamics/dynamics-online-support.aspx).
