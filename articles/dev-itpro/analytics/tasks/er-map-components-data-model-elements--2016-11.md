...
---
# <a name="map-components-of-the-created-format-to-data-model-elements-for-electronic-reporting-er"></a>Tilknytte komponenter af det oprettede format til modelelementer til elektronisk rapportering (ER)
