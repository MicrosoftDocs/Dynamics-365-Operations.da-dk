...
Den oprettede metadatakonfiguration er blevet gemt som en XML-fil, der kan importeres til RCS og bruges som kilden til oplysninger om metadata til forretningsdomænet for udenrigshandel i Finance and Operations. Baseret på disse oplysninger kan vi angive tilknytningen mellem programmetadata og ER-datamodel.
