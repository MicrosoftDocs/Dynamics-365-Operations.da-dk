...
---
# <a name="create-format-to-use-document-management-files-in-format-outputs-for-electronic-reporting-er"></a>Oprette format til at bruge dokumentstyringsfiler i formatoutput til elektronisk rapportering (ER)
