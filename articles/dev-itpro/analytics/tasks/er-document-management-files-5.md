...
---
# <a name="modify-and-run-format-to-use-document-management-files-in-format-outputs-for-electronic-reporting-er"></a>Redigere og køre format til at bruge dokumentstyringsfiler i formatoutput til elektronisk rapportering (ER)
