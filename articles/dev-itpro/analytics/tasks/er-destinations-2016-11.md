--- 
title: Konfigurere destinationer for output fra elektronisk rapportering (ER)
...
---
# <a name="configure-destinations-for-electronic-reporting-er-output"></a>Konfigurere destinationer for output fra elektronisk rapportering (ER)
