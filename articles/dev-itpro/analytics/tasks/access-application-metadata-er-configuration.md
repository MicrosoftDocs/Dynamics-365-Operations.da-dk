...
37. Luk siden. 
38. Luk siden. 
39. Når du har brug for at udvide det eksisterende sæt metadata, kan du gøre det i Finance and Operations. Du kan derefter eksportere den nye fuldførte version af ER-metadatakonfigurationen fra Finance and Operations, importere den til RCS og opdatere forudsætningerne for den konfigurerede konfiguration af modeltilknytning, der henviser til en ny version af importeret metadatakonfiguration. 

> [!NOTE]
> Denne indlæsning af oplysninger om programmetadata er den eneste, der er tilgængelig for lokalt installerede programmer (når der bruges lokale virksomhedsdata (LBD) eller en lokal installationsmodel for Dynamics 365 for Finance and Operations).
