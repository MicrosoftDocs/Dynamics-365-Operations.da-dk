...
9. Klik på **Importér** for at hente den valgte version fra LCS til den aktuelle Finance and Operations-forekomst.

    > [!NOTE]
    > Knappen **Importér** er ikke tilgængelig for ER-konfigurationsversioner, der allerede findes i den aktuelle Finance and Operations-forekomst.
