...
## <a name="power-bi-content-for-dynamics-365-for-finance-and-operations-enterprise-edition-july-2017"></a>Power BI-indhold til Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition (juli 2017)
Hvis du bruger Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition (juli 2017) er følgende Power BI-indhold tilgængeligt:
...
### <a name="accessing-the-content"></a>Adgang til indholdet
Dette Power BI-indhold er tilgængeligt fra PowerBI.com.
...
5. Angiv URL-adressen på dit Dynamics AX-miljø. URL-adressen skal være i formatet **https://&lt;YourAOSTenant&gt;.cloudax.dynamics.com**. Klik på **Næste**.
6. Vælg **oAuth2** som godkendelsesmetode, og klik derefter på **Log på**.
7. Når du bliver bedt om det, skal du angive en Microsoft Office 365-konto, der har tilladelse til at få adgang til dit Microsoft Dynamics AX-miljø.
