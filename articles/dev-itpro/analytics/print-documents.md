...
# <a name="printing-in-finance-and-operations-applications"></a>Udskrivning i Finance and Operations-programmer
...
| 3. Udskrivning på en netværksenhed | Send et dokument med høj præcision til en printerenhed for et domæne.     | Et præcisiondokument sendes til et klientprogram, der kører på en server, der er tilknyttet kundens domæne. |
