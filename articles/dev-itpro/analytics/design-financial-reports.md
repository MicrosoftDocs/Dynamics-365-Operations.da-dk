...
4. Vælg **Filer**, derefter **Gem som**, og navngiv rapporten Detaljeret råbalance med attributter.
    ...
    > [!NOTE]
    > Hver gang en ny rapport i Report Designer, opdateres listen over økonomirapporter i Finance and Operations.
...
[Se økonomiske rapporter](../../financials/general-ledger/view-financial-reports.md)
