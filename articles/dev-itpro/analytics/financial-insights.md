...
**Økonomiske indsigt** bruger Microsoft Power BI til at samle økonomiske nøgletal (KPI'er), diagrammer og regnskaber. Power BI er integreret i Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition.
...
| Vis økonomisk indsigt i aktuelt firma | •   Bogholder •    Regnskabschef •    Regnskabsansvarlig • Revisor •   Budgetchef •    Administrerende direktør •   Økonomidirektør •   Finansinspektør  |   • Denne pligt giver adgang til økonomisk indsigt. •  Som standard bruges det aktive firma som et filter. Du kan ikke tilføje andre juridiske enheder.            |
...
Brugere kan filtrere rapporten ved hjælp af ruden **Filter** til venstre. Denne rude er den samme rude, der er tilgængelig via Power BI Desktop.
Der findes forskellige niveauer af filtrering, hvoraf nogle muligvis ikke er tilgængelige, afhængigt af hvad du har valgt på en side (fane), eller om du bruger funktionerne til detaljeadgang:
...
## <a name="what-is-coming-in-future-releases"></a>Hvad kommer i fremtidige versioner?
De nye arbejdsområder og regnskaber, der bruger Power BI, vil fortsat blive udvidet. Her er nogle af de nye funktioner, der overvejes til fremtidige versioner:

 - Muligheden for at kopiere, redigere, slette og oprette visuelle elementer og selv regnskaber                                                  
 - Yderligere standardrapporter                                                                                                            
    - Understøttelse af yderligere reskontrodata                                                                                            
 - Understøttelse af en rapporteringsvaluta                                                                                                      
 - Tilføjelse af brugerdefinerede beregninger for rækker og kolonner                                                                                          
 - Muligheden for at eksportere regnskaberne to Microsoft Excel.                                                                     
   - Bevarelse af formatet på regnskabet under eksport.                                                                          
   - Analyse af dataene i Excel gennem oprettelse af en pivottabel, der bruger oplysningerne på det visuelle element.                                              
 - Understøttelse af internationale indstillinger                                                                                                                        
 - Muligheden for at definere rapporteringshierarkier, så du kan definere hovedkontohierarkier eller et organisationshierarki, der kan bruges i regnskaber til design, filtrering og sikkerhed.                                                                    
 - Understøttelse af udskrivning

De nye funktioner offentliggøres via webstedet med oversigten, når arbejdet startes: https://roadmap.dynamics.com/.
