...
description: Denne artikel beskriver, hvordan du kan oprette fælles værdier, der bruges til parametre i forskellige dele af styring af tekniske ændringer.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
