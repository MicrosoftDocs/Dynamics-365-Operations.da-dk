...
ms.locfileid: "8675171"
---
# <a name="scenario-setup-for-iot-intelligence"></a>Scenarieopsætning for IoT-viden

[!include [banner](../../includes/banner.md)]

Dette emne forklarer, hvordan du kan konfigurere scenarier for IoT-viden i Microsoft Dynamics 365 Supply Chain Management. <!-- KFM: Hide setup info for now: Before you can set up the scenarios, you must [set up Microsoft Dynamics Lifecycle Services (LCS)](iot-lcs-setup.md). -->
