...
1.  Klik på **Salg og marketing** \> **Salgsreturneringer** \> **Alle returordrer**. Opret en ny returordre, eller åbn returordren på listen. Vælg returordrelinjen i oversigtspanelet **Linjer**. Klik på **Opdater linje**, og klik derefter på **Registrering**.
