...
description: Denne artikel forklarer interne ordrer og returordrer
author: Henrikan
ms.date: 09/01/2021
ms.topic: article
...
ms.locfileid: "8859021"
---
# <a name="intercompany-orders-and-return-orders"></a>Interne ordrer og returordrer

[!include [banner](../../includes/banner.md)]

Denne artikel beskriver, hvordan interne indkøbsordrer, salgsordrer, returvareordrer, købsaftaler og salgsaftaler oprettes og opdateres.
