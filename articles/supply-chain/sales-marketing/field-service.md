---
title: Oversigt over integration med Microsoft Dynamics 365 for Field Service
...
ms.locfileid: "1865183"
---
# <a name="integration-with-microsoft-dynamics-365-for-field-service-overview"></a>Oversigt over integration med Microsoft Dynamics 365 for Field Service

[!include[banner](../includes/banner.md)]

Microsoft Dynamics 365 for Finance and Operations gør det muligt at synkronisere forretningsprocesser mellem Finance and Operations og Microsoft Dynamics 365 for Field Service. Integrationsmulighederne konfigureres ved hjælp af dataintegratorskabeloner, der kan udvides, og Common Data Service (CDS) med henblik på at muliggøre synkronisering af forretningsprocesser.
...
Hvis du vil se et eksempel på, hvordan du synkroniserer en arbejdsordre mellem Field Service og Finance and Operations, kan du se korte YouTube-video [Sådan synkroniserer du en arbejdsordre med Microsoft Dynamics 365-integration](https://www.youtube.com/watch?v=46ylO7raZAo).

## <a name="integration-with-microsoft-dynamics-365-for-field-service-including-inventory-and-project-information"></a>Integration med Microsoft Dynamics 365 for Field Service, herunder lager- og projektoplysninger
...
- Dynamics 365 for Field Service-arbejdsordrer med tilknytning til Dynamics 365 for Finance and Operations-projekter anvender dette projektnummer på Dynamics 365 for Finance and Operations-salgsordren, så der kan faktureres fra projektet. 
...
- Dynamics 365 for Finance and Operations version 8.1.2 (december 2018) blev udgivet i December 2018, og programmet har buildnummer 8.1.195 med Platform update 22 (7.0.5095). 
