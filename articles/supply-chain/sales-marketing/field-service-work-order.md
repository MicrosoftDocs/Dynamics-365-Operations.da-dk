...
4. Serviceteknikeren fuldfører arbejdsordren og registrerer brugt tid til 1,5 timer.
    ...
    I dette eksempel bliver produktets værdi for **Brugt antal** på **6** og tjenestens værdi for **Estimeret antal** på **1,5 t** synkroniseret til Finance and Operations.
