...
2. Kontroller, at zip-filen ikke er blokeret. Ellers, når du forsøger at installere løsningspakken, kan du modtage følgende fejlmeddelelse: "Der blev ikke fundet nogen importpakker". For at fjerne blokeringen af zip-filen skal du højreklikke på filen og vælge **Egenskaber**. Vælg **Ophæv blokering**.
