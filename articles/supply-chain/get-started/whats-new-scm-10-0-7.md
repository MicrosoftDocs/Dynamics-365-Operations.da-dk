...
description: I denne artikel beskrives funktioner, der enten er nye eller ændrede i Dynamics 365 Supply Chain Management 10.0.7.
author: kamaybac
ms.date: 12/05/2019
ms.topic: article
ms.prod: ''
...
I denne artikel beskrives funktioner, der enten er nye eller ændrede i Microsoft Dynamics 365 Supply Chain Management 10.0.7. Denne version har et build-nummer på 10.0.283 og er tilgængelig som følger:
...
Microsoft Dynamics 365 Supply Chain Management 10.0.7 indeholder platformsopdatering 31. Hvis du vil vide mere om platformsopdatering 31, kan du se [Nyheder eller ændringer i platformsopdatering 31](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-31.md).
