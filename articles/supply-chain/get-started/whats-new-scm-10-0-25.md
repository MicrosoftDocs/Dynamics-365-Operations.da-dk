...
I dette emne vises funktioner, der enten er nye eller ændrede i Microsoft Dynamics 365 Supply Chain Management-prøveversionen af version 10.0.25. Denne version har et build-nummer på 10.0.1149 og er tilgængelig som følger:
...
| Indkøb og forsyning | Deaktiver knappen Nulstilling af fordeling af indkøbsrekvisition | Denne funktion deaktiverer knappen **Nulstil** på siden **Regnskabsfordeling** for indkøbsrekvisitioner, der er til gennemsyn. |
...
| Lagerstedsstyring | Deaktiver forventede tilgange fra kvalitetsordrer, der vælger spærret lager | Denne funktion forhindrer, at systemet opretter forventede tilgangsposteringer for kvalitetsordrer, der indsamler lager med blokeringsstatus. Da det blokerede lager ikke er tilgængeligt, fjernes de forventede tilgange af denne funktion. Det er med til at sikre, at lageret ikke slutter med flere blokeringsstatusser, hvilket kan resultere i problemer med dataintegriteten. |
...
| --- | --- | --- |
| Aktivstyring | Anvend regler for gruppering af arbejdsordrer, mens en vedligeholdelsesplan køres | Generelt tilgængelig |
| Aktivstyring | Tællerbaserede forbedringer af vedligeholdelse | Generelt tilgængelig |
| Omkostningsstyring | Omkostningsberegningsniveau | Generelt tilgængelig |
| Omkostningsstyring | Aktivér brugerdefineret batchnummeropsætning for tilbageførsel af lagerlukning | Generelt tilgængelig |
| Omkostningsstyring | Statusdetaljer om lagerlukning | Generelt tilgængelig |
| Omkostningsstyring | Indstillinger for standardværdier til økonomiske dimensioner for værdiregulering af standardomkostning på lager | Generelt tilgængelig |
| Omkostningsstyring | Rapporten Lagerværdi – oprydning i data | Til som standard |
| Omkostningsstyring | Lagerværdirapportlager | Til som standard |
| Omkostningsstyring | Vis lagerlukningslog i gitter | Til som standard |
| Styring af tekniske ændringer | Aktivér administration af ændringer på eksisterende produkter | Til som standard |
| Styring af tekniske ændringer | Styring af tekniske ændringer | Til som standard |
| Styring af tekniske ændringer | Tekniske beskeder til produktion | Til som standard |
| Styring af tekniske ændringer | Forbedret attributnedarvning for Administration af tekniske ændringer | Til som standard |
| Styring af tekniske ændringer | Administrer ændringer af formler og deres ingredienser | Til som standard |
| Styring af tekniske ændringer | Kontroller af produktparathed | Til som standard |
| Styring af tekniske ændringer | Variantgenerering af tekniske produkter | Til som standard |
| Lager- og lokationsstyring | Navigering til styklisteversion fra styklistelinjer | Obligatorisk |
| Varedisponering | Godkendelse og konsolidering, der kan køre i batch, for planlagte bulk- og pakkebatchordrer | Generelt tilgængelig |
...
| Varedisponering | Valg af budgetmodel på Detaljer om behovsprognose | Obligatorisk |
| Varedisponering | Visualisering af status for varedisponering | Obligatorisk |
| Varedisponering | Parallel autorisation af ordreforslag | Obligatorisk |
| Varedisponering | Autorisation af ordreforslag med filtrering | Til som standard |
| Varedisponering | Gemte visninger for ordreforslag | Til som standard |
| Indkøb og forsyning | Deaktiver knappen Nulstilling af fordeling af indkøbsrekvisition | Generelt tilgængelig |
| Indkøb og forsyning | Aktivér nulstilling af indkøbsrelaterede arbejdsgange | Generelt tilgængelig |
...
| Indkøb og forsyning | Tillad, at leverandører ansøger om indkøbskategorier via leverandørsamarbejde | Til som standard |
...
| Indkøb og forsyning | Ansvarlig part for købsaftale | Til som standard |
| Indkøb og forsyning | Gemte visninger af indkøbsordrer | Til som standard |
| Administration af produktoplysninger | Streng validering af standardordreantal | Obligatorisk |
...
| Administration af produktoplysninger | Forbedringer af siden Variantforslag | Til som standard |
...
| Produktionsstyring | Aktivér automatisk generering af id-nummer ved færdigmelding i jobkortenheden | Obligatorisk |
...
| Produktionsstyring | Funktion til låsning af jobkortenhed og jobkortterminal, så de kan renses | Obligatorisk |
| Produktionsstyring | Forbedringer af dialogboksene Godkend og Overførselsjob | Obligatorisk |
| Produktionsstyring | Id for færdigmelding tilføjet i jobkortenheden | Obligatorisk |
| Produktionsstyring | Udskriv etiket fra jobkortenhed | Obligatorisk |
| Produktionsstyring | Produktionsudførelse | Obligatorisk |
| Produktionsstyring | Funktion til aktivstyring af grænsefladen til produktionsudførelse | Til som standard |
| Produktionsstyring | Jobsøgning til grænsefladen til produktionen | Til som standard |
| Produktionsstyring | Tilsidesæt standardproduktionsreservation | Til som standard |
| Produktionsstyring | Vis fulde serie-, batch- og id-numre i grænsefladen til produktionsudførelse | Til som standard |
| Salg og marketing | Forbedringer af ydeevne for salgsordredetaljer | Generelt tilgængelig |
...
| Salg og marketing | Politik for sletning af salgsordrer til indkøbsordrelinjer | Obligatorisk |
| Salg og marketing | Eksportpolitik for refererede salgstilbud | Obligatorisk |
| Salg og marketing | Eksportoptimering af kontaktpersondataenheden | Til som standard |
| Salg og marketing | Aktiver opslag for introduktion til salgstilbudsdokument og dokumentkonteringsfelter | Til som standard |
| Salg og marketing | Forbedr ydeevne for rapport med "Top 100" kunder | Til som standard |
| Salg og marketing | Genberegn forkalkuleret debitorsaldo | Til som standard |
| Salg og marketing | Registrering af salgsreturordrelinje med decimalpræcision med og uden fastvægt | Til som standard |
| Salg og marketing | Gemte visninger af salg og marketing | Til som standard |
| Salg og marketing | Salgsordrebekræftelse med et enkelt klik | Til som standard |
| Lagerstedsstyring | Skabeloner til cross-docking med lokationsvejledninger | Generelt tilgængelig |
| Lagerstedsstyring | Deaktiver forventede tilgange fra kvalitetsordrer, der vælger spærret lager | Generelt tilgængelig |
| Lagerstedsstyring | Historik for modtagelse af nummerplade | Generelt tilgængelig |
| Lagerstedsstyring | Afrund antal ned til nærmeste salgsenhed ved frigivelse til lagersted | Generelt tilgængelig |
...
| Lagerstedsstyring | Brug hurtigere API til containere, der lukker/genåbner på pakkestation | Generelt tilgængelig |
| Lagerstedsstyring | Valider skabeloner, der er valgt til genopfyldningsjob | Generelt tilgængelig |
...
| Lagerstedsstyring | Skift lagerstatus for varer, der styres af sporingsdimensioner | Obligatorisk |
| Lagerstedsstyring | Skift arbejdspulje på arbejde | Obligatorisk |
| Lagerstedsstyring | Klyngeplacering fuld | Obligatorisk |
| Lagerstedsstyring | Funktionen klynge-læg på lager | Obligatorisk |
| Lagerstedsstyring | Bekræft og flyt | Obligatorisk |
| Lagerstedsstyring | Bekræfte udgående forsendelser fra batchjob | Obligatorisk |
| Lagerstedsstyring | Kontrollér, om der skal vises en oversigtsside med tilgange på mobilenheder | Obligatorisk |
| Lagerstedsstyring | Udskudt behandling af manuel lagerbevægelseshandling | Obligatorisk |
...
| Lagerstedsstyring | Forbedrede layouts til id-etiket | Obligatorisk |
| Lagerstedsstyring | Evaluer alle handlinger for direktiver med flere SKU-lokationer | Obligatorisk |
...
| Lagerstedsstyring | Placering af lokations-id | Obligatorisk |
| Lagerstedsstyring | Blanding af produktdimension for lokation | Obligatorisk |
...
| Lagerstedsstyring | Undgå, at id'er for afsendte flytteordrer bliver brugt på andre lagersteder end destinationslagerstedet | Obligatorisk |
| Lagerstedsstyring | Spørg, om tvetydige 'Lok.-/Id'-navne skal fortolkes | Obligatorisk |
| Lagerstedsstyring | Kvalitetskontrol | Obligatorisk |
| Lagerstedsstyring | Brugerindstillinger, ikoner og trinindstillinger til den nye lagerapp | Obligatorisk |
| Lagerstedsstyring | Flere lokationszoner | Til som standard |
| Lagerstedsstyring | Opret, og behandl overførselsordrer fra lagersteds-appen | Til som standard |
| Lagerstedsstyring | Aktivér hurtig validering for mobilenheder til lagersted | Til som standard |
| Lagerstedsstyring | Udnyttelse af varekonsolideringslokation | Til som standard |
| Lagerstedsstyring | Maksimal udførelsestid for jobbet i lokationsstyring til oprydning i disponible poster | Til som standard |
| Lagerstedsstyring | Visualisering af udgående arbejdsbyrde | Til som standard |
| Lagerstedsstyring | Proces for hændelser for lagerapp | Til som standard |
| Lagerstedsstyring | Gemt visning for lastplanlægningspanelet | Til som standard |
| Lagerstedsstyring | Gemt visning af siden med arbejdsdetaljer | Til som standard |
| Lagerstedsstyring | Gemt visning til bølgebehandling | Til som standard |
| Lagerstedsstyring | Gemte visninger til lastbehandling | Til som standard |
| Lagerstedsstyring | Gemte visninger til forsendelsesbehandling | Til som standard |
| Lagerstedsstyring | Oplysninger om bølgebatchjob | Til som standard |
| Lagerstedsstyring | Beskeder om udførelse af bølge | Til som standard |
