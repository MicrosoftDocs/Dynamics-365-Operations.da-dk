...
| Salg og marketing | Ryd op i historik for salgsordreopdatering | Med denne funktion kan du rydde op i midlertidige historikposter, der er relateret til opdateringer af salgsordrer. Den tilføjer en ny knap med navnet **Ryd op i historik for salgsopdatering** i handlingsruden for detalje- og listesider for salgsordrer. |
