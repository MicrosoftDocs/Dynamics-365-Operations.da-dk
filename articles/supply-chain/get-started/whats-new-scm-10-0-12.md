...
I dette emne vises funktioner, der enten er nye eller ændrede i Microsoft Dynamics 365 Supply Chain Management foreløbig version 10.0.12. Denne version har et build-nummer på 10.0.507 og er tilgængelig som følger:

- **Prøveversion:** maj 2020
- **Generel tilgængelighed (selv-opdatering):** juli 2020
- **Automatisk opdatering:** august 2020
...
- [Den maksimale kørselstid for job til oprydning i disponible poster til lokationsstyring](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-supply-chain-management/maximum-execution-time-warehouse-management-on-hand-entries-cleanup-job) – Du finder yderligere oplysninger i [Oprydningsjob for disponible poster for lokationsstyring](../warehousing/onhand-cleanup.md).
...
Microsoft Dynamics 365 Supply Chain Management 10.0.12 indeholder platformopdateringer. Du kan få mere vide i [Platformopdateringer til version 10.0.12 af Finance and Operations-apps (august 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-10-0-12.md).

### <a name="bug-fixes"></a>Fejlrettelser

Du kan finde flere oplysninger om de fejlrettelser, der er inkluderet i hver af de opdateringer, som er del af 10.0.12, ved at logge på Lifecycle Services (LCS) og se [KB-artiklen](https://fix.lcs.dynamics.com/Issue/Details?bugId=453382&dbType=3&qc=a68cf77635c0ab926e7b1b75c6925c82a23058c524c4d728ba8b30fedaf41746).
