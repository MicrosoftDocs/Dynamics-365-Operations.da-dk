...
|---------|-------------|--------|--------|
| [Konfigurere styring af tekniske ændringer for Dynamics 365 Supply Chain Management](/training/paths/set-up-engineering-change-management/) | Dynamics 365 Supply Chain Management giver medarbejdere og organisationer mulighed for at få en samlet visning af lager, lagersted, produktion, service og logistik med forudsigende analyser, der forvandler data til indsigt som en hjælp til at træffe bedre strategiske beslutninger. | Gratis onlinelæringsmodul i dit eget tempo | 4 timer |
