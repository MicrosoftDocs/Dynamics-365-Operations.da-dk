...
description: Denne artikel forklarer, hvordan du kan udelukke produkter baseret på deres livscyklustilstand, når planlægningsoptimeringsfunktionen bruges.
author: t-benebo
ms.date: 11/13/2020
ms.topic: article
ms.prod: ''
