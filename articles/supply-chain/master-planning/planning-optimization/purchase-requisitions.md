...
description: I denne artikel beskrives indkøbsrekvisitioner.
author: t-benebo
ms.date: 01/04/2021
ms.topic: article
ms.prod: ''
...
> [!IMPORTANT]
> Tidshorisonter for godkendte rekvisitioner understøttes ikke til Planlægningsoptimering. Indtil de understøttes, ignoreres alle de værdier, du angiver i feltet **Tidshorisont (dage) for godkendte rekvisitioner**.
