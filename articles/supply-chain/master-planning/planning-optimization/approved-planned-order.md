...
description: Denne artikel beskriver, hvordan du kan se, administrere og godkende ordreforslag.
author: t-benebo
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9740952"
---
# <a name="view-manage-and-approve-planned-orders"></a>Vise, administrere og godkende ordreforslag

[!include [banner](../../includes/banner.md)]

Denne artikel beskriver, hvordan du kan se, administrere og godkende ordreforslag.
