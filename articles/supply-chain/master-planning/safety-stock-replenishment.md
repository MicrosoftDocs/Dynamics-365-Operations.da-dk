---
title: Opfyldelse af sikkerhedslager for varer
description: Denne artikel beskriver opfyldning af sikkerhedslageret, og hvordan du kan konfigurere antallet af varer på sikkerhedslageret.
author: t-benebo
ms.date: 8/23/2021
ms.topic: article
...
> [!NOTE]
> I alle illustrationer i denne artikel repræsenterer x-aksen lager, y-aksen repræsenterer dage, søjlerne repræsenterer lagerniveauet, og pilene repræsenterer posteringer, f.eks. salgsordrelinjer, indkøbsordrelinjer eller ordreforslag.
