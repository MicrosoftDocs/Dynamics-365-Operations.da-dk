...
- Gå til **Lagerstyring &gt; Konfiguration &gt; Arbejdsgange for lagerstyring**, og gennemse konfigurationen af den berørte arbejdsgang. Du kan finde flere oplysninger i [Arbejdsgange for godkendelse af lagerkladde](../../inventory/inventory-journal-workflow.md).
