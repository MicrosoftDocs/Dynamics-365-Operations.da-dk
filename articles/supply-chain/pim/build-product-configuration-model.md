...
Følgende API-flowdiagram viser processen.  

[![Rutediagram.](./media/product_configuration_2.png)](./media/product_configuration_2.png)  

## <a name="configure-products"></a>Konfigurere produkter

### <a name="configure-one-or-more-products"></a>Konfigurere et eller flere produkter

Du kan konfigurere produkter fra følgende steder:
...
### <a name="multiple-sites-and-intercompany-considerations"></a>Flere steder og interne overvejelser
