...
description: Denne artikel beskriver, hvordan du kan oprette salgsprismodeller med salgspriser, der er baseret på komponenter og attributter, og ikke på den fysiske stykliste og ruten.
author: t-benebo
ms.date: 10/2/2020
ms.topic: article
ms.prod: ''
...
Denne artikel beskriver, hvordan du kan oprette salgsprismodeller med salgspriser, der er baseret på komponenter og attributter, og ikke på den fysiske stykliste og ruten. Du kan oprette flere salgsprismodeller for hver produktkonfigurationsmodel.
