...
description: Denne artikel beskriver, hvordan du kan konfigurere en nomenklatur for produktnumre til erstatning for det faste [produktmasternummer - konfiguration - størrelse - farve - type] format.
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
