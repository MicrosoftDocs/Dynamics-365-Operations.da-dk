...
description: Beregningerne af den opsummerede kostpris og salgsprisen kaldes styklistekalkulationer, og du starter dem fra siden Beregninger. Denne artikel indeholder oplysninger om BOM-beregninger.
author: JennySong-SH
ms.date: 05/01/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8902796"
---
# <a name="bom-calculations"></a>Styklistekalkulationer

[!include [banner](../includes/banner.md)]

Beregningerne af den opsummerede kostpris og salgsprisen kaldes styklistekalkulationer, og du starter dem fra siden Beregninger. Denne artikel indeholder oplysninger om BOM-beregninger.
