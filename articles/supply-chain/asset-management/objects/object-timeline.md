...
- Hvornår en jobtype sidst blev brugt på et aktiv
- Hvornår en bestemt arbejder har indtastet en bemærkning på et arbejdsordrejob

Tidslinjen opdateres, hver gang siden åbnes. Den indeholder følgende informationer:

- Ændringer, der er foretaget på aktivet: aktivets placering, aktivets ID, navn og leverandørgaranti
- Overordnede aktiv
- Styklister (BOM)
- Log for aktivers livscyklustilstande
- Arbejdssted
