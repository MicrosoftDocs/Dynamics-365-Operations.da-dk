...
description: Denne artikel indeholder oplysninger, der kan hjælpe dig med at konfigurere detaljerne om politikker for over-/undertransaktioner, så systemet kan bestemme, hvordan det skal administrere overbehandlingen og underbehandlingen af varer på modtagelsestidspunktet.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
