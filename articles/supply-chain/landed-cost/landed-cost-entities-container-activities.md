---
title: Enhed for containeraktiviteter
description: Dette emne indeholder oplysninger om containeraktiviteter, der bruges til at spore status for forsendelsescontainere.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
