...
description: Denne artikel beskriver, hvordan du konfigurerer leveringsoplysninger for modulet Landingsomkostninger.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
Denne artikel beskriver, hvordan du konfigurerer leveringsoplysninger for modulet **Landingsomkostninger**.
