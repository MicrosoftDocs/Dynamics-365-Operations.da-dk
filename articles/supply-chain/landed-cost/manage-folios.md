...
description: Denne artikel beskriver, hvordan du kan arbejde med folioer. En folio består typisk af en leverandørs varer for én enhed eller ét firma pr. forsendelse. Varerne i en folio kan være i én container eller være fordelt på flere containere.
author: Weijiesa
ms.date: 12/14/2020
ms.topic: article
ms.prod: ''
...
En folio bestemmes ofte af toldlovgivningen. Den kan bestå af en leverandørs varer for én enhed eller ét firma pr. forsendelse. Varerne i en folio administreres i én container.
...
I oversigtspanelet **Folio** i visningen **Linjer** vises oplysninger om folioen. De fleste af disse oplysninger vises også i visningen **Overskrift** som beskrevet tidligere i denne artikel.
