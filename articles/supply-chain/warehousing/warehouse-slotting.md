...
## <a name="turn-on-the-warehouse-slotting-feature"></a>Aktivér funktionen til lagerstedsallokering
...
- **Funktionsnavn:** *Funktion til lagerstedsallokering*
...
Derefter skal du konfigurere skabelonhovedet, allokeringsspecifikationerne og lokationsvejledningerne som forklaret i følgende under afsnit.

#### <a name="set-up-a-slotting-template-header"></a>Oprette en overskrift til allokeringsskabeloner
...
1. Angiv følgende værdier i overskriften for skabelonen:
    ...
    - **Efterspørgselstype:** *Salgsordre*
        ...
        Den eneste efterspørgselstype, der understøttes i øjeblikket, er *Salgsordre*.
