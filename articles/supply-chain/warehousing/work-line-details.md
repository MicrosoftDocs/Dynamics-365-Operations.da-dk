...
description: Denne artikel indeholder oplysninger om siden Oplysninger om arbejdslinje, der viser en omfattende, sorterbar og filtrerbar liste over de individuelle arbejdslinjer i systemet.
author: Mirzaab
ms.date: 07/01/2020
ms.topic: article
ms.prod: ''
...
Hvis du vil arbejde gennem denne demo ved hjælp af de eksempelposter og -værdier, der er angivet her, skal du være på et system, hvor [standarddemodataene](../../fin-ops-core/fin-ops/get-started/demo-data.md) er installeret. Derudover skal du vælge den juridiske enhed **USMF**, før du starter.
