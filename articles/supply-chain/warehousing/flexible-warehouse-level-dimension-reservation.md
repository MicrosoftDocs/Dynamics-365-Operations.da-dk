...
Når et lagerreservationshierarki af typen *Batch-below\[lokation\]* er knyttet til produkter, kan virksomheder, der sælger batch-sporede produkter og kører logistik som handlinger, der er aktiveret for Warehouse Management System (WMS), ikke reservere bestemte batches af de pågældende produkter til kundesalgsordrer.
