...
description: Denne artikel giver en oversigt over de funktioner, der omfatter nummerserieudvidelser til id-numre, bølgeetiket-id'er, container-id'er og fragtseddel-id'er.
author: Mirzaab
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
