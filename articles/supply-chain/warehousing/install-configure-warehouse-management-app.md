...
Du kan finde oplysninger om, hvordan du installerer en build, som er hentet fra App Center, i [Installer et build](/appcenter/distribution/installation).
...
1. Angiv følgende oplysninger:
    ...
    - **Active Directory-ressource** – angiv rod-URL-adressen for Supply Chain Management.
        ...
        > Kontrollér, at HTTPS-certifikatet (SSL) er gyldigt.
