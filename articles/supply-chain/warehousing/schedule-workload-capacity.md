...
description: Denne artikel beskriver, hvordan du opretter og planlægger arbejdsbyrdekapaciteten for arbejdere på et lagersted eller for hele lagerstedet.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
