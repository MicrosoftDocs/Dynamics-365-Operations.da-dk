...
> [!NOTE]
> Denne funktion er blevet udfaset. Du kan finde flere oplysninger i [Fjernede eller udfasede funktioner](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
