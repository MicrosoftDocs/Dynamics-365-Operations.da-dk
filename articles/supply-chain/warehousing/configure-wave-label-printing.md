...
- <span data-ttu-id="db31e-124">Annuller etiketter (f.eks. i korte pluk-scenarier), og udskriv dem igen.</span><span class="sxs-lookup"><span data-stu-id="db31e-124">Void labels (for example, in short pick scenarios), and reprint them.</span></span>
...
- <span data-ttu-id="db31e-137">**Modul:** *Lokationsstyring*</span><span class="sxs-lookup"><span data-stu-id="db31e-137">**Module:** *Warehouse management*</span></span>
...
<span data-ttu-id="db31e-150">Med bølgeskabeloner kan du knytte bestemte forekomster af bølgemetoder til en tilsvarende bølgeetiketskabelon.</span><span class="sxs-lookup"><span data-stu-id="db31e-150">Wave templates let you link specific instances of wave methods to a corresponding wave label template.</span></span>
...
1. <span data-ttu-id="db31e-166">Tilføj en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-166">Add a row that has the following settings:</span></span>
...
<span data-ttu-id="db31e-200">Bølgeetikettyper bruges til at knytte bølgeetiketskabeloner til en enhed på enhedsseriegruppelinjer.</span><span class="sxs-lookup"><span data-stu-id="db31e-200">Wave label types are used to link wave label templates to a unit on unit sequence group lines.</span></span>
...
1. <span data-ttu-id="db31e-218">Gå til oversigtspanelet **Generelt**, og indstil feltet **Bølgeetikettype**  til *Karton*.</span><span class="sxs-lookup"><span data-stu-id="db31e-218">On the **General** FastTab, set the **Wave label type** field to *Carton*.</span></span>
...
1. <span data-ttu-id="db31e-233">I dialogboksen for forespørgselseditor skal du under fanen **Sortering** tilføje en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-233">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="db31e-234">**Tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-234">**Table:** *Work lines*</span></span>
...
1. <span data-ttu-id="db31e-250">Gå til **Salg og marketing \> Salgsordrer \> Alle salgsordrer**.</span><span class="sxs-lookup"><span data-stu-id="db31e-250">Go to **Sales and marketing \> Sales order \> All sales orders**.</span></span>
...
1. <span data-ttu-id="db31e-270">Vælg **Frigør til lagersted** under fanen **Lagersted** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-270">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>
    ...
    <span data-ttu-id="db31e-271">Følgende hændelser forekommer:</span><span class="sxs-lookup"><span data-stu-id="db31e-271">The following events occur:</span></span>
...
<span data-ttu-id="db31e-288">Her er de væsentligste forskelle mellem dette scenarie og scenario 1:</span><span class="sxs-lookup"><span data-stu-id="db31e-288">Here are the main differences between this scenario and scenario 1:</span></span>
...
1. <span data-ttu-id="db31e-313">Opret en post, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-313">Create a record that has the following settings:</span></span>
    ...
    - <span data-ttu-id="db31e-314">**Etiketlayout-id:** *karton*</span><span class="sxs-lookup"><span data-stu-id="db31e-314">**Label layout ID:** *Carton*</span></span>
...
1. <span data-ttu-id="db31e-333">Luk siden.</span><span class="sxs-lookup"><span data-stu-id="db31e-333">Close the page.</span></span>
...
1. <span data-ttu-id="db31e-364">Vælg **Gem** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-364">On the Action Pane, select **Save**.</span></span>
...
1. <span data-ttu-id="db31e-379">Opret salgsordre, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-379">Create a sales order that has the following settings:</span></span>
    ...
    - <span data-ttu-id="db31e-380">**Debitorkonto:** *US-001*</span><span class="sxs-lookup"><span data-stu-id="db31e-380">**Customer account:** *US-001*</span></span>
...
1. <span data-ttu-id="db31e-404">Vælg **Frigør til lagersted** under fanen **Lagersted** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-404">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>
...
1. <span data-ttu-id="db31e-431">Gå til **Lokationsstyring \> Konfiguration \> Bølger \> Bølgeskabeloner**.</span><span class="sxs-lookup"><span data-stu-id="db31e-431">Go to **Warehouse management \> Setup \> Waves \> Wave templates**.</span></span>
...
5. <span data-ttu-id="db31e-436">Flyt metoden **Udskrivning af bølgeetiketter** til kolonnen **Valgte metoder** en gang mere.</span><span class="sxs-lookup"><span data-stu-id="db31e-436">Move the **Wave label printing** method to the **Selected methods** column a second time.</span></span>
6. <span data-ttu-id="db31e-437">I kolonnen **Valgte metoder** skal du tildele en anden værdi for **Bølgetrinkode** som f.eks. *Palle* til den anden metode til **Udskrivning af bølgeetiketter**.</span><span class="sxs-lookup"><span data-stu-id="db31e-437">In the **Selected methods** column, assign a different **Wave step code** value, such as *Pallet*, to the second **Wave label printing** method.</span></span> <span data-ttu-id="db31e-438">Du kan få flere oplysninger om bølgetrinkoder under [Bølgetrinkoder](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="db31e-438">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>

### <a name="create-three-wave-label-layouts"></a><span data-ttu-id="db31e-439">Oprette tre bølgeetiketlayout</span><span class="sxs-lookup"><span data-stu-id="db31e-439">Create three wave label layouts</span></span>

1. <span data-ttu-id="db31e-440">Gå til **Lokationsstyring \> Opsætning \> Dokumentruteplanlægning \> Bølgeetiketlayout**.</span><span class="sxs-lookup"><span data-stu-id="db31e-440">Go to **Warehouse management \> Setup \> Document routing \> Wave label layouts**.</span></span>
1. <span data-ttu-id="db31e-441">Opret en post, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-441">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="db31e-442">**Etiketlayout-id:** *karton*</span><span class="sxs-lookup"><span data-stu-id="db31e-442">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="db31e-443">**Beskrivelse:** *Karton (SSCC)*</span><span class="sxs-lookup"><span data-stu-id="db31e-443">**Description:** *Carton (SSCC)*</span></span>

1. <span data-ttu-id="db31e-444">Vælg **Gem** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-444">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="db31e-445">Vælg **Indstillinger for bølgeetiketrækker** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-445">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="db31e-446">Siden **Indstillinger for bølgeetiketrækker** vises.</span><span class="sxs-lookup"><span data-stu-id="db31e-446">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="db31e-447">Her kan du konfigurere den dynamiske del af etiketten.</span><span class="sxs-lookup"><span data-stu-id="db31e-447">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="db31e-448">Tilføj en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-448">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-449">**Række-id:** *Bølgeetiket*</span><span class="sxs-lookup"><span data-stu-id="db31e-449">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="db31e-450">**Rækketabelnavn:** *WHS-bølgeetiket*</span><span class="sxs-lookup"><span data-stu-id="db31e-450">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="db31e-451">**Startposition for række:** *0*</span><span class="sxs-lookup"><span data-stu-id="db31e-451">**Row start position:** *0*</span></span>

        <span data-ttu-id="db31e-452">I dette felt defineres den lodrette position, hvor rækken skal begynde på etiketten.</span><span class="sxs-lookup"><span data-stu-id="db31e-452">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="db31e-453">**Rækkehøjde:** *0*</span><span class="sxs-lookup"><span data-stu-id="db31e-453">**Row height:** *0*</span></span>

        <span data-ttu-id="db31e-454">I dette felt defineres højden af hver række (i punkter) i henhold til ZPL-standarden.</span><span class="sxs-lookup"><span data-stu-id="db31e-454">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="db31e-455">Rækkehøjden er positiv for vandrette etiketter og negative for lodrette etiketter.</span><span class="sxs-lookup"><span data-stu-id="db31e-455">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="db31e-456">Da der kun er én række i dette eksempel, kan du angive værdien til *0* (nul).</span><span class="sxs-lookup"><span data-stu-id="db31e-456">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="db31e-457">**Rækker pr. side:** *1*</span><span class="sxs-lookup"><span data-stu-id="db31e-457">**Rows per page:** *1*</span></span>

        <span data-ttu-id="db31e-458">Dette felt definerer det antal rækker, der kan udskrives på hver etiket.</span><span class="sxs-lookup"><span data-stu-id="db31e-458">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="db31e-459">Denne opsætning medfører, at der udskrives en separat ZPL-etiket for hver post i tabellen Bølgeetiketter.</span><span class="sxs-lookup"><span data-stu-id="db31e-459">This setup will cause a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="db31e-460">Luk siden.</span><span class="sxs-lookup"><span data-stu-id="db31e-460">Close the page.</span></span>
1. <span data-ttu-id="db31e-461">Vælg **Rediger forespørgsel** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-461">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="db31e-462">I dialogboksen for forespørgselseditor skal du under fanen **Område** tilføje en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-462">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-463">**Tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-463">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-464">**Afledt tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-464">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-465">**Felt:** *Arbejdstype*</span><span class="sxs-lookup"><span data-stu-id="db31e-465">**Field:** *Work type*</span></span>
    - <span data-ttu-id="db31e-466">**Kriterier:** *Pluk*</span><span class="sxs-lookup"><span data-stu-id="db31e-466">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="db31e-467">Denne forespørgsel sikrer, at der kun udskrives arbejdslinjer af pluktypen på etiketten og ikke arbejdslinjer af læg på lager-typen.</span><span class="sxs-lookup"><span data-stu-id="db31e-467">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="db31e-468">Hvis du vil have mulighed for at udskrive fragtseddel-id'et, skal du under fanen **Join-forbindelser** vælge tabellen **Arbejdslinje** og knytte tabellen **Forsendelser** til den.</span><span class="sxs-lookup"><span data-stu-id="db31e-468">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span> 
1. <span data-ttu-id="db31e-469">Luk dialogboksen for forespørgselseditoren.</span><span class="sxs-lookup"><span data-stu-id="db31e-469">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="db31e-470">Oversigtspanelet **Layout af printertekst** indeholder tre sektioner, hvor du kan skrive printerkode: **Sidehoved**, **Brødtekst** og **Sidefod**.</span><span class="sxs-lookup"><span data-stu-id="db31e-470">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="db31e-471">I sektionen **Sidehoved** skal du i feltet **Etiketsidehoved** angiv en kode for det påkrævede sidehoved.</span><span class="sxs-lookup"><span data-stu-id="db31e-471">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="db31e-472">Hvis du f. eks. bruger Zebra-printere, kan du bruge følgende kode.</span><span class="sxs-lookup"><span data-stu-id="db31e-472">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="db31e-473">I sektionen **Brødtekst** skal du i feltet **Etiketbrødtekst** angiv en ZPL-kode for den påkrævede brødtekst.</span><span class="sxs-lookup"><span data-stu-id="db31e-473">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="db31e-474">Her er et eksempel.</span><span class="sxs-lookup"><span data-stu-id="db31e-474">Here is an example.</span></span>
...
1. <span data-ttu-id="db31e-475">I sektionen **Brødtekst** skal du i feltet **Etiketsidefod** angiv en ZPL-kode for den påkrævede sidefod.</span><span class="sxs-lookup"><span data-stu-id="db31e-475">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="db31e-476">Her er et eksempel.</span><span class="sxs-lookup"><span data-stu-id="db31e-476">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="db31e-477">Denne opsætning vil udskrive én kopi af hver etiket.</span><span class="sxs-lookup"><span data-stu-id="db31e-477">This setup will print one copy of each label.</span></span> <span data-ttu-id="db31e-478">Hvis du har brug for flere kopier (f.eks. én kopi for hver side af pallen), skal du angive værdien **n-** for **\^PQn** i sidefoden til det påkrævede antal kopier.</span><span class="sxs-lookup"><span data-stu-id="db31e-478">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="db31e-479">Hvis du f.eks. vil udskrive fire kopier af hver etiket, skal du angive **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="db31e-479">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="db31e-480">Den første etiket er nu klar til brug.</span><span class="sxs-lookup"><span data-stu-id="db31e-480">The first label is now ready to use.</span></span>
1. <span data-ttu-id="db31e-481">Opret en anden layoutpost, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-481">Create a second layout record that has the following settings:</span></span>

    - <span data-ttu-id="db31e-482">**Etiketlayout-id:** *Pakke*</span><span class="sxs-lookup"><span data-stu-id="db31e-482">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="db31e-483">**Beskrivelse:** *Palle*</span><span class="sxs-lookup"><span data-stu-id="db31e-483">**Description:** *Pallet*</span></span>

1. <span data-ttu-id="db31e-484">Vælg **Gem** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-484">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="db31e-485">Vælg **Indstillinger for bølgeetiketrækker** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-485">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="db31e-486">Siden **Indstillinger for bølgeetiketrækker** vises.</span><span class="sxs-lookup"><span data-stu-id="db31e-486">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="db31e-487">Her kan du konfigurere den dynamiske del af etiketten.</span><span class="sxs-lookup"><span data-stu-id="db31e-487">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="db31e-488">Tilføj en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-488">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-489">**Række-id:** *Bølgeetiket*</span><span class="sxs-lookup"><span data-stu-id="db31e-489">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="db31e-490">**Rækketabelnavn:** *WHS-bølgeetiket*</span><span class="sxs-lookup"><span data-stu-id="db31e-490">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="db31e-491">**Startposition for række:** *0*</span><span class="sxs-lookup"><span data-stu-id="db31e-491">**Row start position:** *0*</span></span>

        <span data-ttu-id="db31e-492">I dette felt defineres den lodrette position, hvor rækken skal begynde på etiketten.</span><span class="sxs-lookup"><span data-stu-id="db31e-492">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="db31e-493">**Rækkehøjde:** *0*</span><span class="sxs-lookup"><span data-stu-id="db31e-493">**Row height:** *0*</span></span>

        <span data-ttu-id="db31e-494">I dette felt defineres højden af hver række (i punkter) i henhold til ZPL-standarden.</span><span class="sxs-lookup"><span data-stu-id="db31e-494">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="db31e-495">Rækkehøjden er positiv for vandrette etiketter og negative for lodrette etiketter.</span><span class="sxs-lookup"><span data-stu-id="db31e-495">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="db31e-496">Da der kun er én række i dette eksempel, kan du angive værdien til *0* (nul).</span><span class="sxs-lookup"><span data-stu-id="db31e-496">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="db31e-497">**Rækker pr. side:** *1*</span><span class="sxs-lookup"><span data-stu-id="db31e-497">**Rows per page:** *1*</span></span>

        <span data-ttu-id="db31e-498">Dette felt definerer det antal rækker, der kan udskrives på hver etiket.</span><span class="sxs-lookup"><span data-stu-id="db31e-498">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="db31e-499">Denne opsætning medfører, at der udskrives en separat ZPL-etiket for hver post i tabellen Bølgeetiketter.</span><span class="sxs-lookup"><span data-stu-id="db31e-499">This setup causes a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="db31e-500">Luk siden.</span><span class="sxs-lookup"><span data-stu-id="db31e-500">Close the page.</span></span>
1. <span data-ttu-id="db31e-501">Vælg **Rediger forespørgsel** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-501">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="db31e-502">I dialogboksen for forespørgselseditor skal du under fanen **Område** tilføje en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-502">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-503">**Tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-503">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-504">**Afledt tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-504">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-505">**Felt:** *Arbejdstype*</span><span class="sxs-lookup"><span data-stu-id="db31e-505">**Field:** *Work type*</span></span>
    - <span data-ttu-id="db31e-506">**Kriterier:** *Pluk*</span><span class="sxs-lookup"><span data-stu-id="db31e-506">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="db31e-507">Denne forespørgsel sikrer, at der kun udskrives arbejdslinjer af pluktypen på etiketten og ikke arbejdslinjer af læg på lager-typen.</span><span class="sxs-lookup"><span data-stu-id="db31e-507">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="db31e-508">Hvis du vil have mulighed for at udskrive fragtseddel-id'et, skal du under fanen **Join-forbindelser** vælge tabellen **Arbejdslinje** og knytte tabellen **Forsendelser** til den.</span><span class="sxs-lookup"><span data-stu-id="db31e-508">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span>
1. <span data-ttu-id="db31e-509">Luk dialogboksen for forespørgselseditoren.</span><span class="sxs-lookup"><span data-stu-id="db31e-509">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="db31e-510">Oversigtspanelet **Layout af printertekst** indeholder tre sektioner, hvor du kan skrive printerkode: **Sidehoved**, **Brødtekst** og **Sidefod**.</span><span class="sxs-lookup"><span data-stu-id="db31e-510">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="db31e-511">I sektionen **Sidehoved** skal du i feltet **Etiketsidehoved** angiv en kode for det påkrævede sidehoved.</span><span class="sxs-lookup"><span data-stu-id="db31e-511">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="db31e-512">Hvis du f. eks. bruger Zebra-printere, kan du bruge følgende kode.</span><span class="sxs-lookup"><span data-stu-id="db31e-512">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="db31e-513">I sektionen **Brødtekst** skal du i feltet **Etiketbrødtekst** angiv en ZPL-kode for den påkrævede brødtekst.</span><span class="sxs-lookup"><span data-stu-id="db31e-513">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="db31e-514">Her er et eksempel.</span><span class="sxs-lookup"><span data-stu-id="db31e-514">Here is an example.</span></span>
...
1. <span data-ttu-id="db31e-515">I sektionen **Brødtekst** skal du i feltet **Etiketsidefod** angiv en ZPL-kode for den påkrævede sidefod.</span><span class="sxs-lookup"><span data-stu-id="db31e-515">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="db31e-516">Her er et eksempel.</span><span class="sxs-lookup"><span data-stu-id="db31e-516">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="db31e-517">Denne opsætning vil udskrive én kopi af hver etiket.</span><span class="sxs-lookup"><span data-stu-id="db31e-517">This setup will print one copy of each label.</span></span> <span data-ttu-id="db31e-518">Hvis du har brug for flere kopier (f.eks. én kopi for hver side af pallen), skal du angive værdien **n-** for **\^PQn** i sidefoden til det påkrævede antal kopier.</span><span class="sxs-lookup"><span data-stu-id="db31e-518">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="db31e-519">Hvis du f.eks. vil udskrive fire kopier af hver etiket, skal du angive **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="db31e-519">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="db31e-520">Den anden etiket er nu klar til brug.</span><span class="sxs-lookup"><span data-stu-id="db31e-520">The second label is now ready to use.</span></span>
1. <span data-ttu-id="db31e-521">Opret en tredje layoutpost, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-521">Create a third layout record that has the following settings:</span></span>

    - <span data-ttu-id="db31e-522">**Etiketlayout-id:** *Brud*</span><span class="sxs-lookup"><span data-stu-id="db31e-522">**Label layout ID:** *Break*</span></span>
    - <span data-ttu-id="db31e-523">**Beskrivelse:** *Brudetiket*</span><span class="sxs-lookup"><span data-stu-id="db31e-523">**Description:** *Break label*</span></span>

1. <span data-ttu-id="db31e-524">Vælg **Gem** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-524">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="db31e-525">Oversigtspanelet **Layout af printertekst** indeholder tre sektioner, hvor du kan skrive printerkode: **Sidehoved**, **Brødtekst** og **Sidefod**.</span><span class="sxs-lookup"><span data-stu-id="db31e-525">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="db31e-526">I sektionen **Sidehoved** skal du i feltet **Etiketsidehoved** angiv en ZPL-kode for det påkrævede sidehoved.</span><span class="sxs-lookup"><span data-stu-id="db31e-526">In the **Header section** section, in the **Label header** field, enter ZPL code for the required header.</span></span> <span data-ttu-id="db31e-527">Her er et eksempel.</span><span class="sxs-lookup"><span data-stu-id="db31e-527">Here is an example.</span></span>
...
1. <span data-ttu-id="db31e-528">Denne gang er brødtekst ikke nødvendig.</span><span class="sxs-lookup"><span data-stu-id="db31e-528">This time, no body is required.</span></span> <span data-ttu-id="db31e-529">Du skal derfor blot angive den nødvendige tekst i sektionen **Sidefod**.</span><span class="sxs-lookup"><span data-stu-id="db31e-529">Therefore, just enter the required text in the **Footer section** section.</span></span> <span data-ttu-id="db31e-530">Her er et eksempel.</span><span class="sxs-lookup"><span data-stu-id="db31e-530">Here is an example.</span></span>

    ```plaintext
    ^XZ
    ```

    <span data-ttu-id="db31e-531">Den tredje etiket er nu klar til brug.</span><span class="sxs-lookup"><span data-stu-id="db31e-531">The third label is now ready to use.</span></span>

    > [!NOTE]
    > <span data-ttu-id="db31e-532">Denne tredje etiket er en brudetiket, der vil blive brugt som delelinje mellem etiketruller.</span><span class="sxs-lookup"><span data-stu-id="db31e-532">This third label is a break label that will be used as a divider between label rolls.</span></span>

### <a name="create-two-wave-label-types"></a><span data-ttu-id="db31e-533">Oprette to bølgeetikettyper</span><span class="sxs-lookup"><span data-stu-id="db31e-533">Create two wave label types</span></span>

1. <span data-ttu-id="db31e-534">Gå til **Lokationsstyring \> Opsætning \> Dokumentruteplanlægning \> Bølgeetikettyper**.</span><span class="sxs-lookup"><span data-stu-id="db31e-534">Go to **Warehouse management \> Setup \> Document routing \> Wave label types**.</span></span>
1. <span data-ttu-id="db31e-535">Opret en post, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-535">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="db31e-536">**Etikettype:** *Karton*</span><span class="sxs-lookup"><span data-stu-id="db31e-536">**Label type:** *Carton*</span></span>
    - <span data-ttu-id="db31e-537">**Beskrivelse:** *Karton*</span><span class="sxs-lookup"><span data-stu-id="db31e-537">**Description:** *Carton*</span></span>

1. <span data-ttu-id="db31e-538">Opret en anden post, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-538">Create a second record that has the following settings:</span></span>

    - <span data-ttu-id="db31e-539">**Etikettype:** *Palle*</span><span class="sxs-lookup"><span data-stu-id="db31e-539">**Label type:** *Pallet*</span></span>
    - <span data-ttu-id="db31e-540">**Beskrivelse:** *Palle*</span><span class="sxs-lookup"><span data-stu-id="db31e-540">**Description:** *Pallet*</span></span>

### <a name="set-up-unit-sequence-groups"></a><span data-ttu-id="db31e-541">Konfigurer enhedsseriegrupper</span><span class="sxs-lookup"><span data-stu-id="db31e-541">Set up unit sequence groups</span></span>

1. <span data-ttu-id="db31e-542">Gå til **Lokationsstyring \> Opsætning \> Lagersted \> Enhedsseriegrupper**.</span><span class="sxs-lookup"><span data-stu-id="db31e-542">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
1. <span data-ttu-id="db31e-543">Vælg eller opret en **Hver boks PL**-gruppe.</span><span class="sxs-lookup"><span data-stu-id="db31e-543">Select or create an **Ea Box PL** group.</span></span>
1. <span data-ttu-id="db31e-544">For linjen **Boks** skal du indstille feltet **Bølgeniveautype** til *Karton*.</span><span class="sxs-lookup"><span data-stu-id="db31e-544">For the **Box** line, set the **Wave level type** field to *Carton*.</span></span>
1. <span data-ttu-id="db31e-545">For linjen **PL** skal du indstille feltet **Bølgeniveautype** til *Palle*.</span><span class="sxs-lookup"><span data-stu-id="db31e-545">For the **PL** line, set the **Wave level type** field to *Pallet*.</span></span>

### <a name="create-wave-label-templates"></a><span data-ttu-id="db31e-546">Oprette bølgeetiketskabeloner</span><span class="sxs-lookup"><span data-stu-id="db31e-546">Create wave label templates</span></span>

1. <span data-ttu-id="db31e-547">Gå til **Lokationsstyring \> Opsætning \> Dokumentruteplanlægning \> Bølgeetiketskabeloner**.</span><span class="sxs-lookup"><span data-stu-id="db31e-547">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
1. <span data-ttu-id="db31e-548">Opret en etiketskabelon, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-548">Create a label template that has the following settings:</span></span>

    - <span data-ttu-id="db31e-549">**Navn på etiketskabelon:** *Kartonetiketter*</span><span class="sxs-lookup"><span data-stu-id="db31e-549">**Label template name:** *Carton labels*</span></span>
    - <span data-ttu-id="db31e-550">**Beskrivelse:** *Kartonetiketter*</span><span class="sxs-lookup"><span data-stu-id="db31e-550">**Description:** *Carton labels*</span></span>
    - <span data-ttu-id="db31e-551">**Kode for bølgetrin:** *Karton*</span><span class="sxs-lookup"><span data-stu-id="db31e-551">**Wave step code:** *Carton*</span></span>
    - <span data-ttu-id="db31e-552">**Lagersted:** *62*</span><span class="sxs-lookup"><span data-stu-id="db31e-552">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="db31e-553">I oversigtspanelet **Generelt** skal du i feltet **Bølgeetikettype** vælge en værdi som f.eks. *Karton*.</span><span class="sxs-lookup"><span data-stu-id="db31e-553">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Carton*.</span></span>
1. <span data-ttu-id="db31e-554">I oversigtspanelet **Detaljer om bølgeetiketskabeloner** skal du tilføje en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-554">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-555">**Etiketlayout-id:** *karton*</span><span class="sxs-lookup"><span data-stu-id="db31e-555">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="db31e-556">**Printernavn:** Vælg en relevant ZPL-printer.</span><span class="sxs-lookup"><span data-stu-id="db31e-556">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="db31e-557">**Kør forespørgsel:** *Ja* (denne indstilling er valgfri, men den anbefales for at opnå den optimale ydeevne).</span><span class="sxs-lookup"><span data-stu-id="db31e-557">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="db31e-558">Vælg **Gem** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-558">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="db31e-559">Valgfrit: Hvis du konfigurerer et kundespecifikt etiketdesign, skal du oprette en forespørgsel for at finde kundens konto.</span><span class="sxs-lookup"><span data-stu-id="db31e-559">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="db31e-560">Gå til oversigtspanelet **Detaljer om bølgeetiketskabeloner**, og vælg **Rediger forespørgsel**.</span><span class="sxs-lookup"><span data-stu-id="db31e-560">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="db31e-561">I dialogboksen for forespørgselseditor skal du derefter under fanen **Område** tilføje en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-561">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-562">**Tabel:** *Forsendelser*</span><span class="sxs-lookup"><span data-stu-id="db31e-562">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="db31e-563">**Afledt tabel:** *Forsendelser*</span><span class="sxs-lookup"><span data-stu-id="db31e-563">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="db31e-564">**Felt:** *Kontonummer*</span><span class="sxs-lookup"><span data-stu-id="db31e-564">**Field:** *Account number*</span></span>
    - <span data-ttu-id="db31e-565">**Kriterier:** Angiv det relevante debitorkontonummer.</span><span class="sxs-lookup"><span data-stu-id="db31e-565">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="db31e-566">Når du er færdig, skal du vælge **OK** for at lukke dialogboksen for forespørgselseditor.</span><span class="sxs-lookup"><span data-stu-id="db31e-566">When you've finished, select **OK** to close the query editor dialog box.</span></span>

1. <span data-ttu-id="db31e-567">I handlingsruden skal du vælge **Rediger forespørgsel** for at at åbne dialogboksen for forespørgselseditoren for hele etiketskabelonen.</span><span class="sxs-lookup"><span data-stu-id="db31e-567">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="db31e-568">I dialogboksen for forespørgselseditor skal du under fanen **Sortering** tilføje en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-568">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-569">**Tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-569">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-570">**Afledt tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-570">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-571">**Felt:** *Referencelastlinje-id (post-id)*</span><span class="sxs-lookup"><span data-stu-id="db31e-571">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="db31e-572">**Søgeretning:** *Stigende*</span><span class="sxs-lookup"><span data-stu-id="db31e-572">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="db31e-573">Tilføj en anden række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-573">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-574">**Tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-574">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-575">**Afledt tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-575">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-576">**Felt:** *Forsendelses-id*</span><span class="sxs-lookup"><span data-stu-id="db31e-576">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="db31e-577">**Søgeretning:** *Stigende*</span><span class="sxs-lookup"><span data-stu-id="db31e-577">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="db31e-578">Vælg **OK** for at lukke dialogboksen for forespørgselseditoren.</span><span class="sxs-lookup"><span data-stu-id="db31e-578">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="db31e-579">I en meddelelsesboks beder dig om at bekræfte nulstillingen af grupperingsfunktionen.</span><span class="sxs-lookup"><span data-stu-id="db31e-579">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="db31e-580">Vælg **Ja** for at fortsætte.</span><span class="sxs-lookup"><span data-stu-id="db31e-580">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="db31e-581">Gå til handlingsruden, og vælg **Gruppe af bølgeetiketskabeloner**.</span><span class="sxs-lookup"><span data-stu-id="db31e-581">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="db31e-582">Gå til dialogboksen **Gruppe af bølgeetiketskabeloner**, og angiv følgende værdier for hver række i feltet **Referencefeltnavn**, der er angivet til *Forsendelses-id*:</span><span class="sxs-lookup"><span data-stu-id="db31e-582">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="db31e-583">**Udskriv brudetiket:** Markér dette afkrydsningsfelt.</span><span class="sxs-lookup"><span data-stu-id="db31e-583">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="db31e-584">**Etiketlayout-id:** Vælg en brudetiket.</span><span class="sxs-lookup"><span data-stu-id="db31e-584">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="db31e-585">(Du kan f.eks. vælge det etiketlayout for *Brud*, som du har oprettet tidligere i dette scenarie.)</span><span class="sxs-lookup"><span data-stu-id="db31e-585">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="db31e-586">**Printernavn:** Vælg printeren til brudetiketten.</span><span class="sxs-lookup"><span data-stu-id="db31e-586">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="db31e-587">(Hvis du vil opdele etiketten, skal du son regel vælge den samme printer, som er valgt i oversigtspanelet **Detaljer om bølgetiketskabeloner**.</span><span class="sxs-lookup"><span data-stu-id="db31e-587">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="db31e-588">Andre scenarier er dog mulige.)</span><span class="sxs-lookup"><span data-stu-id="db31e-588">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="db31e-589">Når det gælder den række, hvor feltet **Referencefeltnavn** er indstillet til *Referencelastlinje-id*, skal du markere afkrydsningsfeltet **Etiket-build-id**.</span><span class="sxs-lookup"><span data-stu-id="db31e-589">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="db31e-590">Denne opsætning opretter en etiketserie ("karton 1 af X") pr. lastlinje i hele bølgen, uanset opsætningen af arbejdsgrupperingen.</span><span class="sxs-lookup"><span data-stu-id="db31e-590">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="db31e-591">Denne etiketserie kan udskrives på et etiketlayout.</span><span class="sxs-lookup"><span data-stu-id="db31e-591">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="db31e-592">Derudover vil etiketter til forskellige forsendelser blive adskilt af den valgte brudetiket.</span><span class="sxs-lookup"><span data-stu-id="db31e-592">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

1. <span data-ttu-id="db31e-593">Vælg **OK** for at lukke dialogboksen **Gruppe af bølgeetiketskabeloner**.</span><span class="sxs-lookup"><span data-stu-id="db31e-593">Select **OK** to close the **Wave label template group** dialog box.</span></span>
1. <span data-ttu-id="db31e-594">Opret en anden etiketskabelon, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-594">Create a second label template that has the following settings:</span></span>

    - <span data-ttu-id="db31e-595">**Navn på etiketskabelon:** *Palleetiketter*</span><span class="sxs-lookup"><span data-stu-id="db31e-595">**Label template name:** *Pallet labels*</span></span>
    - <span data-ttu-id="db31e-596">**Beskrivelse:** *Palleetiketter*</span><span class="sxs-lookup"><span data-stu-id="db31e-596">**Description:** *Pallet labels*</span></span>
    - <span data-ttu-id="db31e-597">**Kode for bølgetrin:** *Palle*</span><span class="sxs-lookup"><span data-stu-id="db31e-597">**Wave step code:** *Pallet*</span></span>
    - <span data-ttu-id="db31e-598">**Lagersted:** *62*</span><span class="sxs-lookup"><span data-stu-id="db31e-598">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="db31e-599">I oversigtspanelet **Generelt** skal du i feltet **Bølgeetikettype** vælge en værdi som f.eks. *Palle*.</span><span class="sxs-lookup"><span data-stu-id="db31e-599">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Pallet*.</span></span>
1. <span data-ttu-id="db31e-600">I oversigtspanelet **Detaljer om bølgeetiketskabeloner** skal du tilføje en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-600">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-601">**Etiketlayout-id:** *Pakke*</span><span class="sxs-lookup"><span data-stu-id="db31e-601">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="db31e-602">**Printernavn:** Vælg en relevant ZPL-printer.</span><span class="sxs-lookup"><span data-stu-id="db31e-602">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="db31e-603">**Kør forespørgsel:** *Ja* (denne indstilling er valgfri, men den anbefales for at opnå den optimale ydeevne).</span><span class="sxs-lookup"><span data-stu-id="db31e-603">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="db31e-604">Vælg **Gem** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-604">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="db31e-605">Valgfrit: Hvis du konfigurerer et kundespecifikt etiketdesign, skal du oprette en forespørgsel for at finde kundens konto.</span><span class="sxs-lookup"><span data-stu-id="db31e-605">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="db31e-606">Gå til oversigtspanelet **Detaljer om bølgeetiketskabeloner**, og vælg **Rediger forespørgsel**.</span><span class="sxs-lookup"><span data-stu-id="db31e-606">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="db31e-607">I dialogboksen for forespørgselseditor skal du derefter under fanen **Område** tilføje en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-607">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-608">**Tabel:** *Forsendelser*</span><span class="sxs-lookup"><span data-stu-id="db31e-608">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="db31e-609">**Afledt tabel:** *Forsendelser*</span><span class="sxs-lookup"><span data-stu-id="db31e-609">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="db31e-610">**Felt:** *Kontonummer*</span><span class="sxs-lookup"><span data-stu-id="db31e-610">**Field:** *Account number*</span></span>
    - <span data-ttu-id="db31e-611">**Kriterier:** Angiv det relevante debitorkontonummer.</span><span class="sxs-lookup"><span data-stu-id="db31e-611">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="db31e-612">Når du er færdig, skal du vælge **OK** for at lukke dialogboksen for forespørgselseditor.</span><span class="sxs-lookup"><span data-stu-id="db31e-612">When you've finished, select **OK** to close the query editor dialog box.</span></span> 

1. <span data-ttu-id="db31e-613">I handlingsruden skal du vælge **Rediger forespørgsel** for at at åbne dialogboksen for forespørgselseditoren for hele etiketskabelonen.</span><span class="sxs-lookup"><span data-stu-id="db31e-613">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="db31e-614">I dialogboksen for forespørgselseditor skal du under fanen **Sortering** tilføje en række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-614">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-615">**Tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-615">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-616">**Afledt tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-616">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-617">**Felt:** *Referencelastlinje-id (post-id)*</span><span class="sxs-lookup"><span data-stu-id="db31e-617">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="db31e-618">**Søgeretning:** *Stigende*</span><span class="sxs-lookup"><span data-stu-id="db31e-618">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="db31e-619">Tilføj en anden række, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-619">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="db31e-620">**Tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-620">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-621">**Afledt tabel:** *Arbejdslinjer*</span><span class="sxs-lookup"><span data-stu-id="db31e-621">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="db31e-622">**Felt:** *Forsendelses-id*</span><span class="sxs-lookup"><span data-stu-id="db31e-622">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="db31e-623">**Søgeretning:** *Stigende*</span><span class="sxs-lookup"><span data-stu-id="db31e-623">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="db31e-624">Vælg **OK** for at lukke dialogboksen for forespørgselseditoren.</span><span class="sxs-lookup"><span data-stu-id="db31e-624">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="db31e-625">I en meddelelsesboks beder dig om at bekræfte nulstillingen af grupperingsfunktionen.</span><span class="sxs-lookup"><span data-stu-id="db31e-625">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="db31e-626">Vælg **Ja** for at fortsætte.</span><span class="sxs-lookup"><span data-stu-id="db31e-626">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="db31e-627">Gå til handlingsruden, og vælg **Gruppe af bølgeetiketskabeloner**.</span><span class="sxs-lookup"><span data-stu-id="db31e-627">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="db31e-628">Gå til dialogboksen **Gruppe af bølgeetiketskabeloner**, og angiv følgende værdier for hver række i feltet **Referencefeltnavn**, der er angivet til *Forsendelses-id*:</span><span class="sxs-lookup"><span data-stu-id="db31e-628">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="db31e-629">**Udskriv brudetiket:** Markér dette afkrydsningsfelt.</span><span class="sxs-lookup"><span data-stu-id="db31e-629">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="db31e-630">**Etiketlayout-id:** Vælg en brudetiket.</span><span class="sxs-lookup"><span data-stu-id="db31e-630">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="db31e-631">(Du kan f.eks. vælge det etiketlayout for *Brud*, som du har oprettet tidligere i dette scenarie.)</span><span class="sxs-lookup"><span data-stu-id="db31e-631">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="db31e-632">**Printernavn:** Vælg printeren til brudetiketten.</span><span class="sxs-lookup"><span data-stu-id="db31e-632">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="db31e-633">(Hvis du vil opdele etiketten, skal du son regel vælge den samme printer, som er valgt i oversigtspanelet **Detaljer om bølgetiketskabeloner**.</span><span class="sxs-lookup"><span data-stu-id="db31e-633">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="db31e-634">Andre scenarier er dog mulige.)</span><span class="sxs-lookup"><span data-stu-id="db31e-634">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="db31e-635">Når det gælder den række, hvor feltet **Referencefeltnavn** er indstillet til *Referencelastlinje-id*, skal du markere afkrydsningsfeltet **Etiket-build-id**.</span><span class="sxs-lookup"><span data-stu-id="db31e-635">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="db31e-636">Denne opsætning opretter en etiketserie ("karton 1 af X") pr. lastlinje i hele bølgen, uanset opsætningen af arbejdsgrupperingen.</span><span class="sxs-lookup"><span data-stu-id="db31e-636">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="db31e-637">Denne etiketserie kan udskrives på et etiketlayout.</span><span class="sxs-lookup"><span data-stu-id="db31e-637">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="db31e-638">Derudover vil etiketter til forskellige forsendelser blive adskilt af den valgte brudetiket.</span><span class="sxs-lookup"><span data-stu-id="db31e-638">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="db31e-639">Konfigurere nummerserieudvidelser</span><span class="sxs-lookup"><span data-stu-id="db31e-639">Configure number sequence extensions</span></span>

<span data-ttu-id="db31e-640">Nummerserieudvidelser styrer GS1-overholdelse af specifikke nummerserier.</span><span class="sxs-lookup"><span data-stu-id="db31e-640">Number sequence extensions control the GS1 compliance of specific number sequences.</span></span> <span data-ttu-id="db31e-641">Denne konfiguration er valgfri for det aktuelle scenarie.</span><span class="sxs-lookup"><span data-stu-id="db31e-641">This configuration is optional for the current scenario.</span></span> <span data-ttu-id="db31e-642">Du kan finde flere oplysninger og konfigurationsinstruktioner under [Konfigurere nummerserieudvidelser](../warehousing/configure-number-sequence-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="db31e-642">For more information and configuration instructions, see [Configure number sequence extensions](../warehousing/configure-number-sequence-extensions.md).</span></span>

### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="db31e-643">Oprette en salgsordre og frigive den til lagerstedet</span><span class="sxs-lookup"><span data-stu-id="db31e-643">Create a sales order and release it to the warehouse</span></span>

1. <span data-ttu-id="db31e-644">Gå til **Salg og marketing \> Salgsordrer \> Alle salgsordrer**.</span><span class="sxs-lookup"><span data-stu-id="db31e-644">Go to **Sales and marketing \> Sales order \> All sales orders**.</span></span>
1. <span data-ttu-id="db31e-645">Opret salgsordre, der har følgende indstillinger:</span><span class="sxs-lookup"><span data-stu-id="db31e-645">Create a sales order that has the following settings:</span></span>

    - <span data-ttu-id="db31e-646">**Debitorkonto:** *US-001*</span><span class="sxs-lookup"><span data-stu-id="db31e-646">**Customer account:** *US-001*</span></span>
    - <span data-ttu-id="db31e-647">**Lagersted:** *62*</span><span class="sxs-lookup"><span data-stu-id="db31e-647">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="db31e-648">Tilføj to salgsordrelinjer:</span><span class="sxs-lookup"><span data-stu-id="db31e-648">Add two sales order lines:</span></span>

    - <span data-ttu-id="db31e-649">Salgsordrelinje 1:</span><span class="sxs-lookup"><span data-stu-id="db31e-649">Sales order line 1:</span></span>

        - <span data-ttu-id="db31e-650">**Varenummer:** *A0001*</span><span class="sxs-lookup"><span data-stu-id="db31e-650">**Item number:** *A0001*</span></span>
        - <span data-ttu-id="db31e-651">**Antal:** *9024*</span><span class="sxs-lookup"><span data-stu-id="db31e-651">**Quantity:** *9024*</span></span>
        - <span data-ttu-id="db31e-652">**Enhed:** *hver* (9024 hver = 376 boks = 47 PL)</span><span class="sxs-lookup"><span data-stu-id="db31e-652">**Unit:** *ea* (9024 ea = 376 Box = 47 PL)</span></span>

    - <span data-ttu-id="db31e-653">Salgsordrelinje 2:</span><span class="sxs-lookup"><span data-stu-id="db31e-653">Sales order line 2:</span></span>

        - <span data-ttu-id="db31e-654">**Varenummer:** *A0002*</span><span class="sxs-lookup"><span data-stu-id="db31e-654">**Item number:** *A0002*</span></span>
        - <span data-ttu-id="db31e-655">**Antal:** *9016*</span><span class="sxs-lookup"><span data-stu-id="db31e-655">**Quantity:** *9016*</span></span>
        - <span data-ttu-id="db31e-656">**Enhed:** *hver* (9016 hver = 322 boks = 46 PL)</span><span class="sxs-lookup"><span data-stu-id="db31e-656">**Unit:** *ea* (9016 ea = 322 Box = 46 PL)</span></span>

    > [!NOTE]
    > <span data-ttu-id="db31e-657">De varer og antal, der angives her, er kun eksempler.</span><span class="sxs-lookup"><span data-stu-id="db31e-657">The items and quantities that are provided here are only examples.</span></span> <span data-ttu-id="db31e-658">De skal bruge den enhedsseriegruppe, du har defineret tidligere, relevante enhedskonverteringer fra *hver* til *boks* til *PL* skal defineres for dem, og de skal have lager på lagerstedet *62*.</span><span class="sxs-lookup"><span data-stu-id="db31e-658">They must use the unit sequence group that you defined earlier, appropriate unit conversions from *ea* to *Box* to *PL* must be defined for them, and they must have stock in warehouse *62*.</span></span> <span data-ttu-id="db31e-659">Du kan finde flere oplysninger i [Måleenhed og lagerføringspolitikker](unit-measure-stocking-policies.md).</span><span class="sxs-lookup"><span data-stu-id="db31e-659">For more information, see [Unit of measure and stocking policies](unit-measure-stocking-policies.md).</span></span>

1. <span data-ttu-id="db31e-660">Vælg salgsordrelinje 1.</span><span class="sxs-lookup"><span data-stu-id="db31e-660">Select sales order line 1.</span></span> <span data-ttu-id="db31e-661">I sektionen **Salgsordrelinje** skal du i menuen **Lager** vælge **Reservationer**.</span><span class="sxs-lookup"><span data-stu-id="db31e-661">Then, in the **Sales order line** section, on the **Inventory** menu, select **Reservations**.</span></span>
1. <span data-ttu-id="db31e-662">På siden **Reservation** skal du i handlingsruden vælge **Reserver parti** og derefter lukke siden.</span><span class="sxs-lookup"><span data-stu-id="db31e-662">On the **Reservation** page, on the Action Pane, select **Reserve lot**, and then close the page.</span></span>
1. <span data-ttu-id="db31e-663">Gentag trin 4 og 5 for salgsordrelinje 2.</span><span class="sxs-lookup"><span data-stu-id="db31e-663">Repeat steps 4 and 5 for sales order line 2.</span></span>
1. <span data-ttu-id="db31e-664">Vælg **Frigør til lagersted** under fanen **Lagersted** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-664">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>

    <span data-ttu-id="db31e-665">Følgende hændelser forekommer:</span><span class="sxs-lookup"><span data-stu-id="db31e-665">The following events occur:</span></span> 

    - <span data-ttu-id="db31e-666">Systemet behandler den oprettede forsendelse ved hjælp af den skabelon, der indeholder trinnet til udskrivning af etiketter.</span><span class="sxs-lookup"><span data-stu-id="db31e-666">The system processes the created shipment by using the template that includes the label printing step.</span></span> <span data-ttu-id="db31e-667">Etiketlayoutet bruges til at definere etikettens format, og resultatet vil være en etiket, der udskrives på den printer, der er valgt i etiketskabelonen.</span><span class="sxs-lookup"><span data-stu-id="db31e-667">The label layout will be used to define the format of the label, and the result will be a label that is printed on the printer that is selected in the label template.</span></span>
    - <span data-ttu-id="db31e-668">Der genereres og udskrives bølgeetiketter.</span><span class="sxs-lookup"><span data-stu-id="db31e-668">Wave labels are generated and printed.</span></span> <span data-ttu-id="db31e-669">Antallet af etiketter vil være lig med antallet af kartoner (i dette eksempel 376 boks-etiketter til linje 1, 322 boks-etiketter til linje 2, 47 palle-etiketter til linje 1, 47 palle-etiketter til linje 2 og to brudetiketter, der har forsendelses-id'et).</span><span class="sxs-lookup"><span data-stu-id="db31e-669">The number of labels will equal the number of cartons (in this example, 376 Box labels for line 1, 322 Box labels for line 2, 47 PL labels for line 1, 47 PL labels for line 2, and two break labels that have the shipment ID).</span></span>
    - <span data-ttu-id="db31e-670">Der genereres et nyt fragtseddel-id for forsendelserne.</span><span class="sxs-lookup"><span data-stu-id="db31e-670">A new bill of lading ID is generated for the shipments.</span></span> <span data-ttu-id="db31e-671">Hvis du har konfigureret nummerserieudvidelserne, følger bølgeetiket-id'erne **SSCC-18**-nummerformatet.</span><span class="sxs-lookup"><span data-stu-id="db31e-671">If you configured the number sequence extensions, the wave label IDs will follow the **SSCC-18** number format.</span></span> 

<span data-ttu-id="db31e-672">Du kan få vist og udskrive bølgeetiketter fra følgende sider:</span><span class="sxs-lookup"><span data-stu-id="db31e-672">You can view and reprint wave labels from the following pages:</span></span>

- <span data-ttu-id="db31e-673">Alle forsendelser \> Forsendelsesoplysninger</span><span class="sxs-lookup"><span data-stu-id="db31e-673">All shipments \> Shipment details</span></span>
- <span data-ttu-id="db31e-674">Alle laster \> Lastdetaljer</span><span class="sxs-lookup"><span data-stu-id="db31e-674">All loads \> Load details</span></span>
- <span data-ttu-id="db31e-675">Alle bølger</span><span class="sxs-lookup"><span data-stu-id="db31e-675">All waves</span></span>
- <span data-ttu-id="db31e-676">Bølgelabels</span><span class="sxs-lookup"><span data-stu-id="db31e-676">Wave labels</span></span>
- <span data-ttu-id="db31e-677">Historik for bølgelabel</span><span class="sxs-lookup"><span data-stu-id="db31e-677">Wave label history</span></span>

<span data-ttu-id="db31e-678">På de fleste af disse sider kan du finde den relevante funktion ved at vælge **Bølgeetiketter** i gruppen **Relaterede oplysninger** under fanen **Forsendelser** i handlingsruden.</span><span class="sxs-lookup"><span data-stu-id="db31e-678">For most of these pages, you can find the relevant function by selecting **Wave labels** in the **Related information** group on the **Shipments** tab of the Action Pane.</span></span>

## <a name="additional-resources"></a><span data-ttu-id="db31e-679">Yderligere ressourcer</span><span class="sxs-lookup"><span data-stu-id="db31e-679">Additional resources</span></span>

- [<span data-ttu-id="db31e-680">Genudskrive bølgeetiketter og erklære bølgeetiketter ugyldige</span><span class="sxs-lookup"><span data-stu-id="db31e-680">Reprint and void wave labels</span></span>](reprint-and-void-wave-labels.md)
