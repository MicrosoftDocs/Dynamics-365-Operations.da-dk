...
> [!IMPORTANT]
> *Indgående ASN*-import gælder kun for varer, der er aktiveret til lagerstedsstyringsprocesser (WMS). Før du modtager en ASN, skal der være registreret en indkøbsordre i systemet for den leverandør, der sender ASN'en.
