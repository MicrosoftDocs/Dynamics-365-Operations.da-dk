---
title: Behandling af fastvægtprodukt med lokationsstyring
description: Denne artikel beskriver, hvordan du kan bruge arbejdsskabeloner og lokationsvejledninger til at bestemme, hvordan og hvor arbejde skal udføres på lageret.
author: perlynne
ms.date: 08/13/2020
ms.topic: article
ms.prod: ''
...
Du kan finde flere oplysninger i [Konfigurere og vedligeholde fastvægtvarer](/dynamicsax-2012/appuser-itpro/setting-up-and-maintaining-catch-weight-items).
