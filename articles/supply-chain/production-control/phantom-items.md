...
I følgende illustration er (a) styklisten for produktet H og delene F og G, og (b) er rutearket for produkt H og del F.

![Eksempel på en styklistestruktur i to niveauer.](media/product-H-part-F.png)
...
![Styklistetekniker for produkt H.](media/product-H-part-B.png)
...
![Den fantomlinjetype, der bruges i styklistestrukturer med flere niveauer.](media/product-G-route-sheet-G.png)
...
![Eksempel på et rutenetværk, der bruges i en stykliste med flere niveauer.](media/product-G-part-F.png)

I følgende illustration er (a) styklisten for produkt G og del F, og (b) er rutearket for produkt G og del F.

![Styklisten for produkt G og del F samt rutearket for produkt G og del F.](media/product-G-part-F-with-route-sheet.png)
