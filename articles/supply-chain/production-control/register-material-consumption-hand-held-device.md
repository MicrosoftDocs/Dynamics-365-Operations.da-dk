...
## <a name="set-up-theworkflow-to-register-consumption-using-a-handheld-device"></a>Konfigurere arbejdsgangen for at registrere forbrug ved hjælp af en håndholdt enhed
