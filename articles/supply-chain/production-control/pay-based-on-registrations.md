...
description: Denne artikel forklarer, hvordan løn beregnes baseret på arbejderregistreringer.
...
ms.locfileid: "8844374"
---
# <a name="pay-based-on-registrations"></a>Løn på basis af registreringer

[!include [banner](../includes/banner.md)]

Denne artikel forklarer detaljeret, hvordan løn beregnes baseret på arbejderregistreringer. Det indeholder eksempler på, hvordan de forskellige kombinationer af opsætningsindstillinger, der er tilgængelige for beregning, påvirker resultatet. Her er nogle af de områder, der behandles:
