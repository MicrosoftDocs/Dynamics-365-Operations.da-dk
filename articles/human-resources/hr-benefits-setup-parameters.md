...
2. Angiv værdier for følgende felter under fanen **Generelt** :
   ...
   | **Årlig løn som personalegoder** | Giver dig mulighed for at angive et beløb for **Årlig frynsegodeløn** for en medarbejder. Human Resources skal bruge beløbet for **Årlig frynsegodeløn** til bestemmelse af dækningsbeløb i stedet for disponerings beløb, i stedet for det årlige beløb for fast løn. |
