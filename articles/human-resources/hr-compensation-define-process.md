...
1. Gå til **kompensationsstyring** > **Proces** > **Kompensationsprocesser**.
2. Klik på **Ny kompensastionsproces**.
3. Skriv en værdi i **Procesfeltet**.
...
17. I feltet **Plan** indtastes eller vælges en værdi.
