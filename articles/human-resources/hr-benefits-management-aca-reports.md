...
description: Denne artikel beskriver, hvordan Frynsegodeadministration sporer de oplysninger, der er rapporteret på formular 1095-B og 1095-C for Affordable Care Act (ACA) Employer Mandate.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
