...
description: Denne artikel beskriver, hvordan der foretages fejlfinding af poster, som ikke synkroniseres korrekt mellem Microsoft Dynamics 365 Human Resources og HCM (styring af menneskelig kapital) Fælles løsning i Microsoft Dataverse.
author: jaredha
ms.date: 09/27/2021
ms.topic: article
ms.prod: ''
