...
3. Angiv værdier for følgende felter:
   ...
   | Beregning af lønfrekvenssats | Metoden til beregning af betalingsfrekvens: standard eller årlig. |
   ...
   | Skift ikrafttrædelsesdato | Den dato, hvor ændringen af frynsegodesatsen træder i kraft. Systemet vil automatisk ændre frynsegodesatsen og opdatere alle de frynsegodeplaner, der er tilknyttet denne sats, hvis du kører behandling af opdatering af ændret sats. Du bør ikke angive denne dato, medmindre du ønsker, at systemet automatisk skal opdatere medarbejdernes frynsegodeplaner baseret på denne sats. Dette er normalt reserveret til automatisk behandling af fremtidige satsændringer. Ændringens ikrafttrædelsesdatoen skal ligge inden for frynsegodesatsens gyldigheds- og udløbsdato. |
...
3. Angiv værdier for følgende felter:
   ...
   | Administrativt beløb | Det administrationsbeløb, som en tredjepartsadministrator opkræver. Det er det beløb, som arbejdsgiveren betaler til tredjepartsadministratoren, og det bør baseres på betalingsfrekvensen for satsopsætningen. |
   | Flekskreditsats for ikke-ryger | Antallet af flekskreditter, som frynsegodet koster, baseret på den beregning, der er defineret for niveauet for ikke-rygere. Hvis beregningstypen f.eks. er 'Pr. $ dækningsbeløbet', vil beregningsbeløbet være 10.000, og flekskreditsatsen for ikke-rygere er 6, dvs. at hvis en medarbejder, der er ikke-ryger, vælger en dækning på $10.000, vil det koste 6 flekskreditter. Hvis de vælger en dækning på $20.000, koster det 12 flekskreditter osv. |
