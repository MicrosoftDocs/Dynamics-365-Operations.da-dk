...
ms.locfileid: "5891000"
---
# <a name="whats-new-or-changed-in-dynamics-365-human-resources-february-3-2020"></a>Nyheder eller ændringer i Dynamics 365 Human Resources (3. februar 2020)

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

[!include [rename-banner](~/includes/cc-data-platform-banner.md)]

I denne artikel beskrives funktioner, der enten er nye eller ændrede i Dynamics 365 Human Resources. Ændringerne gælder for build nummer 8.1.2809. Tallene i parenteser i nogle overskrifter henviser til supportnumre i Microsoft Dynamics Lifecycle Services (LCS).

## <a name="cant-remove-activities-from-performance-review-form-403542"></a>Aktiviteter kan ikke fjernes fra formularen Performance-gennemgang (403542)

Du kan nu slette de valgte aktiviteter ved hjælp af knappen **Fjern** i formularen **Performance-gennemgang**.
...
- **Prøveversionsfunktion: Administration af frynsegoder** – Du kan finde flere oplysninger, herunder kendte problemer, i [Oversigt over Administration af frynsegoder](hr-benefits-management-overview.md).
