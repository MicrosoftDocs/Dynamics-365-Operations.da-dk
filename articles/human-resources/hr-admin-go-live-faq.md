...
Oplysninger om, hvordan du vælger det korrekte datacenter, finder du under [Netværkskrav](https://docs.microsoft.com/dynamics365/fin-ops-core/fin-ops/get-started/system-requirements#network-requirements). 
...
- Du kan installere en Azure SQL-database i din egen Azure-lejer og bruge BYOD-funktionen (Bring Your Own Database) til at synkronisere data. Yderligere oplysninger finder du i afsnittet [Bruge din egen database (BYOD)](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/analytics/export-entities-to-your-own-database).

- Du kan bruge Common Data Service-integration til at synkronisere udvalgte enheder i Common Data Service-databasen. Du kan finde flere oplysninger under [Common Data Service-enheder](hr-developer-entities.md). 
...
Microsoft opbevarer et tilstrækkeligt antal sikkerhedskopier, der giver mulighed for gendannelse til bestemt tidspunkt (PITR) inden for de seneste syv dage. 

Du kan finde flere oplysninger i  [Få mere at vide om automatiske sikkerhedskopieringer af SQL Database](https://docs.microsoft.com/azure/azure-sql/database/automated-backups-overview?tabs=single-database). 
...
Hvis du vil rapportere en produktionsafbrydelse, skal du følge den proces, der er beskrevet under  [Rapportere en produktionsafbrydelse](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/lifecycle-services/report-production-outage). 
