...
2. Klik på **Detaljer for stilling**.
    * Rediger **Startdato** for arbejderen.  
    * Rediger **Slutdato** for arbejderen.  
    * Rediger **Arbejdertype** for arbejderen, hvis det er nødvendigt.  
3. Skriv en værdi i feltet **Fornavn**.
4. Skriv en værdi i feltet **Mellemnavn**.
5. Skriv en værdi i feltet **Efternavn**.
