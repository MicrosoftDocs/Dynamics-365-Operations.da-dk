...
De fleste Common Data Service-enheder understøtter brugerdefinerede felter. Du kan få vist en komplet liste over Common Data Service-enheder, i [Common Data Service-enheder](https://docs.microsoft.com/dynamics365/human-resources/hr-developer-entities). 

Sørg for at aktivere eventuelle brugerdefinerede felter, du opretter, så du kan bruge dem i Common Data Service. Du kan finde flere oplysninger [Visning af brugerdefinerede felter på dataenheder](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/get-started/user-defined-fields#exposing-custom-fields-on-data-entities).

## <a name="see-also"></a>Se også

[Common Data Service-enheder](https://docs.microsoft.com/dynamics365/human-resources/hr-developer-entities)</br>
