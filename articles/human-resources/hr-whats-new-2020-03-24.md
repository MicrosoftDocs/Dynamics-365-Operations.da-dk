...
## <a name="unable-to-adjust-leave-balance-for-a-plan-with-no-accruals-that-was-created-with-multiple-leave-type-feature-on-419635"></a>Kunne ikke regulere saldoen for en plan uden periodiseringer, der er oprettet med funktionen til "flere orlovstyper" slået til (419635)

Med denne ændring kan du justere saldi for orlovsplaner, der er oprettet med prøvefunktionen Flere orlovstyper aktiveret i Funktionsstyring.
