...
description: Denne artikel beskriver masseansættelsesprojekter, så HR-specialister kan oprette flere stillinger og effektivt ansætte arbejdere til disse stillinger.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
