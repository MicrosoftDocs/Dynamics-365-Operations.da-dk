...
Videoen [Sådan bruges påmindelser til at overvåge filtrerede data](https://youtu.be/ZYKMcv6kl9s) (vises ovenfor) er inkluderet på [Finance and Operations-afspilningslisten](https://www.youtube.com/playlist?list=PLcakwueIHoT_SYfIaPGoOhloFoCXiUSyW), som er tilgængelig på YouTube.
...
Videoen [Indstillinger for påmindelsesregel](https://youtu.be/cpzimwOjicM) (vist ovenfor) er inkluderet på [Finance and Operations-afspilningslisten](https://www.youtube.com/playlist?list=PLcakwueIHoT_SYfIaPGoOhloFoCXiUSyW), som er tilgængelig på YouTube.
