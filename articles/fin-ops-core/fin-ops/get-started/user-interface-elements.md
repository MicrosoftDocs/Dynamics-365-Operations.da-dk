...
description: Denne artikel beskriver brugergrænsefladeelementerne i appen.
author: tlefor
ms.date: 08/09/2019
ms.topic: article
ms.prod: ''
...
Denne artikel beskriver de brugergrænsefladeelementer, der benyttes i appen. Før brugerne kan navigere i grænsefladen, er det vigtigt at kende navnene og funktionerne for de elementer, der udgør grænsefladen.
