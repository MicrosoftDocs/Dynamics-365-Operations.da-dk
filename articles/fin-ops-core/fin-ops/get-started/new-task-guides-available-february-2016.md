...
description: Denne artikel viser de opgaveguider, der er udgivet til Microsoft BPM-biblioteker pr. februar 2016.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8861728"
---
# <a name="new-task-guides-february-2016"></a>Nye opgaveguider (februar 2016)

[!include [banner](../includes/banner.md)]

Denne artikel viser de opgaveguider, der er udgivet til Microsoft BPM-biblioteker pr. februar 2016. De biblioteker, der er udgivet, omfatter (februar 2016) APQC Unified-biblioteket til Microsoft Dynamics AX og (februar 2016) Introduktion.
...
| Opsætte og generere aldersfordelte oplysninger om debitorer   | Globalt         |
...
| BPM-linje                                                            | Land/område |
|---------------------------------------------------------------------|----------------|
| Sammenligne aktive, estimerede og realiserede omkostninger for en produktionsordre | Globalt         |
...
| Vise lageropgørelse og KPI efter omkostningsobjekt                     | Globalt         |
...
| BPM-linje                                                                                 | Land/område |
|------------------------------------------------------------------------------------------|----------------|
| Analysere spørgeskemaresultater                                                            | Globalt         |
...
| Overføre et anlægsaktiv                                    | Globalt         |

### <a name="general-ledger"></a>Finans

| BPM-linje                                                          | Land/område |
|-------------------------------------------------------------------|----------------|
| Lukke regnskabsåret                                             | Globalt         |
...
|------------------------------------------------------------------|----------------|
| Analysere spørgeskemaresultater                                    | Globalt         |
| Godkende indbakkeposter i program                                | Globalt         |
...
| Kontrollere tilgængelighed af lagerbeholdning                                                   | Globalt         |
...
| Overføre fysisk lager på lagersted                                  | Globalt         |

### <a name="manufacturing"></a>Produktion

| BPM-linje                                                      | Land/område |
|---------------------------------------------------------------|----------------|
| Føje en beregningspolitik for kanban-mængder til en kanban-regel     | Globalt         |
...
| BPM-linje                                          | Land/område |
|---------------------------------------------------|----------------|
| Definere dækningsregler for varer                   | Globalt         |
...
| Ændre en behovsprognose manuelt                 | Globalt         |

### <a name="organization-administration"></a>Virksomhedsadministration

| BPM-linje                                  | Land/område |
|-------------------------------------------|----------------|
| Skifte banner eller logo                 | Globalt         |
...
| Oprette nummerserier ved hjælp af en guide | Globalt         |
...
| Konfigurere et indkøbskategorihierarki                          | Globalt         |

### <a name="product-information-and-configuration"></a>Produktoplysninger og -konfiguration

| BPM-linje                                                           | Land/område |
|--------------------------------------------------------------------|----------------|
| Tilføje en beregning til en produktkonfigurationsmodel                 | Globalt         |
...
| Oprette et hierarki eller en produktklassifikation                       | Globalt         |
...
| BPM-linje                                                                          | Land/område |
|-----------------------------------------------------------------------------------|----------------|
| Tilknytte et brændstofindeks med en fragtmand som tillægsgebyr                    | Globalt         |
...
| Oprette et frigivet produkt for et enkelt firma     | Globalt         |
