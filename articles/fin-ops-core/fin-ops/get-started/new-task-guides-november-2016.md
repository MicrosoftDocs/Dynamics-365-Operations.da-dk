...
description: Denne artikel beskriver de nye eller opdaterede opgaveguider, der blev udgivet til Microsoft APQC Unified-biblioteket (november 2016 - alle sprog) til Microsoft Dynamics 365 for Operations. Der blev ikke udgivet noget nyt introduktionsbibliotek.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
| \*Kontrol af kinesisk bilagskontinuitet                                                                                               | Kina                             |
...
| \*Konfigurer basisprofil for momsintegration i Kina                                                                                 | Kina                             |
...
| \*EUR-00002 Angive en fragtadresse for en fællesskabspostering                                                          | Europa                            |
...
| BPM-linje                                                                   | Land/område |
|----------------------------------------------------------------------------|----------------|
| \*Ændre ejerskabet til konsignationslager ud fra produktionsbehov | Globalt         |
| \*Oprette en genopfyldningsordre til konsignation                                 | Globalt         |
| \*Overvåge konsignationslager ved hjælp af kreditorsamarbejde                 | Globalt         |
...
| BPM-linje                                                     | Land/område |
|--------------------------------------------------------------|----------------|
| \*Tilføje til performancekladde og sende ros til en person | Globalt         |
| \*Oprette et mål                                              | Globalt         |
| \*Oprette en performancegennemgang                                | Globalt         |
...
| \*Oprette et produktnummernomenklatur for foruddefinerede produktvarianter | Globalt         |
| \*Oprette et produktnummernomenklatur for konfigurerede produktvarianter | Globalt         |
...
| \*Konfigurere produktanbefalinger, der er baseret på maskinel indlæring   | Globalt         |
...
| \*Oprette et menupunkt for mobilenhedens id-konsolidering          | Globalt         |
