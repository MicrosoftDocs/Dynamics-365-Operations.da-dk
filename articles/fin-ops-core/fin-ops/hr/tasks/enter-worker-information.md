...
2. Klik på Detaljer for stilling.
    * Rediger startdatoen for arbejderen.  
    * Rediger slutdatoen for arbejderen.  
    * Ændr arbejdertypen for arbejderen, hvis det er nødvendigt.  
3. Skriv en værdi i feltet Fornavn.
4. Skriv en værdi i feltet Mellemnavn.
5. Indtast en værdi i feltet Efternavn.
    * Ændr jobbet for arbejderen, hvis det er nødvendigt.  
    * Ændr afdelingen for arbejderen, hvis det er nødvendigt.  
    * Ændr status for fuldtidsansat for arbejderen, hvis det er nødvendigt.  
6. Klik på OK.
