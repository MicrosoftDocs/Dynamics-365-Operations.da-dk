...
| Vis rapport                       | Åbn den seneste version af den genererede rapport. Denne kommando er tilgængelig fra en rapportdefinition, hvis du har oprettet mindst én rapport. |
...
|---------|--------------------------------------------------------------------------|
| Hjælp    | Åbn siden med Hjælp-artiklen om økonomirapportering. |
|         |                                                                          |
