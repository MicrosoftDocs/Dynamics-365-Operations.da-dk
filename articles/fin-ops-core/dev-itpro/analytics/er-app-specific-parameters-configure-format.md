...
Fra [Microsoft Download Center](https://go.microsoft.com/fwlink/?linkid=851448) skal du hente zip-filen **Understøt parameteriserede opkald om ER-datakilder af typen BEREGNET FELT**. Den zip-fil indeholder følgende ER-konfigurationer, der skal udtrækkes og gemmes lokalt.
...
1.  På oversigtspanelet **Versioner** skal du vælge **Skift status**.
2.  Vælg **Fuldfør**.
3.  Vælg **OK**.
...
2.  På fanen **Versioner** skal du vælge den post, der har statussen **Fuldført**.
3.  Vælg **Udveksling**.
