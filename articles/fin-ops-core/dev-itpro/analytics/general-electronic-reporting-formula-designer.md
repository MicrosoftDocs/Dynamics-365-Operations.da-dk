...
## <a name="Transformation">Dataformatering</a>
...
## <a name="Validation">Kontrol af procesforløb</a>
...
## <a name="Enabled">Kontrol af dokumentindhold</a>
...
## <a name="TestFormula">Validering af konfigurerede formler</a>
