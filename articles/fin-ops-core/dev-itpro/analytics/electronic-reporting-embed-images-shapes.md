...
description: Denne artikel forklarer, hvordan du bruger værktøjet elektronisk rapportering til at generere forretningsdokumenter, der har integrerede billeder og figurer.
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
