...
Listefunktioner til elektronisk rapportering (ER) kan bruges til at udtrække oplysninger fra og udføre handlinger på datakilder for datatyperne *Postliste* og *Container (post)*. Denne artikel indeholder en oversigt over disse funktioner.
