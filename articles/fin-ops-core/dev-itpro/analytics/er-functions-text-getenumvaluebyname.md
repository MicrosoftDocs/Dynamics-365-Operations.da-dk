...
description: Denne artikel indeholder oplysninger om, hvordan funktionen GETENUMVALUEBYNAME til elektronisk rapportering (ER) skal anvendes.
author: NickSelin
ms.date: 09/23/2020
ms.prod: ''
ms.technology: ''
