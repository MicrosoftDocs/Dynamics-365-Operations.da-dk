...
ms.locfileid: "9205658"
---
# <a name="view-and-design-financial-reports"></a>Vise og designe økonomiske rapporter

[!include [banner](../includes/banner.md)]

Denne artikel indeholder øvelser, der hjælper dig med visning og oprettelse af økonomirapporter til Microsoft Dynamics 365 Finance. Økonomirapportering består af en visuel oplevelse i programmet og en ClickOnce-rapportdesigner, hvor du kan oprette og redigere økonomirapporter.
...
2. Flyt dimensioner, så de er i følgende rækkefølge:
    ...
    > [!NOTE]
    > De andre dimensioner kan forblive i den rækkefølge, de er i i øjeblikket.
...
4. Peg på **Ny** i menuen **Filer**, og klik derefter på **Trædiagramdefinition**.
...
[Økonomirapportering](../../../finance/general-ledger/financial-reporting-getting-started.md)
