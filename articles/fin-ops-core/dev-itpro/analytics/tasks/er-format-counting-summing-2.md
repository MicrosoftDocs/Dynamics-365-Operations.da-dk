...
---
# <a name="er-configure-format-to-do-counting-and-summing-part-2-configure-computations"></a>ER Konfigurere format for at udføre optælling og sammenlægning (del 2: Konfigurere beregninger)
