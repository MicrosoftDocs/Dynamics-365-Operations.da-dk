...
description: Denne artikel beskriver, hvordan du konfigurerer et format for elektronisk rapportering til optælling og opsummering baseret på data fra det allerede genererede tekstoutput. (Del 4)
author: NickSelin
ms.date: 08/29/2018
