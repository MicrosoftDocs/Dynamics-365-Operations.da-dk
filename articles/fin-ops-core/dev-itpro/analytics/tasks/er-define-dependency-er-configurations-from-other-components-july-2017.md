...
description: Denne artikel beskriver, hvordan du designer en ER-konfiguration (elektronisk rapportering), og angiver dens afhængighed af andre softwarekomponenter.
author: kfend
ms.date: 07/23/2021
