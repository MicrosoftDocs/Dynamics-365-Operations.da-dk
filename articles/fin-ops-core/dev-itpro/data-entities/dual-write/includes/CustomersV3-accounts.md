## <a name="customers-v3-to-accounts"></a>Debitorer V3 til konti

Denne skabelon synkroniserer data mellem Finance and Operations-apps og Common Data Service.

Kildefilter: ((PartyType == "Organization"))

Tilbageført kildefilter: customertypecode eq 3
...
ingen | >> | address1_addresstypecode | 2
ingen | >> | customertypecode | 3
PARTYTYPE | << | ingen | Organisation
