...
+ Ved nye forekomster af Finans- og driftsapps begynder opsætningen af dobbeltskrivningsforbindelsen i Microsoft Dynamics Lifecycle Services (LCS). Hvis du har en licens til Microsoft Power Platform, vil du få et nyt Dataverse-miljø, hvis din lejer ikke har en.
+ Ved eksisterende forekomster af Finans- og driftsapps begynder opsætningen af dobbeltskrivningsforbindelsen i Finans- og driftsmiljøet.

Før du starter dobbeltskrivning på en enhed, kan du køre en indledende synkronisering for at håndtere eksisterende data på begge sider: Finans- og driftsapps og kundeengagementsapps. Du kan springe den første synkronisering over, hvis du ikke har brug for at synkronisere data mellem de to miljøer.
...
+ [En ny Finans- og driftsapp-forekomst og en ny forekomst af en kundeengagementsapp](#new-new)
+ [En ny Finans- og driftsapp-forekomst og en eksisterende forekomst af en kundeengagementsapp](#new-existing)
+ [En ny Finans- og driftsapp-forekomst, som har data, og en ny forekomst af kundeengagementsapp](#new-data-new)
+ [En ny Finans- og driftsapp-forekomst, som har data, og en eksisterende forekomst af kundeengagementsapp](#new-data-existing)
+ [En eksisterende Finans- og driftsapp-forekomst og en ny forekomst af en kundeengagementsapp](#existing-new)
+ [En eksisterende Finans- og driftsapp-forekomst og en eksisterende forekomst af en kundeengagementsapp](#existing-existing)

## <a name="a-new-finance-and-operations-app-instance-and-a-new-customer-engagement-app-instance"></a><a id="new-new"></a>En ny Finans- og driftsapp-forekomst og en ny forekomst af en kundeengagementsapp

Hvis du vil oprette en forbindelse med dobbeltskrivning mellem en ny forekomst af en Finans og drift-app, der ikke har data, og en ny forekomst af en kundeengagementsapp, skal du følge trinnene i [Konfiguration af dobbeltskrivning fra Lifecycle Services](lcs-setup.md). Når opsætningen af forbindelsen er fuldført, sker følgende handlinger automatisk:

- Der klargøres et nyt tomt Finans og driftsmiljø.
...
## <a name="a-new-finance-and-operations-app-instance-and-an-existing-customer-engagement-app-instance"></a><a id="new-existing"></a>En ny Finans- og driftsapp-forekomst og en eksisterende forekomst af en kundeengagementsapp

Hvis du vil oprette en forbindelse med dobbeltskrivning mellem en ny forekomst af en Finans og drift-app, der ikke har data, og en eksisterende forekomst af en kundeengagementsapp, skal du følge trinnene i [Konfiguration af dobbeltskrivning fra Lifecycle Services](lcs-setup.md). Når opsætningen af forbindelsen er fuldført, sker følgende handlinger automatisk:
...
Udfør følgende trin for at synkronisere Dataverse-data til Finans og drift-appen.

1. Opret et nyt firma i Finans- og driftsappen.
...
## <a name="an-existing-finance-and-operations-app-instance-and-a-new-customer-engagement-app-instance"></a><a id="existing-new"></a>En eksisterende Finans- og driftsapp-forekomst og en ny forekomst af en kundeengagementsapp

Opsætningen af en forbindelse med dobbeltskrivning mellem en eksisterende forekomst af en Finans- og driftsapp og en ny forekomst af en kundeengagementsapp forekommer i Finans- og driftsmiljøet.

1. [Konfigurer forbindelsen fra Finans- og driftsappen](enable-dual-write.md).
2. Kør funktionen **Første synkronisering** for de tabeller, du vil synkronisere data for.

Du kan finde links til et eksempel og en alternativ fremgangsmåde i afsnittet [Eksempel](#example).

## <a name="an-existing-finance-and-operations-app-instance-and-an-existing-customer-engagement-app-instance"></a><a id="existing-existing"></a>En eksisterende Finans- og driftsapp-forekomst og en eksisterende forekomst af en kundeengagementsapp

Opsætningen af en forbindelse med dobbeltskrivning mellem en eksisterende forekomst af en Finans- og driftsapp og en eksisterende forekomst af en kundeengagementsapp forekommer i Finans- og driftsmiljøet.

1. [Konfigurer forbindelsen fra Finans- og driftsappen](enable-dual-write.md).
2. Hvis du vil synkronisere eksisterende Dataverse-data med Finans og drift-appen, skal du udføre en [bootstrap](bootstrap-company-data.md) på Dataverse-dataene ved hjælp af en ISO-firmakode på tre bogstaver.
