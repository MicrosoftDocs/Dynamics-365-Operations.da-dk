...
- [Tilpasning af hardware til lokale miljøer](../../fin-ops/get-started/hardware-sizing-on-premises-environments.md)
- [Købe Finance + Operations (i det lokale miljø)](../../fin-ops/get-started/purchase-on-premises.md)
