...
description: Denne artikel forklarer, hvordan du registrerer leasingaftaler i andre valutaer end regnskabs- eller rapporteringsvalutaen.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
