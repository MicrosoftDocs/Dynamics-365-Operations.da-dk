...
description: Denne artikel forklarer, hvordan du tilbagefører en bogført leasingtransaktion. Alle transaktioner, der oprettes via aktivleasing, kan tilbageføres.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
