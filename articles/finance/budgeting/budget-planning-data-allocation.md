...
description: Denne artikel beskriver de forskellige fordelingsmetoder, der er tilgængelige i Microsoft Dynamics 365 Finance, og hvordan de kan bruges.
author: panolte
ms.date: 03/05/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8901454"
---
# <a name="budget-planning-data-allocation"></a>Fordeling af budgetplanlægningsdata

[!include [banner](../includes/banner.md)]

Denne artikel beskriver de forskellige fordelingsmetoder, der er tilgængelige i Microsoft Dynamics 365 Finance, og hvordan de kan bruges.  
