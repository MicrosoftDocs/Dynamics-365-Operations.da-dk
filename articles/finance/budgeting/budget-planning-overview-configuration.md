...
Når du forstår de begreber og den terminologi, der bruges i Microsoft Dynamics 365 Finance, bliver det nemmere at implementere budgetplanlægning i organisationen.
...
Du opretter en arbejdsgang i Budgettering for budgetplanlægning på siden **Arbejdsgange i Budgettering**. Fremgangsmåden minder om processen til oprettelse af andre arbejdsgange. Følgende illustration viser et eksempel på en arbejdsgang i hovedkvarteret. 
