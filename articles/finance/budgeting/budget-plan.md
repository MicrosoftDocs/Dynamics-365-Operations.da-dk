...
ms.locfileid: "6343880"
---
# <a name="budget-planning"></a>Budgetplanlægning

[!include [banner](../includes/banner.md)]

Formålet med denne øvelse er at give en automatiseret visning af Microsoft Dynamics 365 Finance-funktionalitetsopdateringer i området for budgetplanlægningen. Hensigten med denne øvelse er at illustrere en hurtig konfiguration af et eksempel med budgetplanlægningsmodulet, og hvordan budgetplanlægning kan opnås med denne konfiguration.  Denne øvelse fokuserer specifikt på følgende forretningsprocesser eller opgaver:
...
5.1. I konfigurationen af Budgettering&gt;Opsætning &gt; Budgetplanlægning &gt; Budgetplanlægningskonfiguration skal du åbne siden Layouts. Opret et nyt layout for budgetposten Månedlig:
...
7.1. Naviger til Budgettering &gt; Periodisk &gt; Opret budgetplan fra finansmodulet. Udfyld de periodiske procesparametre, og klik på Generér. 
