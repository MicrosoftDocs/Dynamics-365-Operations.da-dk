...
description: Denne artikel beskriver de forskellige tilgængelige metoder til oprettelse af anlægsaktivtransaktioner.
author: moaamer
ms.date: 08/10/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8883352"
---
# <a name="fixed-asset-transaction-options"></a>Posteringsindstillinger for anlægsaktiv

[!include [banner](../includes/banner.md)]

Denne artikel beskriver de forskellige tilgængelige metoder til oprettelse af anlægsaktivtransaktioner.
