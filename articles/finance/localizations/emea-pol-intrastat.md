...
description: Denne artikel indeholder oplysninger om Intrastat-rapportering i Polen.
author: andosip
ms.date: 11/09/2021
ms.topic: article
...
16. Vælg **OK**, og gennemse den rapport i XML-format, der er oprettet. Følgende tabel viser værdierne i eksempelrapporten.
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Oplysninger om dokumentet</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Oplysninger om firmaet</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Oplysninger om varen</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Kontaktpersonoplysninger</strong></p>
    </td>
    </tr>
    <tr>
    <td>
