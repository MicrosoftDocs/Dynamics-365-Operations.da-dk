...
description: Denne artikel indeholder oplysninger om afrundingsreglerne i parametrene for momsberegning for tjenesten Momsberegning.
author: kailiang
ms.date: 07/29/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8858295"
---
# <a name="tax-calculation-rounding-rules"></a>Regler for afrunding af momsberegning

[!include [banner](../includes/banner.md)]

Denne artikel indeholder oplysninger om, hvordan afrundingsreglerne fungerer i parametrene for momsberegning for tjenesten Momsberegning.
