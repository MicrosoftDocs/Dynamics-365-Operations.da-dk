...
description: Denne artikel beskriver, hvordan du opretter komponenter for A-skat i forbindelse med kildeskat (TDS – Tax Deducted at Source). Det beskriver også, hvordan du definerer den grænseværdi, der bruges til at beregne kildeskatten for hver skattekomponent.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
