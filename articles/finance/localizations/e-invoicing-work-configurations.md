...
description: Dette emne indeholder en oversigt over hovedscenariet for arbejde med ER-konfigurationer (elektronisk rapportering) fra arbejdsområdet til globaliseringsfunktioner.
author: dkalyuzh
ms.date: 01/26/2022
ms.topic: article
ms.prod: ''
