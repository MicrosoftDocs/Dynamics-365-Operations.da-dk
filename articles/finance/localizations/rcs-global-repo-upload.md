...
description: Denne artikel forklarer, hvordan du opretter en ER-konfiguration (elektronisk rapportering) i Microsoft Regulatory Configuration Services (RCS) og uploader den til det globale lager.
author: kfend
ms.date: 01/11/2021
ms.topic: article
ms.prod: ''
