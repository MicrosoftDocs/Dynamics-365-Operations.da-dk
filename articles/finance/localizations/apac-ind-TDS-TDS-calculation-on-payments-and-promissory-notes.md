...
description: Denne artikel indeholder referenceoplysninger om de forskellige betalingstransaktioner, som kildeskat (TDS – Tax Deducted at Source) beregnes på.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8906312"
---
# <a name="tds-calculation-on-payments-and-promissory-notes"></a>Beregning af kildeskat for betalinger og egenveksler

[!include [banner](../includes/banner.md)]

Denne artikel indeholder referenceoplysninger om de forskellige betalingstransaktioner, som kildeskat (TDS – Tax Deducted at Source) beregnes på.
