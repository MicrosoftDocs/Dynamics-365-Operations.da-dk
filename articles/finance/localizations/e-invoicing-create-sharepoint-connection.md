...
description: Denne artikel forklarer, hvordan du konfigurerer en forbindelse, så elektronisk fakturering kan få adgang til et Microsoft SharePoint-websted.
author: dkalyuzh
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
