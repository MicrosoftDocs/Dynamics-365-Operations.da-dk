...
description: Denne artikel beskriver, hvordan du beregner kildeskat på fakturaer ved hjælp af siden Fritekstfaktura.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Denne artikel beskriver, hvordan du beregner kildeskat på fakturaer ved hjælp af siden **Fritekstfaktura**.
