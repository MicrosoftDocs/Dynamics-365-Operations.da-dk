...
description: Denne artikel forklarer, hvordan du udligner periodisk kildeskat (TDS – Tax Deducted at Source).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8864236"
---
# <a name="run-the-periodic-tds-settlement-process"></a>Køre den periodiske skatteudligningsproces

[!include [banner](../includes/banner.md)]

Denne artikel forklarer, hvordan du udligner periodisk kildeskat (TDS – Tax Deducted at Source).
