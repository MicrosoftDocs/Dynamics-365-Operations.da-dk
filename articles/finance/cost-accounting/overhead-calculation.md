...
-   <span data-ttu-id="2e7e6-109">Leje</span><span class="sxs-lookup"><span data-stu-id="2e7e6-109">Rent</span></span>
...
<span data-ttu-id="2e7e6-131">[![Beregning af fast omkostning](./media/period-cost-calculation.png)](./media/period-cost-calculation.png)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-131">[![Overhead calculation](./media/period-cost-calculation.png)](./media/period-cost-calculation.png)</span></span>
...
### <a name="step-1-process-the-cost-behavior-calculation"></a><span data-ttu-id="2e7e6-148">Trin 1: Behandle beregningen af omkostningsfunktionaliteten</span><span class="sxs-lookup"><span data-stu-id="2e7e6-148">Step 1: Process the cost behavior calculation</span></span>
...
<td><span data-ttu-id="2e7e6-167">2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-167">2017</span></span></td>
...
##### <a name="cost-entries"></a><span data-ttu-id="2e7e6-183">Omkostningsposter</span><span class="sxs-lookup"><span data-stu-id="2e7e6-183">Cost entries</span></span>
...
<td><span data-ttu-id="2e7e6-208">1.000,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-208">1,000.00</span></span></td>
...
<span data-ttu-id="2e7e6-239">Tabellen nedenfor viser resultatet, når elforbrug anvendes som en fordelingsgrundlag for variable omkostninger.</span><span class="sxs-lookup"><span data-stu-id="2e7e6-239">The following table shows the result when electricity consumption is applied as an allocation base for variable costs.</span></span>
...
<td><span data-ttu-id="2e7e6-282">(0 ÷ 2) × 1.000,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-282">(0 ÷ 2) × 1,000.00</span></span></td>
...
<td><span data-ttu-id="2e7e6-324">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-324">Electricity</span></span></td>
...
<td><span data-ttu-id="2e7e6-352">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-352">Electricity</span></span></td>
...
<td><span data-ttu-id="2e7e6-388">1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-388">1</span></span></td>
...
##### <a name="journal"></a><span data-ttu-id="2e7e6-408">Kladden</span><span class="sxs-lookup"><span data-stu-id="2e7e6-408">Journal</span></span>
...
<td><span data-ttu-id="2e7e6-450">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-450">January 31, 2017</span></span></td>
</tr>
<tr>
...
<tbody>
<tr>
<td><span data-ttu-id="2e7e6-528">CC002</span><span class="sxs-lookup"><span data-stu-id="2e7e6-528">CC002</span></span></td>
<td><span data-ttu-id="2e7e6-529">Finans</span><span class="sxs-lookup"><span data-stu-id="2e7e6-529">Finance</span></span></td>
<td><span data-ttu-id="2e7e6-530">35</span><span class="sxs-lookup"><span data-stu-id="2e7e6-530">35</span></span></td>
<td><span data-ttu-id="2e7e6-531">(35 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-531">(35 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="2e7e6-532">175.00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-532">175.00</span></span></td>
<td><span data-ttu-id="2e7e6-533">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-533">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-534">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-534">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-535">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-535">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-536">55</span><span class="sxs-lookup"><span data-stu-id="2e7e6-536">55</span></span></td>
<td><span data-ttu-id="2e7e6-537">(55 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-537">(55 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="2e7e6-538">275.00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-538">275.00</span></span></td>
<td><span data-ttu-id="2e7e6-539">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-539">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-540">CC004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-540">CC004</span></span></td>
<td><span data-ttu-id="2e7e6-541">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-541">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-542">10</span><span class="sxs-lookup"><span data-stu-id="2e7e6-542">10</span></span></td>
<td><span data-ttu-id="2e7e6-543">(10 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-543">(10 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="2e7e6-544">50,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-544">50.00</span></span></td>
<td><span data-ttu-id="2e7e6-545">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-545">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-546">CC002</span><span class="sxs-lookup"><span data-stu-id="2e7e6-546">CC002</span></span></td>
<td><span data-ttu-id="2e7e6-547">Finans</span><span class="sxs-lookup"><span data-stu-id="2e7e6-547">Finance</span></span></td>
<td><span data-ttu-id="2e7e6-548">35</span><span class="sxs-lookup"><span data-stu-id="2e7e6-548">35</span></span></td>
<td><span data-ttu-id="2e7e6-549">(35 ÷ 100) × 1.245,71</span><span class="sxs-lookup"><span data-stu-id="2e7e6-549">(35 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="2e7e6-550">436.00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-550">436.00</span></span></td>
<td><span data-ttu-id="2e7e6-551">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-551">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-552">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-552">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-553">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-553">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-554">55</span><span class="sxs-lookup"><span data-stu-id="2e7e6-554">55</span></span></td>
<td><span data-ttu-id="2e7e6-555">(55 ÷ 100) × 1.245,71</span><span class="sxs-lookup"><span data-stu-id="2e7e6-555">(55 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="2e7e6-556">685.14</span><span class="sxs-lookup"><span data-stu-id="2e7e6-556">685.14</span></span></td>
<td><span data-ttu-id="2e7e6-557">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-557">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-558">CC004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-558">CC004</span></span></td>
<td><span data-ttu-id="2e7e6-559">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-559">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-560">10</span><span class="sxs-lookup"><span data-stu-id="2e7e6-560">10</span></span></td>
<td><span data-ttu-id="2e7e6-561">(10 ÷ 100) × 1.245,71</span><span class="sxs-lookup"><span data-stu-id="2e7e6-561">(10 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="2e7e6-562">124.57</span><span class="sxs-lookup"><span data-stu-id="2e7e6-562">124.57</span></span></td>
<td><span data-ttu-id="2e7e6-563">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-563">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="2e7e6-564">Tabellen nedenfor viser resultatet, når Finans-tjenester anvendes som fordelingsgrundlag for samlede omkostninger (faste omkostninger og variable omkostninger).</span><span class="sxs-lookup"><span data-stu-id="2e7e6-564">The following table shows the result when the Finance services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="2e7e6-565">Omkostningsobjekt</span><span class="sxs-lookup"><span data-stu-id="2e7e6-565">Cost object</span></span></th>
<th><span data-ttu-id="2e7e6-566">Størrelsesorden</span><span class="sxs-lookup"><span data-stu-id="2e7e6-566">Magnitude</span></span></th>
<th><span data-ttu-id="2e7e6-567">Fordelingsfaktor</span><span class="sxs-lookup"><span data-stu-id="2e7e6-567">Allocation factor</span></span></th>
<th><span data-ttu-id="2e7e6-568">Beløb</span><span class="sxs-lookup"><span data-stu-id="2e7e6-568">Amount</span></span></th>
<th><span data-ttu-id="2e7e6-569">Funktionalitet af omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-569">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="2e7e6-570">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-570">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-571">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-571">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-572">65</span><span class="sxs-lookup"><span data-stu-id="2e7e6-572">65</span></span></td>
<td><span data-ttu-id="2e7e6-573">(65 ÷ 100) × (500,00 + 175,00)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-573">(65 ÷ 100) × (500.00 + 175.00)</span></span></td>
<td><span data-ttu-id="2e7e6-574">438.75</span><span class="sxs-lookup"><span data-stu-id="2e7e6-574">438.75</span></span></td>
<td><span data-ttu-id="2e7e6-575">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-575">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-576">CC004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-576">CC004</span></span></td>
<td><span data-ttu-id="2e7e6-577">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-577">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-578">35</span><span class="sxs-lookup"><span data-stu-id="2e7e6-578">35</span></span></td>
<td><span data-ttu-id="2e7e6-579">(35 ÷ 100) × (500,00 + 175,00)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-579">(35 ÷ 100) × (500.00 + 175.00)</span></span></td>
<td><span data-ttu-id="2e7e6-580">236.25</span><span class="sxs-lookup"><span data-stu-id="2e7e6-580">236.25</span></span></td>
<td><span data-ttu-id="2e7e6-581">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-581">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-582">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-582">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-583">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-583">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-584">65</span><span class="sxs-lookup"><span data-stu-id="2e7e6-584">65</span></span></td>
<td><span data-ttu-id="2e7e6-585">(65 ÷ 100) × (7.714,29 + 436,00)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-585">(65 ÷ 100) × (7,714.29 + 436.00)</span></span></td>
<td><span data-ttu-id="2e7e6-586">5,297.69</span><span class="sxs-lookup"><span data-stu-id="2e7e6-586">5,297.69</span></span></td>
<td><span data-ttu-id="2e7e6-587">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-587">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-588">CC004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-588">CC004</span></span></td>
<td><span data-ttu-id="2e7e6-589">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-589">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-590">35</span><span class="sxs-lookup"><span data-stu-id="2e7e6-590">35</span></span></td>
<td><span data-ttu-id="2e7e6-591">(35 ÷ 100) × (7.714,29 + 436,00)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-591">(35 ÷ 100) × (7,714.29 + 436.00)</span></span></td>
<td><span data-ttu-id="2e7e6-592">2,852.60</span><span class="sxs-lookup"><span data-stu-id="2e7e6-592">2,852.60</span></span></td>
<td><span data-ttu-id="2e7e6-593">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-593">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="2e7e6-594">Tabellen nedenfor viser resultatet, når Assembly-tjenester anvendes som fordelingsgrundlag for samlede omkostninger (faste omkostninger og variable omkostninger).</span><span class="sxs-lookup"><span data-stu-id="2e7e6-594">The following table shows the result when the Assembly services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="2e7e6-595">Omkostningsobjekt</span><span class="sxs-lookup"><span data-stu-id="2e7e6-595">Cost object</span></span></th>
<th><span data-ttu-id="2e7e6-596">Størrelsesorden</span><span class="sxs-lookup"><span data-stu-id="2e7e6-596">Magnitude</span></span></th>
<th><span data-ttu-id="2e7e6-597">Fordelingsfaktor</span><span class="sxs-lookup"><span data-stu-id="2e7e6-597">Allocation factor</span></span></th>
<th><span data-ttu-id="2e7e6-598">Beløb</span><span class="sxs-lookup"><span data-stu-id="2e7e6-598">Amount</span></span></th>
<th><span data-ttu-id="2e7e6-599">Funktionalitet af omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-599">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="2e7e6-600">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-600">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-601">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-601">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-602">60</span><span class="sxs-lookup"><span data-stu-id="2e7e6-602">60</span></span></td>
<td><span data-ttu-id="2e7e6-603">(60 ÷ 80) × (275,00 + 438,75)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-603">(60 ÷ 80) × (275.00 + 438.75)</span></span></td>
<td><span data-ttu-id="2e7e6-604">535.31</span><span class="sxs-lookup"><span data-stu-id="2e7e6-604">535.31</span></span></td>
<td><span data-ttu-id="2e7e6-605">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-605">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-606">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-606">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-607">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-607">Product 2</span></span></td>
<td><span data-ttu-id="2e7e6-608">20</span><span class="sxs-lookup"><span data-stu-id="2e7e6-608">20</span></span></td>
<td><span data-ttu-id="2e7e6-609">(20 ÷ 80) × (275,00 + 438,75)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-609">(20 ÷ 80) × (275.00 + 438.75)</span></span></td>
<td><span data-ttu-id="2e7e6-610">178.44</span><span class="sxs-lookup"><span data-stu-id="2e7e6-610">178.44</span></span></td>
<td><span data-ttu-id="2e7e6-611">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-611">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-612">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-612">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-613">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-613">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-614">60</span><span class="sxs-lookup"><span data-stu-id="2e7e6-614">60</span></span></td>
<td><span data-ttu-id="2e7e6-615">(60 ÷ 80) × (5.297,69 + 685,14)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-615">(60 ÷ 80) × (5,297.69 + 685.14)</span></span></td>
<td><span data-ttu-id="2e7e6-616">4,487.12</span><span class="sxs-lookup"><span data-stu-id="2e7e6-616">4,487.12</span></span></td>
<td><span data-ttu-id="2e7e6-617">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-617">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-618">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-618">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-619">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-619">Product 2</span></span></td>
<td><span data-ttu-id="2e7e6-620">20</span><span class="sxs-lookup"><span data-stu-id="2e7e6-620">20</span></span></td>
<td><span data-ttu-id="2e7e6-621">(20 ÷ 80) × (5.297,69 + 685,14)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-621">(20 ÷ 80) × (5,297.69 + 685.14)</span></span></td>
<td><span data-ttu-id="2e7e6-622">1,495.71</span><span class="sxs-lookup"><span data-stu-id="2e7e6-622">1,495.71</span></span></td>
<td><span data-ttu-id="2e7e6-623">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-623">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="2e7e6-624">Tabellen nedenfor viser resultatet, når Emballage-tjenester anvendes som fordelingsgrundlag for samlede omkostninger (faste omkostninger og variable omkostninger).</span><span class="sxs-lookup"><span data-stu-id="2e7e6-624">The following table shows the result when the Packaging services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="2e7e6-625">Omkostningsobjekt</span><span class="sxs-lookup"><span data-stu-id="2e7e6-625">Cost object</span></span></th>
<th><span data-ttu-id="2e7e6-626">Størrelsesorden</span><span class="sxs-lookup"><span data-stu-id="2e7e6-626">Magnitude</span></span></th>
<th><span data-ttu-id="2e7e6-627">Fordelingsfaktor</span><span class="sxs-lookup"><span data-stu-id="2e7e6-627">Allocation factor</span></span></th>
<th><span data-ttu-id="2e7e6-628">Beløb</span><span class="sxs-lookup"><span data-stu-id="2e7e6-628">Amount</span></span></th>
<th><span data-ttu-id="2e7e6-629">Funktionalitet af omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-629">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="2e7e6-630">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-630">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-631">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-631">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-632">80</span><span class="sxs-lookup"><span data-stu-id="2e7e6-632">80</span></span></td>
<td><span data-ttu-id="2e7e6-633">(80 ÷ 95) × (50,00 + 236,25)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-633">(80 ÷ 95) × (50.00 + 236.25)</span></span></td>
<td><span data-ttu-id="2e7e6-634">241.05</span><span class="sxs-lookup"><span data-stu-id="2e7e6-634">241.05</span></span></td>
<td><span data-ttu-id="2e7e6-635">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-635">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-636">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-636">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-637">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-637">Product 2</span></span></td>
<td><span data-ttu-id="2e7e6-638">15</span><span class="sxs-lookup"><span data-stu-id="2e7e6-638">15</span></span></td>
<td><span data-ttu-id="2e7e6-639">(15 ÷ 95) × (50,00 + 236,25)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-639">(15 ÷ 95) × (50.00 + 236.25)</span></span></td>
<td><span data-ttu-id="2e7e6-640">45.20</span><span class="sxs-lookup"><span data-stu-id="2e7e6-640">45.20</span></span></td>
<td><span data-ttu-id="2e7e6-641">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-641">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-642">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-642">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-643">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-643">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-644">80</span><span class="sxs-lookup"><span data-stu-id="2e7e6-644">80</span></span></td>
<td><span data-ttu-id="2e7e6-645">(80 ÷ 95) × (2.852,60 + 124,57)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-645">(80 ÷ 95) × (2,852.60 + 124.57)</span></span></td>
<td><span data-ttu-id="2e7e6-646">2,507.09</span><span class="sxs-lookup"><span data-stu-id="2e7e6-646">2,507.09</span></span></td>
<td><span data-ttu-id="2e7e6-647">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-647">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-648">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-648">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-649">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-649">Product 2</span></span></td>
<td><span data-ttu-id="2e7e6-650">15</span><span class="sxs-lookup"><span data-stu-id="2e7e6-650">15</span></span></td>
<td><span data-ttu-id="2e7e6-651">(15 ÷ 95) × (2.852,60 + 124,57)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-651">(15 ÷ 95) × (2,852.60 + 124.57)</span></span></td>
<td><span data-ttu-id="2e7e6-652">470.08</span><span class="sxs-lookup"><span data-stu-id="2e7e6-652">470.08</span></span></td>
<td><span data-ttu-id="2e7e6-653">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-653">Variable cost</span></span></td>
</tr>
</tbody>
</table>

##### <a name="journal-entries-cost-object-balance-journal-entries"></a><span data-ttu-id="2e7e6-654">Kladdeposteringer (kladdeposteringer for omkostningsobjektsaldo)</span><span class="sxs-lookup"><span data-stu-id="2e7e6-654">Journal entries (cost object balance journal entries)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="2e7e6-655">Kladden</span><span class="sxs-lookup"><span data-stu-id="2e7e6-655">Journal</span></span></th>
<th><span data-ttu-id="2e7e6-656">Kladdetype</span><span class="sxs-lookup"><span data-stu-id="2e7e6-656">Journal type</span></span></th>
<th colspan="3"><span data-ttu-id="2e7e6-657">Regnskabskalenderperiode</span><span class="sxs-lookup"><span data-stu-id="2e7e6-657">Fiscal calendar period</span></span></th>
<th><span data-ttu-id="2e7e6-658">Version</span><span class="sxs-lookup"><span data-stu-id="2e7e6-658">Version</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="2e7e6-659">00004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-659">00004</span></span></td>
<td><span data-ttu-id="2e7e6-660">Kladde for omkostningsfordeling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-660">Cost allocation journal</span></span></td>
<td><span data-ttu-id="2e7e6-661">Regnskabsår</span><span class="sxs-lookup"><span data-stu-id="2e7e6-661">Fiscal</span></span></td>
<td><span data-ttu-id="2e7e6-662">2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-662">2017</span></span></td>
<td><span data-ttu-id="2e7e6-663">1. Periode</span><span class="sxs-lookup"><span data-stu-id="2e7e6-663">Period 1</span></span></td>
<td><span data-ttu-id="2e7e6-664">Beregning af fast omkostning / 02-01-2017 23:51:00 / Finans /2017 / periode 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-664">Overhead calculation / 01-02-2017 11:51:00 PM / Ledger /2017 / Period 1</span></span></td>
</tr>
</tbody>
</table>

##### <a name="journal-lines"></a><span data-ttu-id="2e7e6-665">kladdelinjer</span><span class="sxs-lookup"><span data-stu-id="2e7e6-665">Journal lines</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="2e7e6-666">Regnskabsdato</span><span class="sxs-lookup"><span data-stu-id="2e7e6-666">Accounting date</span></span></th>
<th colspan="2"><span data-ttu-id="2e7e6-667">Omkostningsobjekt</span><span class="sxs-lookup"><span data-stu-id="2e7e6-667">Cost object</span></span></th>
<th colspan="2"><span data-ttu-id="2e7e6-668">Omkostningselement</span><span class="sxs-lookup"><span data-stu-id="2e7e6-668">Cost element</span></span></th>
<th><span data-ttu-id="2e7e6-669">Funktionalitet af omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-669">Cost behavior</span></span></th>
<th><span data-ttu-id="2e7e6-670">Beløb</span><span class="sxs-lookup"><span data-stu-id="2e7e6-670">Amount</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="2e7e6-671">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-671">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-672">CC001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-672">CC001</span></span></td>
<td><span data-ttu-id="2e7e6-673">Personale</span><span class="sxs-lookup"><span data-stu-id="2e7e6-673">HR</span></span></td>
<td><span data-ttu-id="2e7e6-674">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-674">10001</span></span></td>
<td><span data-ttu-id="2e7e6-675">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-675">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-676">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-676">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-677">500,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-677">500.00</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-678">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-678">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-679">CC001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-679">CC001</span></span></td>
<td><span data-ttu-id="2e7e6-680">Personale</span><span class="sxs-lookup"><span data-stu-id="2e7e6-680">HR</span></span></td>
<td><span data-ttu-id="2e7e6-681">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-681">10001</span></span></td>
<td><span data-ttu-id="2e7e6-682">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-682">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-683">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-683">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-684">1,245.71</span><span class="sxs-lookup"><span data-stu-id="2e7e6-684">1,245.71</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-685">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-685">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-686">CC002</span><span class="sxs-lookup"><span data-stu-id="2e7e6-686">CC002</span></span></td>
<td><span data-ttu-id="2e7e6-687">Finans</span><span class="sxs-lookup"><span data-stu-id="2e7e6-687">Finance</span></span></td>
<td><span data-ttu-id="2e7e6-688">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-688">10001</span></span></td>
<td><span data-ttu-id="2e7e6-689">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-689">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-690">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-690">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-691">675.00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-691">675.00</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-692">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-692">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-693">CC002</span><span class="sxs-lookup"><span data-stu-id="2e7e6-693">CC002</span></span></td>
<td><span data-ttu-id="2e7e6-694">Finans</span><span class="sxs-lookup"><span data-stu-id="2e7e6-694">Finance</span></span></td>
<td><span data-ttu-id="2e7e6-695">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-695">10001</span></span></td>
<td><span data-ttu-id="2e7e6-696">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-696">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-697">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-697">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-698">8,150.29</span><span class="sxs-lookup"><span data-stu-id="2e7e6-698">8,150.29</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-699">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-699">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-700">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-700">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-701">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-701">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-702">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-702">10001</span></span></td>
<td><span data-ttu-id="2e7e6-703">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-703">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-704">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-704">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-705">713.75</span><span class="sxs-lookup"><span data-stu-id="2e7e6-705">713.75</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-706">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-706">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-707">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-707">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-708">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-708">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-709">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-709">10001</span></span></td>
<td><span data-ttu-id="2e7e6-710">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-710">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-711">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-711">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-712">5,982.83</span><span class="sxs-lookup"><span data-stu-id="2e7e6-712">5,982.83</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-713">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-713">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-714">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-714">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-715">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-715">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-716">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-716">10001</span></span></td>
<td><span data-ttu-id="2e7e6-717">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-717">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-718">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-718">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-719">286.25</span><span class="sxs-lookup"><span data-stu-id="2e7e6-719">286.25</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-720">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-720">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-721">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-721">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-722">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-722">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-723">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-723">10001</span></span></td>
<td><span data-ttu-id="2e7e6-724">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-724">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-725">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-725">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-726">2,977.17</span><span class="sxs-lookup"><span data-stu-id="2e7e6-726">2,977.17</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-727">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-727">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-728">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-728">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-729">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-729">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-730">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-730">10001</span></span></td>
<td><span data-ttu-id="2e7e6-731">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-731">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-732">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-732">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-733">776.36</span><span class="sxs-lookup"><span data-stu-id="2e7e6-733">776.36</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-734">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-734">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-735">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-735">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-736">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-736">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-737">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-737">10001</span></span></td>
<td><span data-ttu-id="2e7e6-738">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-738">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-739">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-739">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-740">6,994.21</span><span class="sxs-lookup"><span data-stu-id="2e7e6-740">6,994.21</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-741">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-741">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-742">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-742">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-743">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-743">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-744">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-744">10001</span></span></td>
<td><span data-ttu-id="2e7e6-745">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-745">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-746">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-746">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-747">223.64</span><span class="sxs-lookup"><span data-stu-id="2e7e6-747">223.64</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-748">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-748">January 31, 2017</span></span></td>
<td><span data-ttu-id="2e7e6-749">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-749">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-750">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-750">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-751">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-751">10001</span></span></td>
<td><span data-ttu-id="2e7e6-752">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-752">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-753">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-753">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-754">1,965.79</span><span class="sxs-lookup"><span data-stu-id="2e7e6-754">1,965.79</span></span></td>
</tr>
</tbody>
</table>

##### <a name="cost-entries"></a><span data-ttu-id="2e7e6-755">Omkostningsposter</span><span class="sxs-lookup"><span data-stu-id="2e7e6-755">Cost entries</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="2e7e6-756">Omkostningsobjekt</span><span class="sxs-lookup"><span data-stu-id="2e7e6-756">Cost object</span></span></th>
<th colspan="2"><span data-ttu-id="2e7e6-757">Omkostningselement</span><span class="sxs-lookup"><span data-stu-id="2e7e6-757">Cost element</span></span></th>
<th><span data-ttu-id="2e7e6-758">Funktionalitet af omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-758">Cost behavior</span></span></th>
<th><span data-ttu-id="2e7e6-759">Beløb</span><span class="sxs-lookup"><span data-stu-id="2e7e6-759">Amount</span></span></th>
<th><span data-ttu-id="2e7e6-760">Regnskabsdato</span><span class="sxs-lookup"><span data-stu-id="2e7e6-760">Accounting date</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="2e7e6-761">CC001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-761">CC001</span></span></td>
<td><span data-ttu-id="2e7e6-762">Personale</span><span class="sxs-lookup"><span data-stu-id="2e7e6-762">HR</span></span></td>
<td><span data-ttu-id="2e7e6-763">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-763">10001</span></span></td>
<td><span data-ttu-id="2e7e6-764">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-764">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-765">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-765">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-766">-500,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-766">-500.00</span></span></td>
<td><span data-ttu-id="2e7e6-767">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-767">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-768">CC002</span><span class="sxs-lookup"><span data-stu-id="2e7e6-768">CC002</span></span></td>
<td><span data-ttu-id="2e7e6-769">Finans</span><span class="sxs-lookup"><span data-stu-id="2e7e6-769">Finance</span></span></td>
<td><span data-ttu-id="2e7e6-770">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-770">10001</span></span></td>
<td><span data-ttu-id="2e7e6-771">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-771">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-772">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-772">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-773">175.00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-773">175.00</span></span></td>
<td><span data-ttu-id="2e7e6-774">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-774">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-775">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-775">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-776">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-776">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-777">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-777">10001</span></span></td>
<td><span data-ttu-id="2e7e6-778">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-778">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-779">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-779">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-780">275.00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-780">275.00</span></span></td>
<td><span data-ttu-id="2e7e6-781">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-781">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-782">CC004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-782">CC004</span></span></td>
<td><span data-ttu-id="2e7e6-783">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-783">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-784">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-784">10001</span></span></td>
<td><span data-ttu-id="2e7e6-785">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-785">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-786">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-786">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-787">50,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-787">50,00</span></span></td>
<td><span data-ttu-id="2e7e6-788">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-788">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-789">CC001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-789">CC001</span></span></td>
<td><span data-ttu-id="2e7e6-790">Personale</span><span class="sxs-lookup"><span data-stu-id="2e7e6-790">HR</span></span></td>
<td><span data-ttu-id="2e7e6-791">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-791">10001</span></span></td>
<td><span data-ttu-id="2e7e6-792">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-792">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-793">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-793">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-794">-1.245,71</span><span class="sxs-lookup"><span data-stu-id="2e7e6-794">-1,245.71</span></span></td>
<td><span data-ttu-id="2e7e6-795">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-795">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-796">CC002</span><span class="sxs-lookup"><span data-stu-id="2e7e6-796">CC002</span></span></td>
<td><span data-ttu-id="2e7e6-797">Finans</span><span class="sxs-lookup"><span data-stu-id="2e7e6-797">Finance</span></span></td>
<td><span data-ttu-id="2e7e6-798">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-798">10001</span></span></td>
<td><span data-ttu-id="2e7e6-799">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-799">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-800">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-800">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-801">436.00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-801">436.00</span></span></td>
<td><span data-ttu-id="2e7e6-802">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-802">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-803">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-803">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-804">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-804">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-805">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-805">10001</span></span></td>
<td><span data-ttu-id="2e7e6-806">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-806">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-807">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-807">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-808">685.14</span><span class="sxs-lookup"><span data-stu-id="2e7e6-808">685.14</span></span></td>
<td><span data-ttu-id="2e7e6-809">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-809">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-810">CC004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-810">CC004</span></span></td>
<td><span data-ttu-id="2e7e6-811">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-811">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-812">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-812">10001</span></span></td>
<td><span data-ttu-id="2e7e6-813">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-813">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-814">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-814">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-815">124.57</span><span class="sxs-lookup"><span data-stu-id="2e7e6-815">124.57</span></span></td>
<td><span data-ttu-id="2e7e6-816">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-816">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-817">CC002</span><span class="sxs-lookup"><span data-stu-id="2e7e6-817">CC002</span></span></td>
<td><span data-ttu-id="2e7e6-818">Finans</span><span class="sxs-lookup"><span data-stu-id="2e7e6-818">Finance</span></span></td>
<td><span data-ttu-id="2e7e6-819">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-819">10001</span></span></td>
<td><span data-ttu-id="2e7e6-820">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-820">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-821">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-821">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-822">-675,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-822">-675.00</span></span></td>
<td><span data-ttu-id="2e7e6-823">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-823">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-824">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-824">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-825">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-825">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-826">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-826">10001</span></span></td>
<td><span data-ttu-id="2e7e6-827">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-827">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-828">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-828">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-829">438.75</span><span class="sxs-lookup"><span data-stu-id="2e7e6-829">438.75</span></span></td>
<td><span data-ttu-id="2e7e6-830">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-830">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-831">CC004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-831">CC004</span></span></td>
<td><span data-ttu-id="2e7e6-832">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-832">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-833">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-833">10001</span></span></td>
<td><span data-ttu-id="2e7e6-834">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-834">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-835">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-835">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-836">236.25</span><span class="sxs-lookup"><span data-stu-id="2e7e6-836">236.25</span></span></td>
<td><span data-ttu-id="2e7e6-837">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-837">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-838">CC002</span><span class="sxs-lookup"><span data-stu-id="2e7e6-838">CC002</span></span></td>
<td><span data-ttu-id="2e7e6-839">Finans</span><span class="sxs-lookup"><span data-stu-id="2e7e6-839">Finance</span></span></td>
<td><span data-ttu-id="2e7e6-840">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-840">10001</span></span></td>
<td><span data-ttu-id="2e7e6-841">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-841">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-842">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-842">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-843">-8.150,29</span><span class="sxs-lookup"><span data-stu-id="2e7e6-843">-8,150.29</span></span></td>
<td><span data-ttu-id="2e7e6-844">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-844">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-845">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-845">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-846">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-846">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-847">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-847">10001</span></span></td>
<td><span data-ttu-id="2e7e6-848">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-848">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-849">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-849">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-850">5,297.69</span><span class="sxs-lookup"><span data-stu-id="2e7e6-850">5,297.69</span></span></td>
<td><span data-ttu-id="2e7e6-851">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-851">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-852">CC004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-852">CC004</span></span></td>
<td><span data-ttu-id="2e7e6-853">Emballage</span><span class="sxs-lookup"><span data-stu-id="2e7e6-853">Packaging</span></span></td>
<td><span data-ttu-id="2e7e6-854">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-854">10001</span></span></td>
<td><span data-ttu-id="2e7e6-855">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-855">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-856">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-856">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-857">2,852.60</span><span class="sxs-lookup"><span data-stu-id="2e7e6-857">2,852.60</span></span></td>
<td><span data-ttu-id="2e7e6-858">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-858">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-859">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-859">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-860">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-860">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-861">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-861">10001</span></span></td>
<td><span data-ttu-id="2e7e6-862">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-862">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-863">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-863">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-864">-713,75</span><span class="sxs-lookup"><span data-stu-id="2e7e6-864">-713.75</span></span></td>
<td><span data-ttu-id="2e7e6-865">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-865">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-866">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-866">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-867">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-867">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-868">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-868">10001</span></span></td>
<td><span data-ttu-id="2e7e6-869">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-869">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-870">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-870">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-871">535.31</span><span class="sxs-lookup"><span data-stu-id="2e7e6-871">535.31</span></span></td>
<td><span data-ttu-id="2e7e6-872">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-872">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-873">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-873">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-874">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-874">Product 2</span></span></td>
<td><span data-ttu-id="2e7e6-875">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-875">10001</span></span></td>
<td><span data-ttu-id="2e7e6-876">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-876">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-877">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-877">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-878">178.44</span><span class="sxs-lookup"><span data-stu-id="2e7e6-878">178.44</span></span></td>
<td><span data-ttu-id="2e7e6-879">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-879">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-880">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-880">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-881">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-881">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-882">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-882">10001</span></span></td>
<td><span data-ttu-id="2e7e6-883">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-883">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-884">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-884">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-885">-5.982,83</span><span class="sxs-lookup"><span data-stu-id="2e7e6-885">-5,982.83</span></span></td>
<td><span data-ttu-id="2e7e6-886">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-886">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-887">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-887">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-888">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-888">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-889">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-889">10001</span></span></td>
<td><span data-ttu-id="2e7e6-890">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-890">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-891">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-891">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-892">4,487.12</span><span class="sxs-lookup"><span data-stu-id="2e7e6-892">4,487.12</span></span></td>
<td><span data-ttu-id="2e7e6-893">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-893">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-894">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-894">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-895">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-895">Product 2</span></span></td>
<td><span data-ttu-id="2e7e6-896">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-896">10001</span></span></td>
<td><span data-ttu-id="2e7e6-897">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-897">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-898">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-898">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-899">1,495.71</span><span class="sxs-lookup"><span data-stu-id="2e7e6-899">1,495.71</span></span></td>
<td><span data-ttu-id="2e7e6-900">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-900">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-901">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-901">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-902">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-902">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-903">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-903">10001</span></span></td>
<td><span data-ttu-id="2e7e6-904">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-904">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-905">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-905">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-906">-286,25</span><span class="sxs-lookup"><span data-stu-id="2e7e6-906">-286.25</span></span></td>
<td><span data-ttu-id="2e7e6-907">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-907">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-908">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-908">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-909">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-909">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-910">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-910">10001</span></span></td>
<td><span data-ttu-id="2e7e6-911">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-911">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-912">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-912">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-913">241.05</span><span class="sxs-lookup"><span data-stu-id="2e7e6-913">241.05</span></span></td>
<td><span data-ttu-id="2e7e6-914">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-914">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-915">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-915">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-916">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-916">Product 2</span></span></td>
<td><span data-ttu-id="2e7e6-917">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-917">10001</span></span></td>
<td><span data-ttu-id="2e7e6-918">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-918">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-919">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-919">Fixed cost</span></span></td>
<td><span data-ttu-id="2e7e6-920">45.20</span><span class="sxs-lookup"><span data-stu-id="2e7e6-920">45.20</span></span></td>
<td><span data-ttu-id="2e7e6-921">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-921">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-922">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-922">CC003</span></span></td>
<td><span data-ttu-id="2e7e6-923">Samling</span><span class="sxs-lookup"><span data-stu-id="2e7e6-923">Assembly</span></span></td>
<td><span data-ttu-id="2e7e6-924">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-924">10001</span></span></td>
<td><span data-ttu-id="2e7e6-925">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-925">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-926">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-926">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-927">-2.977,17</span><span class="sxs-lookup"><span data-stu-id="2e7e6-927">-2,977.17</span></span></td>
<td><span data-ttu-id="2e7e6-928">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-928">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-929">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-929">Prod 1</span></span></td>
<td><span data-ttu-id="2e7e6-930">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-930">Product 1</span></span></td>
<td><span data-ttu-id="2e7e6-931">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-931">10001</span></span></td>
<td><span data-ttu-id="2e7e6-932">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-932">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-933">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-933">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-934">2,507.09</span><span class="sxs-lookup"><span data-stu-id="2e7e6-934">2,507.09</span></span></td>
<td><span data-ttu-id="2e7e6-935">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-935">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="2e7e6-936">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-936">Prod 2</span></span></td>
<td><span data-ttu-id="2e7e6-937">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-937">Product 2</span></span></td>
<td><span data-ttu-id="2e7e6-938">10001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-938">10001</span></span></td>
<td><span data-ttu-id="2e7e6-939">Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-939">Electricity</span></span></td>
<td><span data-ttu-id="2e7e6-940">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-940">Variable cost</span></span></td>
<td><span data-ttu-id="2e7e6-941">470.08</span><span class="sxs-lookup"><span data-stu-id="2e7e6-941">470.08</span></span></td>
<td><span data-ttu-id="2e7e6-942">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="2e7e6-942">January 31, 2017</span></span></td>
</tr>
</tbody>
</table>

## <a name="conclusion"></a><span data-ttu-id="2e7e6-943">Konklusion</span><span class="sxs-lookup"><span data-stu-id="2e7e6-943">Conclusion</span></span>
<span data-ttu-id="2e7e6-944">I Finansregnskab bogføres en omkostning på 10.000,00 for elektricitet til et dummy-bærer-id.</span><span class="sxs-lookup"><span data-stu-id="2e7e6-944">In Financial accounting, a cost of 10,000.00 for Electricity is posted to a dummy cost center ID.</span></span> <span data-ttu-id="2e7e6-945">Derfor kan bogholdere se, at disse omkostninger skal fordeles.</span><span class="sxs-lookup"><span data-stu-id="2e7e6-945">Therefore, cost accountants will know that this cost must be allocated.</span></span> <span data-ttu-id="2e7e6-946">I Omkostningsregnskab passerer omkostningerne på tværs af afdelinger og niveauer, baseret på de politikker og regler, der anvendes.</span><span class="sxs-lookup"><span data-stu-id="2e7e6-946">In Cost accounting, the costs flow across organizational units and levels, based on the policies and rules that are applied.</span></span> <span data-ttu-id="2e7e6-947">Hver omkostning er knyttet et fordelingsgrundlag, der giver den bedste vurdering af fordelingen af omkostninger.</span><span class="sxs-lookup"><span data-stu-id="2e7e6-947">Each cost has been associated with an allocation base that provides the best assessment for the allocation of costs.</span></span>

<table>
<thead>
<tr>
<th colspan="2" rowspan="2"><span data-ttu-id="2e7e6-948">Omkostningselement</span><span class="sxs-lookup"><span data-stu-id="2e7e6-948">Cost element</span></span></th>
<th colspan="9"><span data-ttu-id="2e7e6-949">Omkostningsobjekt</span><span class="sxs-lookup"><span data-stu-id="2e7e6-949">Cost object</span></span></th>
<th rowspan="2"><span data-ttu-id="2e7e6-950">Samlet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-950">Total</span></span></th>
</tr>
<tr>
<th><span data-ttu-id="2e7e6-951">CC099</span><span class="sxs-lookup"><span data-stu-id="2e7e6-951">CC099</span></span></th>
<th><span data-ttu-id="2e7e6-952">CC001</span><span class="sxs-lookup"><span data-stu-id="2e7e6-952">CC001</span></span></th>
<th><span data-ttu-id="2e7e6-953">CC002</span><span class="sxs-lookup"><span data-stu-id="2e7e6-953">CC002</span></span></th>
<th><span data-ttu-id="2e7e6-954">CC003</span><span class="sxs-lookup"><span data-stu-id="2e7e6-954">CC003</span></span></th>
<th><span data-ttu-id="2e7e6-955">CC004</span><span class="sxs-lookup"><span data-stu-id="2e7e6-955">CC004</span></span></th>
<th><span data-ttu-id="2e7e6-956">Proj 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-956">Proj 1</span></span></th>
<th><span data-ttu-id="2e7e6-957">Proj 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-957">Proj 2</span></span></th>
<th><span data-ttu-id="2e7e6-958">Prod 1</span><span class="sxs-lookup"><span data-stu-id="2e7e6-958">Prod 1</span></span></th>
<th><span data-ttu-id="2e7e6-959">Prod 2</span><span class="sxs-lookup"><span data-stu-id="2e7e6-959">Prod 2</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td colspan="2"><span data-ttu-id="2e7e6-960">10001 Elektricitet</span><span class="sxs-lookup"><span data-stu-id="2e7e6-960">10001 Electricity</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-961"><strong>0.00</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-961"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-962"><strong>0.00</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-962"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-963"><strong>0.00</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-963"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-964"><strong>0.00</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-964"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-965"><strong>30.00</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-965"><strong>30.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-966"><strong>10.00</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-966"><strong>10.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-967"><strong>7,770.57</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-967"><strong>7,770.57</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-968"><strong>2,189.43</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-968"><strong>2,189.43</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-969"><strong>10,000.00</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-969"><strong>10,000.00</strong></span></span></td>
</tr>
<tr>
<td></td>
<td style="text-align: left;"><span data-ttu-id="2e7e6-970">Ikke-klassificerede</span><span class="sxs-lookup"><span data-stu-id="2e7e6-970">Unclassified</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-971">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-971">0.00</span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
...
<tr>
<td style="text-align: right;"></td>
<td style="text-align: left;"><span data-ttu-id="2e7e6-972">Fast omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-972">Fixed cost</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-973">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-973">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-974">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-974">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-975">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-975">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-976">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-976">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-977">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-977">0.00</span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-978">776.36</span><span class="sxs-lookup"><span data-stu-id="2e7e6-978">776.36</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-979">223.64</span><span class="sxs-lookup"><span data-stu-id="2e7e6-979">223.64</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-980"><strong>1,000.00</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-980"><strong>1,000.00</strong></span></span></td>
</tr>
<tr>
<td style="text-align: right;"></td>
<td style="text-align: left;"><span data-ttu-id="2e7e6-981">Variabel omkostning</span><span class="sxs-lookup"><span data-stu-id="2e7e6-981">Variable cost</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-982">000</span><span class="sxs-lookup"><span data-stu-id="2e7e6-982">000</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-983">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-983">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-984">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-984">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-985">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-985">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-986">0,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-986">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-987">30,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-987">30.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-988">10,00</span><span class="sxs-lookup"><span data-stu-id="2e7e6-988">10.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-989">6,994.21</span><span class="sxs-lookup"><span data-stu-id="2e7e6-989">6,994.21</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-990">1,965.79</span><span class="sxs-lookup"><span data-stu-id="2e7e6-990">1,965.79</span></span></td>
<td style="text-align: right;"><span data-ttu-id="2e7e6-991"><strong>9,000.00</strong></span><span class="sxs-lookup"><span data-stu-id="2e7e6-991"><strong>9,000.00</strong></span></span></td>
</tr>
</tbody>
</table>

> [!NOTE]
> <span data-ttu-id="2e7e6-992">Dette emne viser, hvordan et primært omkostningselement, 10001 Elektricitet, flyder gennem omkostningsobjekter.</span><span class="sxs-lookup"><span data-stu-id="2e7e6-992">This topic shows how a primary cost element, 10001 Electricity, flows through the cost objects.</span></span> <span data-ttu-id="2e7e6-993">Derfor tildeles disse faste omkostninger til det laveste niveau i organisationen.</span><span class="sxs-lookup"><span data-stu-id="2e7e6-993">Therefore, this overhead cost is allocated to the lowest level in the organization.</span></span> <span data-ttu-id="2e7e6-994">Det vil sige, at omkostningsobjekter på laveste niveau bærer omkostningen.</span><span class="sxs-lookup"><span data-stu-id="2e7e6-994">In other words, the cost objects at the lowest level bear the cost.</span></span> <span data-ttu-id="2e7e6-995">Hvis du har brug for en visuel tilførsel af omkostningen mellem omkostningsobjekter, kan du bruge politikreglerne for omkostningsakkumuleringen til at visualisere strømmen af omkostningerne.</span><span class="sxs-lookup"><span data-stu-id="2e7e6-995">If you require a visual flow of the cost between the cost objects, you can use the cost roll-up policy rules to visualize the flow of the cost.</span></span> <span data-ttu-id="2e7e6-996">Du kan få flere oplysninger under [Omkostningstotaler](cost-rollup.md).</span><span class="sxs-lookup"><span data-stu-id="2e7e6-996">For more information, see [Cost roll-up](cost-rollup.md).</span></span>
