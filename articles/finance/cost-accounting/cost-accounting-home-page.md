...
Følgende køreplan viser de vigtigste begreber og opgaver, der udgør strukturen i modulet Omkostningsregnskab. Klik på linksene i sektionen [Hurtige links](#quick-links) for at få mere at vide, hvordan du bruger modulet.

[![Køreplan for omkostningsregnskab.](./media/cost-accounting-map.png)](./media/cost-accounting-map.png)

## <a name="quick-links"></a>Hurtige links

| &nbsp; | &nbsp;  |
|------|---|
|  [Start her med omkostningsregnskab (Learn)](https://docs.microsoft.com/learn/modules/get-started-cost-accounting-dyn365-finance/)  |[Dimensioner for omkostningselement](cost-elements.md)  |
