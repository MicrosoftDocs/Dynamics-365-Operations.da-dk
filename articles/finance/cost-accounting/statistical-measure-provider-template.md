...
description: Denne artikel indeholder oplysninger om skabeloner for statistiske dimensionsmedlemmer og providere af statistiske målinger.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
Statistiske målinger kan stamme fra mange forskellige kilder. Dynamics 365 Finance er en fremragende kilde til at udtrække statistiske målinger fra. Du kan bruge en provider-skabelon for statistisk målinger til nemt at konfigurere de statistiske målinger, som du vil udtrække.
...
Gå til **Finanspost for omkostningsregnskab** \> **Faktisk version** \> **Administrer** \> **Statistiske målinger** for at oprette relationen. I dette scenarie skal du vælge **Dynamics 365 Finance – Statistiske målinger** som dataconnector for at udtrække data fra Finance.
...
|----------------|------------------------------------------------------------------------------------|------------------------------|
| Pakke CC D365FO | Dynamics 365 Finance – Statistiske målinger | Pakke-CC                      |
...
Gå til **Finanspost for omkostningsregnskab** \> **Faktisk version** \> **Administrer** \> **Statistiske målinger** for at oprette relationen. I dette scenarie skal du vælge **Importerede statistiske målinger** som dataconnector, fordi dataene er importeret fra et tredjepartssystem til omkostningsregnskabet via Excel.
