...
description: Denne artikel definerer nøgleudtryk, der bruges i omkostningsregnskabet.
author: aprilolson
ms.date: 08/31/2017
ms.topic: article
ms.prod: ''
...
Denne artikel definerer nøgleudtryk, der bruges i omkostningsregnskabet.
...
-  Dynamics 365 Finance (forudkonfigureret)
...
|  **Tabeller** |  **Dataconnector for importerede transaktioner** | **Dynamics 365 Finance-dataconnector**  | **Dynamics AX-dataconnector**  |
|---|---|---|---|
