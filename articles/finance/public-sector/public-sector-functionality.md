...
ms.locfileid: "9572971"
---
# <a name="public-sector-home-page"></a>Startside for offentlig sektor

[!include [banner](../includes/banner.md)]

Du kan gøre det muligt at bruge forretningsprocesser, der er fælles for både den offentlige og private sektor, f.eks. opgaver med budgetplanlægning, indkøb, kreditor og debitor. 
...
- [Oversigt over budgetplanlægning i den offentlige sektor](budgeting-public-sector.md)
