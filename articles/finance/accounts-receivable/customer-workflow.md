...
Arbejdsgangen følger standardprocessen for arbejdsgang i applikationen. Godkenderen dirigeres til siden **Kunde**, hvor han eller hun kan gennemgå ændringerne på siden **Forslag til ændringer** og derefter vælge **Arbejdsgang \> Godkend** for at godkende arbejdsgangen. Når alle godkendelser er fuldført, opdateres felterne med de værdier, du foreslog.
