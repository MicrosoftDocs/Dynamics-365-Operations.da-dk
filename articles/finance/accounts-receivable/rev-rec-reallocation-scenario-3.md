...
[![Oprindelig faktura, tilbageført dokument og den nye faktura på debitortransaktioner-siden](./media/35_rev-rec-scenarios.png)](./media/35_rev-rec-scenarios.png)
