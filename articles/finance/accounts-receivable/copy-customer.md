---
title: Kopiere kunder ved hjælp af delte nummerserier
description: Denne artikel beskriver, hvordan du kan bruge delte nummerserier til at kopiere en kunde til en anden juridisk enhed, men bevare det samme kunde-id.
author: abruer
ms.date: 08/31/2018
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "8899979"
---
# <a name="copy-customers-by-using-shared-number-sequences"></a>Kopiere kunder ved hjælp af delte nummerserier
