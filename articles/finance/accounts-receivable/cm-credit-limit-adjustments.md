...
description: Denne artikel beskriver, hvordan du kan konfigurere og tilføje reguleringer af kreditgrænser.
...
Du kan oprette poster i kladden **Regulering af kreditgrænse** på siden **Regulering af kreditgrænse** (**Kreditstyring \> Reguleringer af kreditgrænse \> Reguleringer af kreditgrænse**).
