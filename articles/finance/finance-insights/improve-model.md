...
description: Denne artikel beskriver funktioner, som du kan bruge til at forbedre ydeevnen i forudsigelsesmodeller.
...
ms.locfileid: "8846880"
---
# <a name="improve-the-prediction-model"></a>Forbedre forudsigelsesmodellen

[!include [banner](../includes/banner.md)]

Denne artikel beskriver funktioner, som du kan bruge til at forbedre ydeevnen i forudsigelsesmodeller. Du begynder at forbedre din model i arbejdsområdet **Forudsigelser om debitorbetalinger** i Microsoft Dynamics 365 Finance. Forbedringstrinene fuldføres derefter i AI Builder.
...
Du kan finde flere oplysninger om filtrering af dataene under [Oprette en forudsigelsesmodel](/ai-builder/prediction-create-model#filter-your-data).
