...
description: Denne artikel indeholder en oversigt over indstillinger til betalingsforslag og indeholder nogle eksempler på, hvordan betalingsforslag fungerer.
author: abruer
ms.date: 04/04/2018
ms.topic: article
ms.prod: ''
