...
description: I denne artikel beskrives forskellene mellem tilbageførsel, sletning, annullering og afvisning af en betaling, og hvordan en leverandørcheck tilbageføres.
author: angelad116
ms.date: 10/24/2022
ms.topic: article
ms.prod: ''
