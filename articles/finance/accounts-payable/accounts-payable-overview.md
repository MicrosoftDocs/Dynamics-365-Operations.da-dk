...
description: I dette emne beskrives de sider, som du kan bruge til at konfigurere grundlæggende og valgfri funktioner for Kreditor. Der beskrives også de installationstrin, du skal fuldføre, før du begynder at konfigurere Kreditor.
author: abruer
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
-   På siden **Pristolerancer** kan du angive tolerancer for enhedspriser.
...
-   På siden **Kasserabatter** kan du konfigurere og administrere betingelserne for at opnå kasserabatter. Kasserabatkoderne knyttes til kreditorer og anvendes på indkøbsordrer.
...
-   På siden **Betalingsformålskoder** kan du konfigurere **Nationalbankens formålskode**.
