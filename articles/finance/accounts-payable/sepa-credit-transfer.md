...
description: Dette emne indeholder generelle oplysninger om ISO 20022-kreditoverførsler, som omfatter SEPA-kreditoverførsler (Single Euro Payments Area) og andre elektroniske betalinger til kreditorer.
author: sunfzam
ms.date: 06/20/2017
ms.topic: overview
ms.prod: ''
