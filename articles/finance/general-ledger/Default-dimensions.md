...
description: Denne artikel forklarer de komponenter, der udgør kontoplanen, og hvordan komponenterne arbejder sammen.
author: aprilolson
ms.date: 10/24/2022
ms.topic: article
ms.prod: ''
...
Et omfattende regelbaseret system bruges til definition af gyldige kombinationer af værdier for hovedkonti og økonomiske dimensioner. Dette afsnit giver en kort oversigt over funktionaliteten af hver komponent og forklarer, hvor du kan finde komponenten.
...
Nogle af følgende ressourcer refererer til en tidligere version af vores software. Men mange af oplysningerne om anvendelsen af standarddimensioner og mange af begreberne er de samme i den tidligere version, og referencerne er stadig gyldige.
