...
description: Denne artikel indeholder detaljerede oplysninger om det importformat, der bruges til konsolidering af økonomiske data fra flere juridiske enheder.
author: jinniew
ms.date: 10/09/2020
ms.topic: article
ms.prod: ''
...
Denne artikel indeholder detaljerede oplysninger om det importformat, der bruges til konsolidering af økonomiske data fra flere juridiske enheder. Importformatet skal gemmes som en tekstfil (.txt).
