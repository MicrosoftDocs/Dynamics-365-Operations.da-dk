...
ms.locfileid: "7727058"
---
# <a name="financial-period-close-workspace"></a>Arbejdsområde til afslutning på regnskabsperiode

[!include [banner](../includes/banner.md)]

Dette emne indeholder en oversigt over arbejdsområdet **Afslutning på regnskabsperiode** og den tilknyttede konfiguration.
...
Før du kan bruge arbejdsområdet **Afslutning på regnskabsperiode**, skal du konfigurere processen ved hjælp af siden **Konfiguration af afslutning på regnskabsperiode**. (Klik på **Finans** &gt; **Luk periode** &gt; **Konfiguration af afslutning på regnskabsperiode**).
