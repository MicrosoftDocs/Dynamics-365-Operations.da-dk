...
description: Dette emne indeholder en forklaring på, hvordan bogføringer konfigureres i Debitor, og viser eksempler på bogføringskonfigurationer.
