...
ms.locfileid: "7726865"
---
# <a name="ledger-allocation-rules"></a>Finansfordelingsregler

[!include [banner](../includes/banner.md)]

Dette emne indeholder oplysninger om finansfordelingsregler. Den beskriver de forskellige komponenter i disse fordelingsregler og de fordelingsmetoder, som kan bruges til dem.
