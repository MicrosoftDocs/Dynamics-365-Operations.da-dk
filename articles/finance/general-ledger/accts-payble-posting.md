...
description: Dette emne indeholder en forklaring på, hvordan bogføringer konfigureres i Kreditor, og viser eksempler på bogføringskonfigurationer.
