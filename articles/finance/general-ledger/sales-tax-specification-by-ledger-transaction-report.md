...
description: Denne artikel forklarer, hvordan du kan bruge rapporten Momsspecifikation pr. finanstransaktion til at se og udskrive oplysninger om finanstransaktioner, der er beregnet moms for.
author: EricWang
ms.date: 08/19/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8898085"
---
# <a name="sales-tax-specification-by-ledger-transaction-report"></a>Momsspecifikation pr. finanstransaktionsrapport
[!include [banner](../includes/banner.md)]

Denne artikel forklarer, hvordan du kan bruge rapporten **Momsspecifikation pr. finanstransaktion** til at se og udskrive oplysninger om finanstransaktioner, der er beregnet moms for.
