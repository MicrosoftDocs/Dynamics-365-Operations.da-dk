...
Du kan oprette seks typer projekter i Finans. Hver enkelt projekttype er angivet forskelligt med hensyn til omkostninger og indtægtsføring. Den projekttype, du vælger, afhænger af formålet med projektet. I følgende tabel beskrives den typiske brug af de enkelte projekttyper.
...
Finans reducerer ikke automatisk de budgetterede skøn. Der er derfor en god ide at bevare en oprindelig budgetmodel for fastprisprojektet for at oprette stamdata til sammenligning, når projektet er fuldført. 
...
:::row:::
    :::column:::
        #### <a name="cash-flow-page"></a>Pengestrømsside
        - Indgående pengestrømme 
        - Udgående pengestrømme
        - Nettopengestrømme
    :::column-end:::
    :::column:::
        #### <a name="project-statements-page"></a>Siden projektopgørelse.
        - Indtægter
        - Totalomkostning
        - Bruttoavance
    :::column-end:::
