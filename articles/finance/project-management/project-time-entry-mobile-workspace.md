...
Hvis Finance er implementeret for organisationen, skal systemadministratoren publicere mobilarbejdsområdet **Tidsregistrering for projekt**. Du kan finde flere oplysninger under [Publicere et arbejdsområde til mobilenheder](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
