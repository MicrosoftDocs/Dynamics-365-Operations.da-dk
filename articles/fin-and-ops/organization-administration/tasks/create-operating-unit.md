...
---
# <a name="create-operating-units"></a>Oprette driftsenheder
...
1. Gå til Virksomhedsadministration > Organisationer > Driftsenheder.
2. Klik på Ny for at åbne dialogboksen Fjern.
3. Find og vælg den ønskede post på listen.
    * Vælg den type driftsenhed, du vil oprette.  
