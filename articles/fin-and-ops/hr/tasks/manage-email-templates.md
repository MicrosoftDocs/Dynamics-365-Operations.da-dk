...
1. Gå til Ansøgningsbogmærker.
2. Find og vælg den ønskede korrespondancehandling på listen.
3. Klik på Rediger.
4. Find og vælg den ønskede post på listen.
    * Vælg de felter, du gerne vil bruge i en e-mailskabelon for den valgte korrespondancehandling, og flyt dem til Bogmærkefelter.  
5. Luk siden.

## <a name="create-an-email-template"></a>Oprette en e-mail-skabelon
1. Gå til Personale > Rekruttering > Kommunikation > Skabeloner til ansøgnings-e-mail.
2. Klik på Ny.
3. Vælg "Samtale" i feltet Korrespondancehandling.
    * Vælg den korrespondancehandling, der indeholder bogmærkerne, der skal bruges til denne type e-mailkommunikation.  
