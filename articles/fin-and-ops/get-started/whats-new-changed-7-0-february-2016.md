...
<td>Etiketterne i formularerne <strong>InventPosting</strong>, <strong>Ressource</strong>, <strong>ResourceGroup</strong> og <strong>ProductionGroup</strong> justeres ikke altid med de etiketter for <strong>LedgerPostingType</strong>, der faktisk bruges. Det er ikke let at forstå den terminologi, der bruges på etiketterne.</td>
...
<td>Det er lettere at konfigurere systemet, fordi de nye etiketter er relateret til de operationelle hændelser, der bruger denne bogføringstype.</td>
</tr>
<tr class="odd">
...
|                                                                                                              |                                                                                                                                                                                                    |                                                                                                                                                                                                                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|--------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                      <strong>Hvad kan du gøre?</strong>                                       |                                                                                 <strong>Dynamics AX 2012</strong>                                                                                  |                                                                                                <strong>Dynamics AX 7.0</strong>                                                                                                |                                                                                                                                                                                                                                                                               <strong>Hvorfor er det vigtigt?</strong>                                                                                                                                                                                                                                                                                |
...
|                                       Integrere med Microsoft Office.                                       |                                                                                           Ikke ledig                                                                                            |                                              Nye funktioner omfatter Excel Data Connector-appen, <strong>Projektmappedesigner</strong> side, eksport af API og dokumentstyring.                                              |                                                                                                                                                                                                                                                                      Du kan oprette produktivitetsløsninger for dine slutbrugere.                                                                                                                                                                                                                                                                       |
...
<td>Det er lettere at få adgang til vigtige oplysninger, når kontostrukturerne er defineret og redigeret.</td>
</tr>
<tr class="even">
...
<td>Faktabokse er føjet til siden <strong>Kontoplan</strong>.</td>
...
<td>Ikke ledig </td>
<td>Ny <strong>Global finanskladde</strong> side til angivelse af finanskladder. Rettigheder til denne side føjes til rollen <strong>Bogholder</strong>.</td>
...
<tr class="odd">
<td>Bruge den nye <strong>Sporing af regnskabskilde</strong>side.</td>
<td>Tilgængelig fra Dynamics AX 2012 R3 CU10.</td>
<td>Ny <strong>Sporing af regnskabskilde</strong> side og handlinger til at gå dertil fra <strong>Råbalance</strong> listesiden og <strong>Bilagstransaktioner</strong> siden.</td>
...
<td>Ved udskrivning af en rapport bruges browserens udskriftsindstillinger, og der udskrives kun det, brugeren kan se på skærmen. </td>
...
<td>Ikke ledig </td>
<td>Afslutningsskabeloner og -tidsplaner kan oprettes ved hjælp af Afslutning på regnskabsperiode-konfigurationen. Brug <strong>Afslutning på regnskabsperiode</strong>-arbejdsområdet til at spore status for afslutning af tidsplaner på tværs af flere firmaer.</td>
...
<tr class="odd">
<td>Overvåge budgettet kontra faktiske oplysninger og oprette budgetter i Finans ved hjælp af arbejdsområdet <strong>Finansbudgetter og budgetter</strong> og yderligere forespørgselsformularer.</td>
<td>Ikke ledig</td>
<td> Arbejdsområdet kan åbnes ved hjælp af Dynamics AX-dashboard. Det indeholder links til flere nye forespørgselssider: <strong>Faktisk vs. budgetoversigt</strong>, <strong>Statistik for budgetstyringsoversigt</strong>, <strong>Budgetregisterposter</strong> og <strong>Budgetplaner</strong>.</td>
...
<td>Dokumentet <strong>Budgetplan</strong> vises som en liste over de linjer, der har ikrafttrædelsesdatoer og beløb for kombinationer af økonomiske dimensioner. Brugeren skal oprette og bruge Excel-skabeloner til at få vist budgetplandata i en pivottabel.</td>
...
<tr class="odd">
<td>Udskriv rapporten <strong>Kreditorfakturaposteringer</strong> ved hjælp af oplysninger fra rapporten <strong>Detaljeret forfaldsliste</strong>, som indeholder dagene efter forfald. </td>
<td>Du skal udskrive to forskellige rapporter: <strong>Detaljeret forfaldsliste</strong> og <strong>Kreditorfakturaposteringer</strong>.</td>
<td>Oplysninger om de to rapporter er konsolideret i rapporten <strong>Kreditorfakturaposteringer</strong>. Rapporten <strong>Detaljeret forfaldsliste</strong> er forældet. </td>
...
<td>Ikke ledig</td>
<td>På siden <strong>Momsafregningsperiode</strong> kan du angive, at afregningsprocessen skal køres i batchtilstand.</td>
...
<td>Det giver en filtreret visning af medarbejdere, der er ansat i det firma, der er logget på. Medarbejderlisten er stadig tilgængelig for en ufiltreret visning af alle medarbejdere og kontrahenter. I den aktuelle version af Dynamics AX ændrer systemet ikke firmaet ud fra den medarbejder, der er valgt på listen.</td>
</tr>
<tr class="odd">
...
<td>Du skal generere <strong>Salgs- og købmoms</strong>-rapporter ved hjælp af funktionen ikke-realiseret moms, så brugerne kan identificere posteringer, der tilhører de realiserede og ikke-realiserede sektioner baseret på status.</td>
<td><strong>Salgs- og købsmoms</strong>-rapporter er blevet ændret, og medtager nu funktionen for betinget moms ved hjælp af specifikke afregningsperioder for definitionen af ikke-realiserede og realiserede momskoder.</td>
...
<td>Ikke ledig</td>
<td>På siden <strong>Parametre for anlægsaktiv</strong> kan du vælge at indhente i slutningen af regnskabsperioden eller regnskabsåret.</td>
...
<td>Saldoliste med rapport over konti med gruppetotaler er implementeret som SSRS-rapport (LedgerAccountSum_FR).</td>
...
|                                                                                                                                                                   |                                                                                                                                                |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                 <strong>Hvad kan du gøre?</strong>                                                                 |                                                       <strong>Dynamics AX 2012</strong>                                                        |
| Udfør en kontrol af materialetilgængelighed til produktionsordrer på en separat side, der åbnes fra arbejdsområdet <strong>Administration af produktion</strong>. |                                                                 Ikke tilgængelig                                                                  |
|                               Starte og rapportere status på produktionsjob ved hjælp af den nye side <strong>Jobkortenhed</strong>.                                | Formularen <strong>Jobregistrering </strong>er primært målrettet større terminalskærme, og der er typisk adgang til brugergrænsefladen via museklik. |
...
<ul>
<li>Administrer arbejdere og arbejdernes POS-tilladelser.</li>
...
<td>API'en for e-handel understøttes ikke af Retail Server.</td>
