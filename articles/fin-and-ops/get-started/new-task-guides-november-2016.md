...
### <a name="cash-management"></a>Likvide midler
...
|                                                       Konfigurere årsagskoder for australsk BAS                                                       |     Australien og New Zealand     |
|                                                <strong>\</strong>*Kontrol af kinesisk bilagskontinuitet                                                |               Kina               |
|                                         <strong>\</strong>*CN-00010 Hierarki i kontoplan for Kina                                          |               Kina               |
|                                       <strong>\</strong>*CN-00016 Log over brugerhandlinger efter arbejdsregler i Kina                                        |               Kina               |
|                                              <strong>\</strong>*Eksportopsætning for Golden Tax-integration                                               |               Kina               |
|                                     <strong>\</strong>*Bogføre bilag fra andre moduler, f.eks. salgsfakturaer                                      |               Kina               |
|                                             <strong>\</strong>*Bogføre bilag fra finanskladden                                             |               Kina               |
|                                         <strong>\</strong>*Konfigurere basisprofil for momsintegration i Kina                                         |               Kina               |
|                                                    <strong>\</strong>*Konfigurere kinesiske bilag                                                     |               Kina               |
|                                          Oprette og bogføre en debitorfaktura for en debitor i den offentlige sektor                                          |              Danmark              |
...
|                                                            Konfigurere indbetalingskortformat                                                             |              Danmark              |
|                                             <strong>\</strong>*EEU 00047 Forskud til medarbejder                                              |          Østeuropa           |
|                                          Oprette og eksportere kreditorbetalinger ved hjælp af ISO20022-betalingsformat                                          |              Europa               |
|                                            Oprette betalinger for kunder, der har bemyndigelser til direkte debitering                                            |              Europa               |
|                                           <strong>\</strong>*EE-00015 Værktøj til generering af betalingsreference                                           |              Europa               |
|                                                  EUR-00002 Generere en EU Intrastat-opgørelse                                                   |              Europa               |
|                             <strong>\</strong>*EUR-00002 Angive en fragtadresse for en transaktion inden for EU                              |              Europa               |
...
|                                              <strong>\</strong>*EUR-00015 Søgning efter part ved hjælp af moms-id                                               |              Europa               |
|                                            <strong>\</strong>*EUR-00015 Registrering af kreditors moms-id                                             |              Europa               |
|                                                    <strong>\</strong>*EUR 00015 Konfigurere moms-id                                                     |              Europa               |
|                                               <strong>\</strong>*HU-00001 Beregning af valutakurs                                               |              Europa               |
|                                                   Importere konfiguration for ISO20022-kreditoverførsel                                                   |              Europa               |
|                                                    Importere ISO20022 Direct Debit-konfiguration                                                     |              Europa               |
|  <strong>\</strong>*LT-00003 Overførselsdokument for varetransport inden for virksomheden/Oprette et overførselsdokument til en intern lageroverførsel  |              Europa               |
| <strong>\</strong>*LT-00003 Overførselsdokument for varetransport inden for virksomheden/Konfigurere overførselsdokumenterne for transport af varer inden for en virksomhed |              Europa               |
|                                         <strong>\</strong>*NO-00002 Debitorbetaling baseret på betalings-id                                          |              Europa               |
|                                            Konfigurere firmas bankkonti for ISO20022-kreditoverførsler                                             |              Europa               |
...
|                                              <strong>\</strong>*EUR-00018 Momsafstemningsrapport                                               |              Island              |
...
|                                          BPM-linje                                           | Land/område |
|---------------------------------------------------------------------------------------------|----------------|
| <strong>\</strong>*Ændre ejerskabet til konsignationslager ud fra produktionsbehov |     Globalt     |
|                 <strong>\</strong>*Oprette en genopfyldningsordre til konsignation                 |     Globalt     |
|         <strong>\</strong>*Overvåge konsignationslager ved hjælp af kreditorsamarbejde         |     Globalt     |
...
|                                   BPM-linje                                    | Land/område |
|-------------------------------------------------------------------------------|----------------|
| <strong>\</strong>*Tilføje til performancekladde og sende ros til en person |     Globalt     |
|                       <strong>\</strong>*Oprette et mål                        |     Globalt     |
|                <strong>\</strong>*Oprette en performancegennemgang                 |     Globalt     |
...
| <strong>\</strong>*Konfigurere produktanbefalinger, der er baseret på maskinel indlæring |     Globalt     |
|        Konfigurere funktionalitetsprofilen for en sælger         |     Globalt     |
|        <strong>\</strong>*Oprette en visuel POS-profil (november 2016)         |     Globalt     |
|                         Oprette og tilknytte registre                         |     Globalt     |
...
|         <strong>\</strong>*Definere kommunation for detailkanaler (CDX)         |     Globalt     |
...
### <a name="supply-relationship-management"></a>Administration af leverandørrelationer
...
|                                      BPM-linje                                       | Land/område |
|-------------------------------------------------------------------------------------|----------------|
|                              Oprette en lokalitetsprofil.                              |     Globalt     |
| <strong>\</strong>*Oprette et menupunkt for mobilenhedens id-konsolidering |     Globalt     |
...
|                       Konfigurere automatisk fragtafstemning                       |     Globalt     |
|              <strong>\</strong>*Konfigurere vareomfordeling for kort plukning              |     Globalt     |
...
[Nye eller opdaterede tilgængelige opgaveguider (august 2016)](new-updated-task-guides-available-august-2016.md)
