...
- [Funktioner, der i øjeblikket ikke er implementeret i lokale installationer](features-not-implemented-on-prem.md)
...
Der er to måder at købe et abonnement til en lokal installation

### <a name="buy-through-volume-licensing"></a>Købe via volumenlicens

Hvis organisationen har 250 eller flere brugere af Dynamics 365, vil du muligvis være interesseret i en [Volumenlicensaftale](https://www.microsoft.com/en-us/Licensing/product-licensing/dynamics365).
...
Du kan samarbejde med en Microsoft Cloud Solution Provider for at forstå behovene i din virksomhed eller organisation. [Bruge Microsoft Partnercenter-portalen til at finde en partner til dine behov](https://partnercenter.microsoft.com/partner/home).
...
- [Introduktion til fordele ved Microsoft Dynamics Cloud Service-support](http://go.microsoft.com/fwlink/?LinkId=530335) (PDF)
