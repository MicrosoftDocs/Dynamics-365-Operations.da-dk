...
> [!NOTE]
> Betegnelsen *juridiske enhed* bruges i Finance and Operations, og udtrykket *regnskab* bruges i Økonomirapportering. Begge disse udtryk anvendes i dette emne. Men i dette emne har de samme betydning.
...
Finance and Operations bruger en særskilt juridisk enhed til at behandle en konsolidering. Det anvender en enkelt forekomst til konsolidering, men giver mulighed for at hente data fra andre kilder. Konsolideringsprocessen skal køres, hver gang der foretages ændringer i kildens juridiske enheder.
...
- **Dybde på data** – Du kan oprette konsoliderede rapporter, der samler faktiske data og budgetdata på både kontoniveau og dimensionsniveau. Disse data omfatter for Finance and Operations data fra budgetstyring og budgetplanlægning.
...
- **Strømlinet valutaomregning** – Efter minimal opsætning i Finance and Operations kan du omregne enhver Økonomirapportering-rapport til enhver rapporteringsvaluta, som er blevet oprettet. Du kan desuden oprette et ubegrænset antal rapporteringsvalutaer.
