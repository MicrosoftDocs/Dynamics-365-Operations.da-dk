...
Flere variationer af det foregående scenarie er mulige, hvis fakturaintegration er påkrævet. Overførsel af data er en anden metode, hvor denne grænseflade kan bruges til at oprette fakturaer og vedhæftede filer i Finance and Operations.
...
En datapakke er arbejdsenheden, der skal sendes til Finance and Operations , så fakturahoveder, fakturalinjer og fakturaens vedhæftede filer kan oprettes. Følgende dataenheder anvendes for de artefakter, der udgør datapakken:
...
Dette emne give ikke en detaljeret definition af en datapakke. Det forklarer heller ikke, hvordan datapakker oprettes. Du kan finde disse oplysninger i [Struktur for dataenheder og pakker](../../dev-itpro/data-entities/data-entities-data-packages.md).
...
+ Når der sendes en datapakke, der indeholder fakturaer, til Finance and Operations, kan kalderen (dvs. det integrationsprogram, der kører uden for Finance and Operations) udtrykkeligt nævne regnskabs-id i HTTP-anmodningen. I dette tilfælde tilsidesættes den regnskabskontekst, hvor behandlingsjobbet kører Finance and Operations, og fakturaerne importeres til det regnskab, der blev sendt via HTTP-anmodningen.
