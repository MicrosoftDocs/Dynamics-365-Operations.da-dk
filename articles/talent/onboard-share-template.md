...
Microsoft Dynamics 365 Talent: Onboard giver dig mulighed for at dele onboardingguider og -skabeloner med andre bidragydere, så de kan gennemgå dokumenterne og foretage ændringer.

## <a name="share-an-onboarding-guide-with-other-contributors"></a>Dele en onboardingguide med andre bidragydere

1. Vælg **Guider** i menuen til venstre, og vælg derefter den guide, du vil dele.
2. Vælg knappen **Mere** (tre lodrette prikker) i øverste højre hjørne af siden, og vælg dernæst **Del**.

    ![[Deling af en onboardingguide med andre bidragydere](./media/onboard-share-guide.png)](./media/onboard-share-guide.png)
...
6. Når du er færdig med at tilføje eller ændre modtagere, skal du vælge **Opdater**.

## <a name="share-an-onboarding-template-with-other-contributors"></a>Dele en onboardingskabelon med andre bidragydere

1. Vælg **Skabeloner** i menuen til venstre.
2. Under **Mine skabeloner** skal du vælge knappen **Mere** (ellipsen \[**...**\]) i øverste højre hjørne af den skabelon, du vil dele, og derefter vælge **Del**.

    [![Deling af en skabelon med andre bidragydere](./media/onboard-share-template.png)](./media/onboard-share-template.png)
