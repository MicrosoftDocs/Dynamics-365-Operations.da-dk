...
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-june-18-2019"></a>Nyheder eller ændringer i Dynamics 365 for Talent (18. juni 2019)
...
De ændringer, der er beskrevet i dette afsnit, gælder for build-nummer 8.1.2347.

### <a name="confirmation-of-course-participants-causes-an-error"></a>Bekræftelse af kursusdeltagere forårsager en fejl

Dialogboksen til udskrivning af rapporten om kursusdeltagere er blevet fjernet. Denne rapport understøttes ikke i Talent.

### <a name="the-compensation-section-of-the-transfer-worker-page-isnt-available-in-some-scenarios"></a>Sektionen Kompensation på siden Overfør arbejder er ikke tilgængelig i visse scenarier.

Denne ændring giver brugerne mulighed for at angive kompensationsdata, når de udfylder siden **Overfør arbejder**.
...
Følgende enheder understøtter brugerdefinerede felter: lønkode og kompensationsreferencepunkt. 
