...
Ændringer, der er beskrevet i dette afsnit, gælder for build-nummer 8.1.2604. Tallene i parenteser i nogle overskrifter henviser til supportnumre i Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Office-placeringen opdateres ikke via Excel-projektmappen (369727)

Med denne ændring kan du nu opdatere Office-placeringen ved hjælp af designeren Office-projektmappe.
