...
<li>OPOS</li>
<li>Netværk
<p><strong>Bemærk!</strong> Der kan kun konfigureres én skuffe, hvis <strong>Brug af delt skift</strong> er konfigureret på skuffen.</p>
</li>
</ul>
</td>
</tr>
...
> [!NOTE]
> Når IIS-hardwarestationen er "dedikeret", er der en én til én-relation mellem POS-klienten og hardwarestationen.
...
<li>OPOS</li>
<li>Windows-driver
<p><strong>Bemærk!</strong> Til Windows-printere på et netværk skal brugeren af hardwarestationen have rettighed til at få adgang til printeren.</p>
</li>
<li>Netværk</li>
</ul>
</td>
...
<li>OPOS</li>
<li>Netværk
<p><strong>Bemærk!</strong> Der kan kun konfigureres én skuffe pr. hardwareprofil, hvis <strong>Brug af delt skift</strong> er konfigureret på skuffen.</p>
</li>
</ul>
</td>
</tr>
...
3. Opret en hardwarestation af typen **Dedikeret** til den detailbutik, hvor POS-kasseapparatet skal bruges. En beskrivelse er valgfri.
...
6. Vælg distributionsplanen **1070** for at synkronisere den nye hardwarestation til butikken. Klik på **Kør nu** for at synkronisere ændringer til POS-enheden.
...
- Kun TLS (Transport Layer Security) version 1.2 (eller den aktuelle højeste version) skal aktiveres og anvendes.
    ...
    > [!NOTE]
    > Som standard er SSL og alle versioner af TLS, undtagen TLS 1.2, deaktiveret.

    Hvis du vil redigere eller aktivere disse værdier, skal du følge disse trin:
...
- Den computer, der kører Modern POS har tillid til det certifikat, der bruges på den computer, der kører hardwarestationen.
    ...
    - Hvis du vil kontrollere denne opsætning, skal du i en webbrowser gå til følgende webadresse: `https://<Computer Name>:<Port Number>/HardwareStation/ping`.
