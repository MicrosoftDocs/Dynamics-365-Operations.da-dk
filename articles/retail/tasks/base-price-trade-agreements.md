...
1. Gå i **navigationsruden** til **Moduler > Detail og handel > Styring af prissætning og rabatter > Prisgrupper > Alle prisgrupper**. Prisgrupper er den måde samhandelsaftaler er tildelt til bestemte kanaler. Hvis du bruger prisgrupper til at tildele samhandelsaftaler til en kanal, er det muligt at have kanalspecifikke priser.  
2. Klik på **Ny**.
3. Indtast en værdi i feltet **Prisgrupper**.
4. Skriv en værdi i feltet **Navn**.
5. Klik på **Gem**.
6. Luk siden.
7. På **navigationssiden** skal du gå til **Moduler > Detail og handel > Kanaler > Detailbutikker > Alle detailbutikker**.
...
15. Luk siden.
16. Luk siden.
17. Gå i **navigationsruden** til **Moduler > Detail og handel > Produkter og kategorier > Frigivne produkter efter kategori**.
