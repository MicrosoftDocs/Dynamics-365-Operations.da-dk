...
description: Dette emne giver en oversigt over omni-kanalbetalinger i Microsoft Dynamics 365 for Retail.
author: rubendel
manager: AnnBe
ms.date: 05/12/2019
ms.topic: article
...
ms.locfileid: "1606186"
---
# <a name="omni-channel-payments-overview"></a>Oversigt over omni-kanalbetalinger

[!include [banner](../includes/banner.md)]

Dette emne giver en oversigt over omni-kanalbetalinger i Microsoft Dynamics 365 for Retail. Det indeholder en omfattende liste over understøttede scenarier, oplysninger om funktionalitet, opsætning og fejlfinding samt beskrivelser af nogle typiske problemer.
...
- **Konfiguration af omni-kanalbetalinger**: Gå til **Detail \> Opsætning af Headquarters \> Parametre \> Delte parametre for detail** i administrationen. Indstil derefter **Brug omni-kanalbetalinger** til **Ja** under fanen **Omni-kanalbetalinger**.
...
- Indstillingen **Omni-kanalbetalinger** på siden **Delte parametre for detail** er angivet til **Sand**.
...
3. I Retail kan du bruge batchjobbet **Synkroniser ordrer** og **P-001**-distributionsplanen til at oprette ordrerne i administrationen på kontoret.
...
1. På siden **Kundeservice** i Retail skal du angive **Karen Berg** i søgepanelet og derefter vælge **Søg**. 
