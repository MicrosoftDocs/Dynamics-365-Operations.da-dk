...
# <a name="hybrid-customer-orders"></a><span data-ttu-id="6bda9-103">Hybride kundeordrer</span><span class="sxs-lookup"><span data-stu-id="6bda9-103">Hybrid customer orders</span></span>

[!include [banner](includes/banner.md)]

<span data-ttu-id="6bda9-104">En hybrid kundeordre er en enkelt ordre, der indeholder produkter, der kan sælges ud af butikken af kunden, samt produkter, der skal afhentes eller sendes senere.</span><span class="sxs-lookup"><span data-stu-id="6bda9-104">A hybrid customer order is a single order, which contains products that can be carried out of the store by the customer, as well as products that will be picked up or shipped later.</span></span>
