...
1. Gå til **Detail** \> **Konfiguration af kanal** \> **Åbningstider**.
...
3. I dialogboksen **Tilføj et interval** skal du definere datointervallet, åbningstiderne og de helligdage, der kræves.
    ...
    ![Dialogboksen Tilføj interval](../dev-itpro/media/Storehours1.png "Dialogboksen Tilføj interval")
...
![Eksempel på kvittering](../dev-itpro/media/Storehours3.png "Eksempel på kvittering")
