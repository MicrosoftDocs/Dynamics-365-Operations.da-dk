...
8. Klik på OK.
    * Du kan vælge lige så mange organisationsformål, der er behov for til din organisation.  
9. Find og vælg den ønskede post på listen.
10. Klik på Angiv som standard.
11. Luk siden.
12. Klik på Gem.
13. Klik på Vis.
14. Klik på Rediger.
15. Klik på Indsæt.
16. Klik på Virksomhedsenhed.
17. Find og vælg den ønskede post på listen.
18. Klik op linket i den valgte række på listen.
19. Klik på Indsæt.
20. Klik på Commerce-kanal.
21. Find og vælg den ønskede post på listen.
22. Klik op linket i den valgte række på listen.
    * Du kan tilføje så mange organisationsenheder, der er behov for.  
23. Klik på Gem.
24. Klik på Luk.
25. Klik på Publicer for at åbne dialogboksen Fjern.
26. Angiv en dato og et klokkeslæt i feltet Ikrafttrædelsesdato.
27. Angiv en dato og et klokkeslæt i feltet Ikrafttrædelsesdato.
28. Indtast en værdi i feltet Beskriv ændringer.
29. Klik på Publicer.
30. Klik på Luk.
