---
title: Gemme, se prøveversion og udgive en side
description: Denne artikel beskriver, hvordan du gemmer, ser forhåndsvisning af og udgiver en side i Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 04/14/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9280208"
---
# <a name="save-preview-and-publish-a-page"></a>Gemme, se prøveversion og udgive en side

[!include [banner](includes/banner.md)]

Denne artikel beskriver, hvordan du gemmer, ser forhåndsvisning af og udgiver en side i Microsoft Dynamics 365 Commerce.
