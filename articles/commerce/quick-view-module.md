---
title: Modul til hurtig visning
description: Denne artikel omhandler hurtig visning-moduler og beskriver, hvordan du kan føje dem til sider på websteder i Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8847569"
---
# <a name="quick-view-module"></a>Modul til hurtig visning

[!include [banner](includes/banner.md)]

Denne artikel omhandler hurtig visning-moduler og beskriver, hvordan du kan føje dem til sider på websteder i Microsoft Dynamics 365 Commerce.
...
1. Gå til et **Produktsamling**-modul på startsiden, vælg ellipsen (**...**), og vælg derefter **Tilføj modul**.
1. I dialogboksen **Vælg moduler** skal du vælge modulet **Hurtig visning** og derefter **OK**.
