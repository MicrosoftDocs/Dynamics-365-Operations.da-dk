...
| Indsigt  |  Stream POS-driftsindsigtshændelser til din Application Insights-konto. | [Få adgang til logfiler i Application Insights](../dev-itpro/retail-component-events-diagnostics-troubleshooting.md#enable-diagnostic-events-in-application-insights)   |  Tilmelding af it-medarbejder/udvikler   |
