---
title: Indkøbskurvsmodul
description: Denne artikel omhandler indkøbsvogn-moduler og beskriver, hvordan du kan føje dem til sider på websteder i Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8866050"
---
# <a name="cart-module"></a>Indkøbskurvsmodul

[!include [banner](includes/banner.md)]

Denne artikel omhandler indkøbsvogn-moduler og beskriver, hvordan du kan føje dem til sider på websteder i Microsoft Dynamics 365 Commerce.
...
1. Vælg modulet **Indkøbskurv** i dialogboksen **Vælg fragment**.
...
1. På pladsen **Indkøbskurv** skal du vælge ellipsen (**...**) og derefter **Tilføj modul**.
