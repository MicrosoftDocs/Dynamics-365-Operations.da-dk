...
- Data i det format, der kræves af anbefalingstjenesten, udtrækkes fra Commerce-driftsdatabasen og sendes til ADLS (Azure Data Lake Storage) eller enhedslageret.
