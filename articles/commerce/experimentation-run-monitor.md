...
Dette emne beskriver, hvordan du kører og overvåger dit eksperiment i en tredjepartsapp og eventuelt ændrer variationer. Før du udfører trinnene i dette emne, skal du [publicere](experimentation-preview-publish.md) dit eksperimenter i Commerce. I følgende diagram vises alle de trin, der er nødvendige for at konfigurere og køre et eksperiment på et e-handelswebsted i Dynamics 365 Commerce. Yderligere trin behandles i separate emner.
