...
description: Denne artikel omhandler interaktive funktionsmoduler og beskriver, hvordan du kan føje dem til sider på websteder i Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8898513"
---
# <a name="interactive-feature-module"></a>Interaktivt funktionsmodul

[!include [banner](includes/banner.md)]

Denne artikel omhandler interaktive funktionsmoduler og beskriver, hvordan du kan føje dem til sider på websteder i Microsoft Dynamics 365 Commerce.
...
1. I dialogboksen **Vælg moduler** skal du vælge modulet **Interaktiv funktion** og derefter vælge **OK**.
...
1. I dialogboksen **Vælg moduler** under **Vælg moduler** skal du vælge modulet **Interaktiv funktion** og derefter vælge **OK**.
...
1. I dialogboksen **Vælg moduler** skal du vælge modulet **Interaktivt funktionselement** og derefter vælge **OK**.
