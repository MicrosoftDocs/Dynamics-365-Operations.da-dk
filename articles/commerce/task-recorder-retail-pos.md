...
description: Denne artikel beskriver, hvordan du bruger Arbejdsrutineoptager i Retail Modern POS og Cloud POS.
author: josaw1
ms.date: 06/19/2017
ms.topic: article
ms.prod: ''
...
Denne artikel beskriver, hvordan du bruger Arbejdsrutineoptager i Retail Modern POS og Cloud POS.
...
> [!NOTE]
> Funktionen Hent skærmbilleder understøttes ikke i Store Commerce, Commerce Modern POS og Sky-POS.
...
Når du klikker på en opgaveguide i søgeresultaterne, kan du enten få vist trinnene som en artikel i Hjælp eller eksportere trinnene til et Word-dokument.
