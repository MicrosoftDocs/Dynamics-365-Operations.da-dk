...
description: Denne artikel beskriver de grundlæggende begreber for sortimentsstyring i Dynamics 365 Commerce og overvejelser i forbindelse med implementering af projekter.
author: josaw1
ms.date: 03/12/2018
ms.topic: article
ms.prod: ''
...
Dynamics 365 Commerce indeholder *sortimenter*, så du kan administrere produkttilgængeligheden på tværs af kanaler. Sortimenter bestemmer, hvilke produkter der er tilgængelige i bestemte butikker og i en bestemt periode.

I Commerce er et sortiment en tilknytning af en eller flere kanaler (eller grupper af kanaler, når der bruges organisationshierarkier) til et eller flere produkter (eller grupper af produkter, når der bruges kategorihierarkier).
...
Ud over at stoppe salget af et produkt kan du midlertidigt spærre et produktsalg. Du kan konfigurere denne indstilling under fanen **Commerce** for et frigivet produkt. Spærrede produkter udvælges stadig, men du får en meddelelse i POS, der angiver, at produktet ikke kan sælges.
...
Sortimenter, der defineres i Commerce, skal behandles, før de kan træde i kraft. Denne behandling udføres af følgende årsager:
...
Overvej følgende implementeringskrav, når du planlægger og administrerer sortimenter til din Commerce-installation:
