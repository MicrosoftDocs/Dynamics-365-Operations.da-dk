...
description: Denne artikel beskriver, hvordan du opretter en standarddebitor, der skal bruges, når der oprettes en kanal i Microsoft Dynamics 365 Commerce.
author: samjarawan
ms.date: 01/27/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9273579"
---
# <a name="create-a-default-customer"></a>Oprette en standarddebitor

[!include [banner](includes/banner.md)]

Denne artikel beskriver, hvordan du opretter en standarddebitor, der skal bruges, når der oprettes en kanal i Microsoft Dynamics 365 Commerce.
