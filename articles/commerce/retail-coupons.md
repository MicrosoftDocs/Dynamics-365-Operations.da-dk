...
description: Denne artikel indeholder en oversigt over kuponer og en beskrivelse af, hvordan de konfigureres i Dynamics 365 Commerce.
author: josaw1
ms.date: 10/05/2021
ms.topic: article
ms.prod: ''
