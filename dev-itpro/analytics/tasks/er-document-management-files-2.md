...
---
# <a name="extend-data-model-to-use-document-management-files-in-format-outputs-for-electronic-reporting-er"></a>Udvide datamodel til at bruge dokumentstyringsfiler i formatoutput til elektronisk rapportering (ER)
