...
---
# <a name="use-computations-to-make-the-output-for-counting-and-summing-for-electronic-reporting-er"></a>Bruge beregninger til fremstille output til optælling og opsummering til elektronisk rapportering (ER)
