...
---
# <a name="create-a-configuration-providand-mark-it-as-active-for-electronic-reporting-er"></a>Oprette en konfigurationsudbyder og markere den som aktiv til elektronisk rapportering (ER)
