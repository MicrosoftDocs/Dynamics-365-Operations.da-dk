...
- [Dataenheder](https://ax.help.dynamics.com/en/wiki/data-entities/)
...
- [Tilføjelse af Power BI-felter til arbejdsområder](http://ax.help.dynamics.com/en/wiki/configuring-powerbi-integration/)
