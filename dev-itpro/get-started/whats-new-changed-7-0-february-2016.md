---
title: "Hvad er ny eller ændret i Dynamics AX 7.0 (februar 2016)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Hvad er ny eller ændret i Dynamics AX 7.0 (februar 2016)
...
| Automatisere build, test og implementer.                                                                            | Delvis ledig                                                                                                                                                                                | Installere udviklertopologi ved hjælp af udvikler og build VM. Konfigurer automatisk build VM for at opdage, bygge moduler fra Visual Studio Online (VSO) og køre test. C\# og udarbejdelse af X ++-modul og referencer, der understøttes. | Det øger udviklernes produktivitet ved at reducere omkostninger og besvær til test og validering.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Udnytte Business Connector til at oprette forretningsregler og understøtte integrationsmuligheder.         | Business connector er tilgængelig til at ringe til X ++-kode fra administreret kode. Vi anbefaler, at du bruger business connector, kun kan forfatteren forretningslogik i C\#, ikke for integrationsmuligheder. | Business connector understøttes ikke længere. Oprettelseskravet dækkes af det faktum, at X ++ kompileres til en administreret kode. Derfor er interop lettere. Integrationsmulighederne opfyldes ved hjælp af OData.       | Du kan ikke bruge business connector fremover.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<td>Indstillinger for rapport er blevet tilføjet, så forskellige filtre kan anvendes, når en bruger får vist en rapport. Der genereres derefter en ny rapport baseret på disse filtre.</td>
...
<td>Analysere økonomiske data ved hjælp af "Overvågning af finansielle ydeevne" Power BI-indhold.</td>
<td>Ikke tilgængelig</td>
...
<td>Denne funktion er implementeret som en elektronisk rapportering konfiguration. Funktionerne er tilgængelige for Tyskland og Østrig.</td>
...
<td>Saldoliste med totalkonti grupperapport er implementeret som en SSRS-rapport (LedgerAccountSum\_FR).</td>
...
<td>Separat liste over Intrastat-varekoder flettes med produkthierarki af typen varekode.</td>
...
<td>Intrastat-varekoder er et tekstfelt til at identificere yderligere enheder og ** Product ** kortet har et felt til at identificere antallet af supplerende enheder i kg.</td>
...
<tr class="odd">
<td>Analysere retail channel salgsdata ved hjælp af "Performance Monitor detailkanal" Power BI-indhold.</td>
<td>Ikke tilgængelig</td>
...
<li>Det tilbyder pakker "færdige" alternativ levering, som en kombination websted/opbevaring/variant/transporttilstand, baseret på den hurtigste levering (tidligste tilgængelige dato) kriterium, som brugeren kan vælge fra.</li>
