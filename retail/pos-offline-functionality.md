...
Statushovedet i Retail Modern POS angiver den aktuelle forbindelsesstatus, og vinduet **Forbindelsesstatus** viser status for det seneste forsøg på synkronisering med offlinedatabasen. [![Forbindelsesstatus](./media/status.png)](./media/status.png)
