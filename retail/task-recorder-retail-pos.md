...
Følg disse trin for at aktivere opgaveregistrering på POS.

1.  Klik på **Detail og handel** &gt; **Konfiguration af kanal** &gt; **POS-opsætning** &gt; **Kasseapparater**.
...
4.  Klik på **Gem**.
5.  Gå til **Detail og handel** &gt; **Detail-it** &gt; **Distributionsplan**.
...
3.  Angiv et navn og en beskrivelse for registreringen, og klik derefter på **Start**. Registreringssessionen starter, så snart du klikker på **Start**. **Bemærk:** Hvis du klikker på knappen **Luk** (**X**) i øverste højre hjørne, mens registreringen er i gang, lukkes ruden **Arbejdsrutineoptager**, men registreringssessionen afsluttes ikke. Klik på Hjælp (spørgsmålstegn) øverst på skærmen for at åbne ruden Arbejdsrutineoptager igen. 
...
Arbejdsrutineoptager kan hente skærmbilleder af brugergrænsefladen i Retail Modern POS i takt med, at du registrerer en forretningsproces. Arbejdsrutineoptager bruger skærmbillederne, hvis du henter registreringen som et Word-dokument. Hvis du vil slå funktionen til hentning af skærmbilleder til, skal du angive indstillingen **Tag skærmbilleder** til **Ja**. Bemærk: Funktionen til hentning af skærmbilleder understøttes ikke i Cloud POS.
...
## <a name="help-at-retail-modern-pos-and-cloud-pos"></a>Hjælpen på Retail Modern POS og Cloud POS
For at få vist dine egne brugerdefinerede opgaveregistreringer i ruden Hjælp i Retail Modern POS og Cloud POS så de kan afspilles som opgaveguider eller vises som tekst, skal du gemme opgaveregistreringerne i dit eget BPM-bibliotek og derefter opdatere dine systemparametre til Hjælp til at pege på BPM-biblioteket. Vil du have mere hjælp, kan du se [Tilslutning til hjælpesystemet.](https://ax.help.dynamics.com/en/wiki/working-with-help/#connecting-the-help-system) Hjælpen til Retail Modern POS og Cloud POS søger i LCS i realtid. Den søger på tværs af alle BPM-biblioteker, der er valgt i Microsoft Dynamics AX Hjælp-systemparametrene og viser de relevante resultater. For at få adgang til menuen **Hjælp** skal du klikke på knappen **Hjælp** øverst på skærmen, og derefter skal du skrive navnet på din proces i søgefeltet og trykke på søgeknappen. 

[![Knappen Hjælp](./media/help.jpg)](./media/help.jpg) 

Når du klikker på en opgaveguide i søgeresultaterne, kan du enten få vist trinnene som et emne i Hjælp eller eksportere trinnene til et Word-dokument. Bemærk: Hjælpesystemet i Retail Modern POS og Cloud POS viser ikke automatisk opgaveguider på basis af din formular eller dine handlinger, du skal skrive procesnavnet i søgefeltet og klikke på søgeknappen for at få resultaterne.
