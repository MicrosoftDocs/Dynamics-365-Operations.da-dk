...
> [!TIP] 
> Hvis de **kode for fakturering bestemmer** er angivet til salgspris, kan du ikke ændre prisen, men du kan ændre beløbet indirekte ved at ændre antallet.
...
> [!TIP] 
> Hvis du vil ændre finanskontoen for fakturaen linjer, der er relateret til projekter, ændringer skulle tillades, både på selve faktureringskoden og afsnittet projekter på siden konti Debitorparametre.
