...
Brug af **værdiregulering af udenlandsk valuta** side **periodiske opgaver i** at regulere åbne posteringer. Du kan køre processen i realtid eller planlægge, at den skal køre ved hjælp af en batch. Når du definerer indstillingerne for processen til værdiregulering, skal du kontrollere, om du vil udskrive en rapport over resultaterne. Værdiregulering af rapporten kan ikke genoptrykkes, når processen er fuldført. Hvis du genererer rapporten for værdireguleringen af udenlandsk valuta, viser den forskellige saldi på debitor/kreditorniveau og valutaniveau:
...
Det registreres, hver gang du kører en værdiregulering af udenlandsk valuta. Fra posten på siden **Værdiansættelse af udenlandsk valuta** skal du vælge **Posteringer** for at se en detaljeret oversigt over posteringer, der er oprettet på grund af værdireguleringen. Hver enkelt bilagspostering repræsenterer den åbne postering, der blev reguleret. Hvis en åben transaktion blev reguleret mere end én gang, kan du se to poster, der bruger samme bilag. Vil være én post til tilbageførsel af tidligere Urealiseret gevinst eller tab, og anden posten bliver til nye Urealiseret gevinst eller tab. Hvis du vil køre processen til værdiregulering, skal du klikke på knappen **Værdiregulering af udenlandsk valuta**. Angiv relevante indstillinger for følgende parametre:
