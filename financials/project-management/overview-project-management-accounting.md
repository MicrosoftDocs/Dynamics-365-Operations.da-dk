...
Et projekt er en gruppe af aktiviteter, der er udviklet til at yde en service, produktion af et produkt eller opnå et resultat. Projekter forbruger ressourcer og generere økonomiske resultater i form af indtægter eller aktiver.
...
I et callcenter kan en billet bruges til at beskrive det sæt handlinger, der er nødvendige for at løse et opkald. Konsulentfirmaer som ledelse eller tekniske høring af organisationer eller reklame agenturer, se deres aktiviteter som projekter. I marketing repræsenterer en kampagne et sæt, der skal leveres. I projektbaseret produktion vedrører en produktionsordre forskelligt arbejde, der skal udføres for at producere nogle færdige varer. Navnet, der bruges til dem, omfatter disse projekter, ressourcer, planer og omkostninger, og projektstyring og regnskab funktionalitet i Microsoft Dynamics 365 for operationer, der kan hjælpe dig med planlægning, udførelse og analyse af disse projekter.
...
Under igangsættelsen af projektet forekomme flere vigtige processer. Du kan bruge tilbudstyper til at kommunikere den anslåede arbejdskraft, udgifter og materialer til kunden. Du kan registrere fakturering vilkår, grænser og aftaler i en projektkontrakt. Du kan bruge et arbejdsopgavehierarki (WBS) til at planlægge og vurdere arbejdet. Du kan oprette budgetter og budgetter som vejledning til udførelse af projekter. Følgende illustration viser strukturen i et projekt. [![project struktur](./media/project-structure1.jpg)](./media/project-structure1.jpg)  
...
Du kan oprette seks typer projekter i Microsoft Dynamics 365 for operationer. Hver enkelt projekttype er angivet forskelligt for omkostninger og indtægtsføring. Den projekttype, du vælger, afhænger af formålet med projektet. I følgende tabel beskrives den typiske brug af de enkelte projekttyper.
...
| Fastpris       | I fastprisprojekter består fakturaerne, der af aconto-transaktioner. Et fastprisprojekt faktureres i henhold til en faktureringsplan, der er baseret på en projektkontrakt. Indtægter for et fastprisprojekt kan beregnes og bogføres i løbet af projektet ved hjælp af metoden afsluttet procentdel. Omsætning kan også beregnes og bogføres, når projektet er fuldført, ved hjælp af metoden afsluttet kontrakt. Virksomheder kan ofte have fordel af at bruge værdien af igangværende arbejde (IGVA) til at beregne færdiggørelsesgraden af et projekt eller en gruppe projekter.                                                                                                                                     |
...
> [!NOTE] 
> Posteringer på investeringsprojekter, der ikke er vist på den **Bogfør omkostninger**, **Periodiser omsætning**, eller **Opret fakturaforslag** side.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | | Omkostninger projekt | Ligesom investeringsprojekter omkostningsprojekter bruges typisk til at holde styr på interne projekter og kun timer, udgifter og varer, der kan registreres for dem. Omkostningsprojekter er imidlertid normalt af kortere varighed end investeringsprojekter. I modsætning til investeringsprojekter kan omkostningsprojekter desuden ikke kapitaliseres på statuskonti. I stedet bogføres projektposteringerne kun på driftskonti. 
[!NOTE] 
> Posteringer på omkostningsprojekter ikke afspejles på det **Bogfør omkostninger**, **Periodiser omsætning**, eller **Opret fakturaforslag** side. Da omkostningsprojekter bruges typisk til at holde styr på interne projekter, behøver de normalt ikke at være knyttet til en debitorkonto. Hvis din installation kræver, at der oprettes varebehov for indkøbsordrer, skal du dog knytte omkostningsprojekt til en debitor. Denne tilknytning kræves, fordi varebehov administreres som salgsordrelinjer, og systemet kræver, at der angives en debitor. Denne opsætning resulterer imidlertid ikke i, at varebehov automatisk oprettes ud fra en indkøbsordre. For omkostningsprojekter ignoreres indstillingen **Opret varebehov**. Hvis du skal bruge et varebehov i et omkostningsprojekt, kan du oprette det manuelt, når blot en debitor er knyttet til projektet. | | Interne | Interne projekter, der bruges til at spore omkostninger på et projekt, der er internt i organisationen. Interne projekter kan levere et planlægningsværktøj til at styre ressourceforbruget. **Bemærk:** posteringer på interne projekter ikke afspejles på det **Periodiser omsætning** eller **Opret fakturaforslag** side.                                                                                                                                                                                                                                                                       | | Tid | Tidsprojekter bruges til at registrere tid, der er tilknyttet ikke-fakturerbare og ikke-produktive aktiviteter, som et projekt for at spore sygefravær for arbejdere. Posteringer på tidsprojekter bogføres ikke i finans. De medtages i stedet i rapporterne over brugen af arbejdere. Der kan kun registreres timetransaktioner i tidsprojekter. Du bruger en timekladde eller timeseddel til at registrere disse timer til projektet. Når timerne, der er registreret, vises som projektposteringer men har ikke tilsvarende bilagsposteringer.

> [!NOTE] 
> Posteringer på tidsprojekter ikke afspejles på det **Bogfør omkostninger**, **Periodiser omsætning**, eller **Opret fakturaforslag** side.                                                                                                                                                                                       |
...
Her er nogle af de måder, du kan bruge ressourceplanlægning funktionalitet:
...
Der er to måder at administrere og styre dine projekter: projekt prognoser og projekt budgetter. Du kan bruge prognosebaseret budgettering, hvis organisationen har et operationelt perspektiv og fokuserer på de indtægter og omkostninger, der er udledt af specifikke transaktioner. Du kan imidlertid bruge budgettering, hvis organisationen fokuserer mere på økonomiske beløb.
...
-   Forbrugt vare/ingen link til ordre *** – Link projektet til et varebehov. Hvis du bruger denne metode, kan du få vist de faktiske projektomkostninger, når produktionen har statussen **Igangsat** eller er rapporteret Færdigmeldt. Omkostningerne vil blive bogført som flere posteringer for projektvarer for råmaterialer og timer, der er forbrugt under produktionen. Du kan også angive, hvilket niveau i styklistehierarkiet, projekterne i produktionen skal spores til.
...
-   Hvis du vil bestille varer fra firmaets lager, skal du oprette ordren som et varebehov. Hvis du bruger den **varebehov** side, du kan konfigurere kravet så du modtager varer som delleverancer. Du kan derfor udskyde forbrug af et antal varer, indtil elementerne, der er nødvendige.
...
Microsoft Dynamics 365 for operationer reducere ikke automatisk de budgetterede skøn. Der er derfor en god ide at bevare en oprindelig budgetmodel for fastprisprojektet for at oprette stamdata til sammenligning, når projektet er fuldført. 
> [!NOTE]Når du vælger denne metode, kan du bruge mindst to budgetmodeller. Én model bør indeholde det oprindelige budget. For den anden model skal du kopiere budgetposteringerne fra en anden model. Denne metode er kun gyldig for fastpris- og investeringsprojekter.</td>
> </tr>
<tr class="odd">
...
-   **Forfaldsdato:** 14 April 2012. Denne dato bestemmes ud fra de betalingsbetingelser, der er angivet for projektet. I dette eksempel har du valgt 14 dage som betalingsbetingelse. Derfor føjes 14 dage til fakturadatoen, så der fås en forfaldsdato, der hedder 14. april 2012.
-   **Forventet dato for salgsbetalingen:** April 27, 2012. Denne dato beregnes ved at lægge antallet af dage i den **generelle bufferdage** på den **projektstyring og regnskabsparametre** side til antallet af dage i den **individuelle bufferdage** på **projektkontrakter** side og derefter tilføje Samlet antal dage i den **forfaldsdato** felt. I dette eksempel har du angivet **3** i feltet **Generelle bufferdage** og **10** i feltet **Individuelle bufferdage**. Derfor føjes 13 dage til forfaldsdatoen, så der fås en forventet betalingsdato for salg, der hedder 27. april 2012.
...
-   **Forventet dato for salgsbetalingen:** 29 marts 2012. Beregningen omfatter tre generelle bufferdage og 10 individuelle bufferdage.
...
> [!NOTE] 
> Forfaldsdatoen for indkøbsordren er baseret på kreditorposteringen, når projektets indkøbsordre oprettes. Forfaldsdatoen bestemmes ikke af standardindstillinger. 
...
> [!NOTE] 
> Når du bruger den **omkostningsstyring** side for at få vist den aktuelle status for projektomkostninger, bruge de budgetmodeller, der blev valgt for det oprindelige og det resterende budget. Hvis du vælger andre budgetmodeller til beregning af omkostninger, vil resultaterne af beregningen ikke være nøjagtige.
