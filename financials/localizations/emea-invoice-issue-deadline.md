...
| Relaterede opsætningsopgaver | På siden **Datointervaller** skal du definere et datointerval, der bruges til at beregne forfaldsdatoen for fakturaudstedelse. (Klik på **Finans**&gt;**finansopsætning**&gt;**datointervaller**.) På den **Udenrigshandelsparametre** side, konfigurere egenskaber for Udenrigshandel for forskellige lande. (Klik på **skat**&gt;**Setup**&gt;**Udenrigshandel**&gt;**Udenrigshandelsparametre**.) |
...
Til at konfigurere Microsoft Dynamics 365 for operationer til at beregne faktura problem forfaldsdatoer for intra-EU-leverancer på femtende i måneden efter leveringen er leveret, kan du oprette en dato interval kode og beregningen regel, der har følgende indstillinger.
...
<td>Klik på <strong>systemadministration</strong>&gt;<strong>Setup</strong>&gt;<strong>Licensing</strong>&gt;<strong>Licenskonfiguration</strong>. Klik på konfigurationsnøglen <strong>Finans</strong>.</td>
</tr>
<tr class="even">
