...
| **Felt**                             | **Beskrivelse**             |
|---------------------------------------|--------------------------------------------------------------------------------------|
|**Minimumstimer for diæter**           | Angiv det mindste antal timer, som en medarbejder skal arbejde på en dag, for at det udløser en diæt til rejserelaterede udgifter.                                                                                      |
