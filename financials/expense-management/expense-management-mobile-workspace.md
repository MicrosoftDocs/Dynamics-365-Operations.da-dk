...
<li><a href="/dynamics365/operations/dev-itpro/deployment/create-apply-deployable-package">Opret en installerbar pakke</a>, der indeholder <strong>ApplicationSuite</strong>- og <strong>ExpenseMobile</strong>-modellen, og overfør derefter den installerbare pakke til LCS.</li>
...
3.  Vælg udgiftsarten. Der vises en liste over de udgiftsarter, der er indlæst i din app til offlinebrug. Op til 50 varer er indlæst som standard, men en udvikler kan ændre dette tal. Der findes flere oplysninger for udviklere under [Dynamics 365 for Operations-mobilplatform](/dynamics365/operations/dev-itpro/mobile-apps/mobile-platform). Hvis den aktuelle art ikke står på listen, skal du vælge **Søg** for foretage en onlinesøgning i Dynamics 365 for Operations. Søg på udgiftsart, eller skift for at søge på udgiftstypen.
4.  Angiv posteringsdatoen for udgiften.
5.  Valgfrit: Angiv forhandleren for udgiften.
6.  Angiv beløbet for udgiften.
7.  Vælg valutaen for udgiften. Der vises en liste over de valutakoder, der er indlæst i din app til offlinebrug. Op til 400 valutaer er indlæst som standard, men en udvikler kan ændre dette tal. Der findes flere oplysninger for udviklere under [Dynamics 365 for Operations-mobilplatform](/dynamics365/operations/dev-itpro/mobile-apps/mobile-platform). Hvis den aktuelle valuta ikke står på listen, skal du vælge **Søg** for foretage en onlinesøgning i Dynamics 365 for Operations. Søg på valuta, eller skift for at søge på navn.
