...
April foretager en ekstra betaling mod fakturaen d. 8. juli. For at indtaste beløbet åbner hun siden **Udlign posteringer** og klikker derefter på fanen **Kasserabat**. Hun ser datoerne og beløbene for de to kasserabatter, der er tilgængelige. Da denne betaling er foretaget i den anden rabatperiode, er en rabat på 1 % eller 5,00 tilgængelig. Dette beløb beregnes som halvdelen af rabatten på 1 % på 1.000,00 eller halvdelen af 10,00.
