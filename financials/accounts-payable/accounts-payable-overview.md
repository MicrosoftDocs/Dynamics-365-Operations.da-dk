...
## <a name="setup-pages-for-accounts-payable"></a>Opsætning af sider til kreditor
...
## <a name="optional-setup-pages-for-accounts-payable"></a>Valgfri installationssider for kreditor
...
-   På siden kreditor gebyrer gruppe, Opret og vedligehold gebyrgrupper for kreditorer.
...
-   På den **1099-felter**, kontrollere og opdatere de minimumsbeløb, der skal rapporteres til den interne skattemyndigheder (IRS), baseret på de seneste myndighedskrav.

## <a name="optional-setup-for-other-modules"></a>**Valgfri opsætning til andre moduler**
