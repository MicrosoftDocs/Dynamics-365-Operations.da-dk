...
Når de checks, der er angivet i en fil til positiv betaling, er betalt, modtager du et bekræftelsesnummer fra din bank. Derefter kan du bekræfte positive lønfil Microsoft Dynamics 365 for operationer. 
...
Yderligere oplysninger finder du [angivet op og generere positive løn filer](set-up-generate-positive-pay-files.md).
